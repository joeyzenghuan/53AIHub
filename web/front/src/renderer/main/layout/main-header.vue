<template>
  <header class="flex-none h-[70px] border-b" :class="[type === 'homepage' ? 'nav-bg' : 'bg-white']"
          ...
          <el-tooltip v-if="userStore.is_login" effect="light" popper-class="el-popper--plain" placement="bottom-end">
            <template #content>
              ...
              <div class="flex flex-col gap-1.5 px-3 py-1.5 border-t">
                ...
                <div class="h-8 px-3 flex items-center gap-2 rounded cursor-pointer text-primary opacity-50">
                  <div class="flex-center size-6">
                    <svg-icon name="send_plane" size="16"></svg-icon>
                  </div>
