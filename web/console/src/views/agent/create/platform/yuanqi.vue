        ...
        <div class="flex items-center gap-1">
          ...
          <ElPopover content="Right Top prompts info" placement="right-start" width="480">
            ...
            <div
              ...
              v-html="$t('yuanqi_agent_get_tip', { url: `<a class='text-[#5A6D9E] underline' href='https://yuanqi.tencent.com/my-creation/agent' target='_blank'>https://yuanqi.tencent.com/my-creation/agent</a>` })"
            />
          </ElPopover>
        </div>
      </div>
