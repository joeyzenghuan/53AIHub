...
<template>
  <div>
    ...
    <ElForm ref="form_ref" :model="store.form_data" label-width="104px" label-position="top" class="mt-6">
              ...
              >
                ...
                <div class="flex items-center gap-1">
                  <el-tooltip placement="top" :content="$t('optimize_tip')">
                    <span class="flex-center gap-1 text-[#2563EB] text-sm px-1 cursor-pointer" @click.stop="onOptimize">
                  ...
                  <el-tooltip placement="top" :content="$t('generate_tip')">
                    <span class="text-[#182B50] px-1 cursor-pointer" @click.stop="onGenerate">
