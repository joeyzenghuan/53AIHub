...
<template>
	<ElDialog :title="$t('wechat_pay')" :align-center="true" :close-on-click-modal="false" width="700px" destroy-on-close append-to-body v-model="visible"
		@close="close">
		<ElForm ref="form_ref" :model="form" label-position="top">
			...
			<ElFormItem :label="$t('module.payment_wechat_mch_id')" prop="mchId"
			...
			<ElFormItem :label="$t('module.payment_wechat_app_id')" prop="appId"
			...
			<ElFormItem :label="$t('module.payment_wechat_api_secret')" prop="apiV3Key"
			...
			<ElFormItem :label="$t('module.payment_wechat_cert')" prop="certPath"
				...
				<UploadCertificate v-model="form.certPath" v-model:fileName="form.certName" @change="$refs.form_ref.validateField('certPath')" />
			</ElFormItem>
			<ElFormItem :label="$t('module.payment_wechat_private_key')" prop="privateKeyPath"
				...
				<UploadCertificate v-model="form.privateKeyPath" v-model:fileName="form.privateKeyName" @change="$refs.form_ref.validateField('privateKeyPath')" />
			</ElFormItem>
			<ElFormItem :label="$t('module.payment_wechat_serial_no')" prop="serialNo"
		...
		<ElDialog :title="$t(guideTitle)" :align-center="true" width="860px" destroy-on-close append-to-body v-model="guideVisible">
