...
<template>
	<ElContainer class="w-screen h-screen bg-white">
		<ElAside width="55%"
			...
			<img class="w-[48%] object-contain absolute top-[25%] left-1/2 -translate-x-1/2" :src="$getRealPath({ url: '/images/login/title.png' })"
				alt="">
			<img class="w-[70%] object-contain absolute top-[32%] left-1/2 -translate-x-1/2" :src="$getRealPath({ url: '/images/login/demo.png' })"
				alt="">
		</ElAside>
