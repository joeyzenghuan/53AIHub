import { m as ve, u as ke, e as Pe, f as de, d as ie } from "./mdurl-d7fdfec3.js";
import { P as Re, r as ze, u as Oe } from "./uc.micro-2ff9f57e.js";
import { d as me } from "./entities-52510f6e.js";
import { L as De } from "./linkify-it-c9428ec8.js";
import { p as xe } from "./punycode.js-c41da3d1.js";
function Fe(e) {
...
function Ke(e, n, r) {
  let i, o = n;
  const t = { ok: false, pos: 0, str: "" };
  if (e.charCodeAt(o) === 60) {
    for (o++; o < r; ) {
      if (i = e.charCodeAt(o), i === 10 || i === 60)
        return t;
      if (i === 62)
        return t.pos = o + 1, t.str = D(e.slice(n + 1, o)), t.ok = true, t;
      if (i === 92 && o + 1 < r) {
        o += 2;
        continue;
      }
  ...
  return n === o || l !== 0 || (t.str = D(e.slice(n, o)), t.pos = o, t.ok = true), t;
}
function en(e, n, r, i) {
  let o, t = n;
  const l = { ok: false, can_continue: false, pos: 0, str: "", marker: 0 };
  if (i)
  ...
  for (; t < r; ) {
    if (o = e.charCodeAt(t), o === l.marker)
      return l.pos = t + 1, l.str += D(e.slice(n, t)), l.ok = true, l;
    if (o === 40 && l.marker === 41)
      return l;
    o === 92 && t + 1 < r && t++, t++;
  }
  return l.can_continue = true, l.str += D(e.slice(n, t)), l;
}
const nn = Object.freeze(Object.defineProperty({ __proto__: null, parseLinkDestination: Ke, parseLinkLabel: Ye, parseLinkTitle: en }, Symbol.toStringTag, { value: "Module" })), I = {};
...
`), t += (o.nesting === -1 ? "</" : "<") + o.tag, t += this.renderAttrs(o), o.nesting === 0 && i.xhtmlOut && (t += " /");
  let l = false;
  if (o.block && (l = true, o.nesting === 1 && r + 1 < n.length)) {
    const c = n[r + 1];
    (c.type === "inline" || c.hidden || c.nesting === -1 && c.tag === o.tag) && (l = false);
  }
  return t += l ? `>
` : ">", t;
};
...
S.prototype.before = function(e, n, r, i) {
  ...
  if (o === -1)
    throw new Error("Parser rule not found: " + e);
  this.__rules__.splice(o, 0, { name: n, enabled: true, fn: r, alt: t.alt || [] }), this.__cache__ = null;
};
S.prototype.after = function(e, n, r, i) {
  const o = this.__find__(e), t = i || {};
  if (o === -1)
    throw new Error("Parser rule not found: " + e);
  this.__rules__.splice(o + 1, 0, { name: n, enabled: true, fn: r, alt: t.alt || [] }), this.__cache__ = null;
};
S.prototype.push = function(e, n, r) {
  const i = r || {};
  this.__rules__.push({ name: e, enabled: true, fn: n, alt: i.alt || [] }), this.__cache__ = null;
};
S.prototype.enable = function(e, n) {
  ...
  return e.forEach(function(i) {
    ...
    this.__rules__[o].enabled = true, r.push(i);
...
S.prototype.disable = function(e, n) {
  ...
  return e.forEach(function(i) {
    ...
    this.__rules__[o].enabled = false, r.push(i);
  }, this), this.__cache__ = null, r;
};
...
function T(e, n, r) {
  this.type = e, this.tag = n, this.attrs = null, this.map = null, this.nesting = r, this.level = 0, this.children = null, this.content = "", this.markup = "", this.info = "", this.meta = null, this.block = false, this.hidden = false;
}
...
function be(e, n, r) {
  this.src = e, this.env = r, this.tokens = [], this.inlineMode = false, this.md = n;
}
...
const Ce = /\+-|\.\.|\?\?\?\?|!!!!|,,|--/, hn = /\((c|tm|r)\)/i, pn = /\((c|tm|r)\)/ig, an = { c: "\xA9", r: "\xAE", tm: "\u2122" };
function kn(e, n) {
...
function mn(e) {
  ...
  for (let r = e.length - 1; r >= 0; r--) {
    const i = e[r];
    i.type === "text" && !n && Ce.test(i.content) && (i.content = i.content.replace(/\+-/g, "\xB1").replace(/\.{2,}/g, "\u2026").replace(/([?!])…/g, "$1..").replace(/([?!]){4,}/g, "$1$1$1").replace(/,{2,}/g, ",").replace(/(^|[^-])---(?=[^-]|$)/mg, "$1\u2014").replace(/(^|\s)--(?=\s|$)/mg, "$1\u2013").replace(/(^|[^-\s])--(?=[^-\s]|$)/mg, "$1\u2013")), i.type === "link_open" && i.info === "auto" && n--, i.type === "link_close" && i.info === "auto" && n++;
  }
}
function xn(e) {
  let n;
  ...
  for (let o = 0; o < e.length; o++) {
    ...
    e:
      for (; s < f; ) {
        ...
        if (x ? p = false : y && (d || _ || (p = false)), d ? k = false : _ && (x || y || (k = false)), C === 34 && h[0] === '"' && u >= 48 && u <= 57 && (k = p = false), p && k && (p = _, k = y), !p && !k) {
        ...
        if (k)
          for (r = i.length - 1; r >= 0; r--) {
            ...
            if (m.single === a && i[r].level === l) {
              m = i[r];
              let g, b;
              a ? (g = n.md.options.quotes[2], b = n.md.options.quotes[3]) : (g = n.md.options.quotes[0], b = n.md.options.quotes[1]), t.content = Z(t.content, h.index, b), e[m.token].content = Z(e[m.token].content, m.pos, g), s += b.length - 1, m.token === o && (s += g.length - 1), c = t.content, f = c.length, i.length = r;
              continue e;
            }
          }
        p ? i.push({ token: o, pos: h.index, single: a, level: l }) : k && a && (t.content = Z(t.content, h.index, ce));
      }
  }
}
function bn(e) {
...
const V = [["normalize", tn], ["block", ln], ["inline", cn], ["linkify", un], ["replacements", xn], ["smartquotes", bn], ["text_join", Cn]];
function re() {
  this.ruler = new S();
...
function v(e, n, r, i) {
  this.src = e, this.md = n, this.env = r, this.tokens = i, this.bMarks = [], this.eMarks = [], this.tShift = [], this.sCount = [], this.bsCount = [], this.blkIndent = 0, this.line = 0, this.lineMax = 0, this.tight = false, this.ddIndent = -1, this.listIndent = -1, this.parentType = "root", this.level = 0;
  const o = this.src;
  for (let t = 0, l = 0, c = 0, s = 0, f = o.length, h = false; l < f; l++) {
    ...
    if (!h)
      if (A(p)) {
        ...
        h = true;
    (p === 10 || l === f - 1) && (p !== 10 && l++, this.bMarks.push(t), this.eMarks.push(l), this.tShift.push(c), this.sCount.push(s), this.bsCount.push(0), h = false, c = 0, s = 0, t = l + 1);
  }
...
v.prototype.push = function(e, n, r) {
  const i = new T(e, n, r);
  return i.block = true, r < 0 && this.level--, i.level = this.level, r > 0 && this.level++, this.tokens.push(i), i;
};
...
function se(e) {
  const n = [], r = e.length;
  let i = 0, o = e.charCodeAt(i), t = false, l = 0, c = "";
  for (; i < r; )
...
function yn(e, n, r, i) {
  ...
  return d && (e.push("tbody_close", "tbody", -1), d[1] = o), e.push("table_close", "table", -1), C[1] = o, e.parentType = k, e.line = o, true;
}
function En(e, n, r) {
  ...
  return t.content = e.getLines(n, o, 4 + e.blkIndent, false) + `
`, t.map = [n, e.line], true;
}
function Sn(e, n, r, i) {
  ...
  return a.info = h, a.content = e.getLines(n + 1, p, s, true), a.markup = f, a.map = [n, e.line], true;
}
function Mn(e, n, r, i) {
  let o = e.bMarks[n] + e.tShift[n], t = e.eMarks[n];
  const l = e.lineMax;
  ...
  for (u = n; u < r; u++) {
    ...
    if (e.src.charCodeAt(o++) === 62 && !x) {
      ...
      e.src.charCodeAt(o) === 32 ? (o++, g++, E = false, b = true) : e.src.charCodeAt(o) === 9 ? (b = true, (e.bsCount[u] + g) % 4 === 3 ? (o++, g++, E = false) : E = true) : b = false;
      let M = g;
...
function wn(e, n, r, i) {
  ...
  return s.map = [n, e.line], s.markup = Array(c + 1).join(String.fromCharCode(l)), true;
}
function fe(e, n) {
  const r = e.eMarks[n];
...
function Tn(e, n) {
  ...
  for (let i = n + 2, o = e.tokens.length - 2; i < o; i++)
    e.tokens[i].level === r && e.tokens[i].type === "paragraph_open" && (e.tokens[i + 2].hidden = true, e.tokens[i].hidden = true, i += 2);
}
function In(e, n, r, i) {
  let o, t, l, c, s = n, f = true;
  if (e.sCount[s] - e.blkIndent >= 4 || e.listIndent >= 0 && e.sCount[s] - e.listIndent >= 4 && e.sCount[s] < e.blkIndent)
    return false;
  let h = false;
  i && e.parentType === "paragraph" && e.sCount[s] >= e.blkIndent && (h = true);
  let p, k, a;
  if ((a = ue(e, s)) >= 0) {
    if (p = true, l = e.bMarks[s] + e.tShift[s], k = Number(e.src.slice(l, a - 1)), h && k !== 1)
      return false;
  } else if ((a = fe(e, s)) >= 0)
    p = false;
  else
  ...
  return p ? c = e.push("ordered_list_close", "ol", -1) : c = e.push("bullet_list_close", "ul", -1), c.markup = String.fromCharCode(u), _[1] = s, e.line = s, e.parentType = x, f && Tn(e, C), true;
}
function vn(e, n, r, i) {
  ...
  function c(d) {
    ...
    if (d >= x || e.isEmpty(d))
      return null;
    let m = false;
    if (e.sCount[d] - e.blkIndent > 3 && (m = true), e.sCount[d] < 0 && (m = true), !m) {
  ...
  return y ? (i || (typeof e.env.references > "u" && (e.env.references = {}), typeof e.env.references[y] > "u" && (e.env.references[y] = { title: _, href: p }), e.line = l), true) : false;
}
const Pn = ["address", "article", "aside", "base", "basefont", "blockquote", "body", "caption", "center", "col", "colgroup", "dd", "details", "dialog", "dir", "div", "dl", "dt", "fieldset", "figcaption", "figure", "footer", "form", "frame", "frameset", "h1", "h2", "h3", "h4", "h5", "h6", "head", "header", "hr", "html", "iframe", "legend", "li", "link", "main", "menu", "menuitem", "nav", "noframes", "ol", "optgroup", "option", "p", "param", "search", "section", "summary", "table", "tbody", "td", "tfoot", "th", "thead", "title", "tr", "track", "ul"], Rn = "[a-zA-Z_:][a-zA-Z0-9:._-]*", zn = "[^\"'=<>`\\x00-\\x20]+", On = "'[^']*'", Dn = '"[^"]*"', Fn = "(?:" + zn + "|" + On + "|" + Dn + ")", Ln = "(?:\\s+" + Rn + "(?:\\s*=\\s*" + Fn + ")?)", Ae = "<[A-Za-z][A-Za-z0-9\\-]*" + Ln + "*\\s*\\/?>", ye = "<\\/[A-Za-z][A-Za-z0-9\\-]*\\s*>", $n = "<!---?>|<!--(?:[^-]|-[^-]|--[^>])*-->", Bn = "<[?][\\s\\S]*?[?]>", jn = "<![A-Za-z][^>]*>", qn = "<!\\[CDATA\\[[\\s\\S]*?\\]\\]>", Nn = new RegExp("^(?:" + Ae + "|" + ye + "|" + $n + "|" + Bn + "|" + jn + "|" + qn + ")"), Zn = new RegExp("^(?:" + Ae + "|" + ye + ")"), O = [[/^<(script|pre|style|textarea)(?=(\s|>|$))/i, /<\/(script|pre|style|textarea)>/i, true], [/^<!--/, /-->/, true], [/^<\?/, /\?>/, true], [/^<![A-Z]/, />/, true], [/^<!\[CDATA\[/, /\]\]>/, true], [new RegExp("^</?(" + Pn.join("|") + ")(?=(\\s|/?>|$))", "i"), /^$/, true], [new RegExp(Zn.source + "\\s*$"), /^$/, false]];
function Un(e, n, r, i) {
  let o = e.bMarks[n] + e.tShift[n], t = e.eMarks[n];
  ...
  return f.map = [n, s], f.content = e.getLines(n, s, e.blkIndent, true), true;
}
function Hn(e, n, r, i) {
  let o = e.bMarks[n] + e.tShift[n], t = e.eMarks[n];
  if (e.sCount[n] - e.blkIndent >= 4)
  ...
  return p.markup = "########".slice(0, c), true;
}
function Gn(e, n, r) {
  ...
  if (!t)
    return false;
  const s = e.getLines(n, c, e.blkIndent, false).trim();
  e.line = c + 1;
  ...
  return p.markup = String.fromCharCode(l), e.parentType = o, true;
}
function Wn(e, n, r) {
  ...
  const l = e.getLines(n, t, e.blkIndent, false).trim();
  e.line = t;
  const c = e.push("paragraph_open", "p", 1);
  c.map = [n, e.line];
  const s = e.push("inline", "", 0);
  return s.content = l, s.map = [n, e.line], s.children = [], e.push("paragraph_close", "p", -1), e.parentType = o, true;
}
const U = [["table", yn, ["paragraph", "reference"]], ["code", En], ["fence", Sn, ["paragraph", "reference", "blockquote", "list"]], ["blockquote", Mn, ["paragraph", "reference", "blockquote", "list"]], ["hr", wn, ["paragraph", "reference", "blockquote", "list"]], ["list", In, ["paragraph", "reference", "blockquote"]], ["reference", vn], ["html_block", Un, ["paragraph", "reference", "blockquote"]], ["heading", Hn, ["paragraph", "reference", "blockquote"]], ["lheading", Gn], ["paragraph", Wn]];
function Q() {
  this.ruler = new S();
...
Q.prototype.tokenize = function(e, n, r) {
  ...
  for (; l < r && (e.line = l = e.skipEmptyLines(l), !(l >= r || e.sCount[l] < e.blkIndent)); ) {
    ...
    e.tight = !c, e.isEmpty(e.line - 1) && (c = true), l = e.line, l < r && e.isEmpty(l) && (c = true, l++, e.line = l);
  }
};
...
Q.prototype.State = v;
function q(e, n, r, i) {
  this.src = e, this.env = r, this.md = n, this.tokens = i, this.tokens_meta = Array(i.length), this.pos = 0, this.posMax = this.src.length, this.level = 0, this.pending = "", this.pendingLevel = 0, this.cache = {}, this.delimiters = [], this._prev_delimiters = [], this.backticks = {}, this.backticksScanned = false, this.linkLevel = 0;
}
...
function Xn(e, n) {
  ...
  if (r + 3 > i || e.src.charCodeAt(r) !== 58 || e.src.charCodeAt(r + 1) !== 47 || e.src.charCodeAt(r + 2) !== 47)
    return false;
  ...
  return e.pos += c.length - t.length, true;
}
function Yn(e, n) {
  let r = e.pos;
  ...
  if (!n)
    if (i >= 0 && e.pending.charCodeAt(i) === 32)
      if (i >= 1 && e.pending.charCodeAt(i - 1) === 32) {
        let t = i - 1;
        for (; t >= 1 && e.pending.charCodeAt(t - 1) === 32; )
          t--;
...
function Kn(e, n) {
  let r = e.pos;
  const i = e.posMax;
  if (e.src.charCodeAt(r) !== 92 || (r++, r >= i))
    return false;
...
function er(e, n) {
  ...
  if (e.backticksScanned && (e.backticks[c] || 0) <= o)
    return n || (e.pending += l), e.pos += c, true;
  let s = r, f;
  ...
  return e.backticksScanned = true, n || (e.pending += l), e.pos += c, true;
}
function nr(e, n) {
  const r = e.pos, i = e.src.charCodeAt(r);
  if (n || i !== 126)
    return false;
  const o = e.scanDelims(e.pos, true);
  let t = o.length;
  ...
  for (let s = 0; s < t; s += 2)
    c = e.push("text", "", 0), c.content = l + l, e.delimiters.push({ marker: i, length: 0, token: e.tokens.length - 1, end: -1, open: o.can_open, close: o.can_close });
...
const Ee = { tokenize: nr, postProcess: rr };
function or(e, n) {
  const r = e.pos, i = e.src.charCodeAt(r);
  if (n || i !== 95 && i !== 42)
    return false;
  ...
  for (let t = 0; t < o.length; t++) {
    ...
    l.content = String.fromCharCode(i), e.delimiters.push({ marker: i, length: o.length, token: e.tokens.length - 1, end: -1, open: o.can_open, close: o.can_close });
  }
  return e.pos += o.length, true;
}
function pe(e, n) {
  ...
  for (let i = r - 1; i >= 0; i--) {
    ...
    if (o.marker !== 95 && o.marker !== 42 || o.end === -1)
      continue;
    const t = n[o.end], l = i > 0 && n[i - 1].end === o.end + 1 && n[i - 1].marker === o.marker && n[i - 1].token === o.token - 1 && n[o.end + 1].token === t.token + 1, c = String.fromCharCode(o.marker), s = e.tokens[o.token];
...
const Se = { tokenize: or, postProcess: tr };
function ir(e, n) {
  let r, i, o, t, l = "", c = "", s = e.pos, f = true;
  if (e.src.charCodeAt(e.pos) !== 91)
    return false;
  const h = e.pos, p = e.posMax, k = e.pos + 1, a = e.md.helpers.parseLinkLabel(e, e.pos, true);
  if (a < 0)
    return false;
  let u = a + 1;
  if (u < p && e.src.charCodeAt(u) === 40) {
    for (f = false, u++; u < p && (r = e.src.charCodeAt(u), !(!A(r) && r !== 10)); u++)
      ;
    if (u >= p)
      return false;
    ...
    (u >= p || e.src.charCodeAt(u) !== 41) && (f = true), u++;
  }
  if (f) {
  ...
  return e.pos = u, e.posMax = p, true;
}
function lr(e, n) {
  ...
  if (e.src.charCodeAt(e.pos) !== 33 || e.src.charCodeAt(e.pos + 1) !== 91)
    return false;
  const a = e.pos + 2, u = e.md.helpers.parseLinkLabel(e, e.pos + 1, false);
  if (u < 0)
    return false;
...
function ar(e, n) {
  ...
  return e.pos += t[0].length, true;
}
const kr = /^&#((?:x[a-f0-9]{1,6}|[0-9]{1,7}));/i, dr = /^&([a-z][a-z0-9]{1,31});/i;
function mr(e, n) {
  const r = e.pos, i = e.posMax;
  if (e.src.charCodeAt(r) !== 38 || r + 1 >= i)
    return false;
...
function ae(e) {
  ...
  for (let l = 0; l < r; l++) {
    const c = e[l];
    if (t.push(0), (e[i].marker !== c.marker || o !== c.token - 1) && (i = l), o = c.token, c.length = c.length || 0, !c.close)
      continue;
    ...
    for (; f > s; f -= t[f] + 1) {
      ...
      if (p.marker === c.marker && p.open && p.end < 0) {
        let k = false;
        if ((p.close || c.open) && (p.length + c.length) % 3 === 0 && (p.length % 3 !== 0 || c.length % 3 !== 0) && (k = true), !k) {
          const a = f > 0 && !e[f - 1].open ? t[f - 1] + 1 : 0;
          t[l] = l - f + a, t[f] = a, c.open = false, p.end = l, p.close = false, h = -1, o = -2;
          break;
        }
      }
    }
...
const Y = [["text", Jn], ["linkify", Xn], ["newline", Yn], ["escape", Kn], ["backticks", er], ["strikethrough", Ee.tokenize], ["emphasis", Se.tokenize], ["link", ir], ["image", lr], ["autolink", fr], ["html_inline", ar], ["entity", mr]], K = [["balance_pairs", xr], ["strikethrough", Ee.postProcess], ["emphasis", Se.postProcess], ["fragments_join", gr]];
function N() {
  this.ruler = new S();
...
N.prototype.skipToken = function(e) {
  ...
  if (e.level < o) {
    for (let c = 0; c < i; c++)
      if (e.level++, l = r[c](e, true), e.level--, l) {
        if (n >= e.pos)
...
N.prototype.State = q;
const _r = { options: { html: false, xhtmlOut: false, breaks: false, langPrefix: "language-", linkify: false, typographer: false, quotes: "\u201C\u201D\u2018\u2019", highlight: null, maxNesting: 100 }, components: { core: {}, block: {}, inline: {} } }, br = { options: { html: false, xhtmlOut: false, breaks: false, langPrefix: "language-", linkify: false, typographer: false, quotes: "\u201C\u201D\u2018\u2019", highlight: null, maxNesting: 20 }, components: { core: { rules: ["normalize", "block", "inline", "text_join"] }, block: { rules: ["paragraph"] }, inline: { rules: ["text"], rules2: ["balance_pairs", "fragments_join"] } } }, Cr = { options: { html: true, xhtmlOut: true, breaks: false, langPrefix: "language-", linkify: false, typographer: false, quotes: "\u201C\u201D\u2018\u2019", highlight: null, maxNesting: 20 }, components: { core: { rules: ["normalize", "block", "inline", "text_join"] }, block: { rules: ["blockquote", "code", "fence", "heading", "hr", "html_block", "lheading", "list", "reference", "paragraph"] }, inline: { rules: ["autolink", "backticks", "emphasis", "entity", "escape", "html_inline", "image", "link", "newline", "text"], rules2: ["balance_pairs", "emphasis", "fragments_join"] } } }, Ar = { default: _r, zero: br, commonmark: Cr }, yr = /^(vbscript|javascript|file|data):/, Er = /^data:image\/(gif|png|jpeg|webp);/;
function Sr(e) {
  const n = e.trim().toLowerCase();
  return yr.test(n) ? Er.test(n) : true;
}
...
w.prototype.enable = function(e, n) {
  ...
  Array.isArray(e) || (e = [e]), ["core", "block", "inline"].forEach(function(o) {
    r = r.concat(this[o].ruler.enable(e, true));
  }, this), r = r.concat(this.inline.ruler2.enable(e, true));
...
w.prototype.disable = function(e, n) {
  let r = [];
  Array.isArray(e) || (e = [e]), ["core", "block", "inline"].forEach(function(o) {
    r = r.concat(this[o].ruler.disable(e, true));
  }, this), r = r.concat(this.inline.ruler2.disable(e, true));
  const i = e.filter(function(o) {
    return r.indexOf(o) < 0;
  });
  if (i.length && !n)
