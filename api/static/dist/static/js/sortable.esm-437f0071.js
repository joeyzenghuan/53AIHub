...
function z(o) {
  for (var t = 1; t < arguments.length; t++) {
    ...
    t % 2 ? se(Object(e), true).forEach(function(n) {
      Me(o, n, e[n]);
...
function Me(o, t, e) {
  return t in o ? Object.defineProperty(o, t, { value: e, enumerable: true, configurable: true, writable: true }) : o[t] = e, o;
}
function q() {
...
function dt(o, t, e, n) {
  for (var i = 0, r = 0, a = o.children; r < a.length; ) {
    if (a[r].style.display !== "none" && a[r] !== p.ghost && (n || a[r] !== p.dragged) && W(a[r], e.draggable, o, false)) {
      if (i === t)
        return a[r];
      i++;
    }
...
function De(o) {
  ...
  return t && t.dom ? t.dom(o).cloneNode(true) : e ? e(o).clone(true)[0] : o.cloneNode(true);
}
function Se(o, t, e) {
  var n = {};
  return Array.from(o.children).forEach(function(i) {
    var r, a, l, s;
    if (!(!W(i, t.draggable, o, false) || i.animated || i === e)) {
      var u = C(i);
  ...
  return { captureAnimationState: function() {
    ...
    if (a) {
      ...
      n.animatingX = !!d, n.animatingY = !!c, h(n, "transform", "translate3d(" + d + "px," + c + "px,0)"), this.forRepaintDummy = We(n), h(n, "transition", "transform " + a + "ms" + (this.options.easing ? " " + this.options.easing : "")), h(n, "transform", "translate3d(0,0,0)"), typeof n.animated == "number" && clearTimeout(n.animated), n.animated = setTimeout(function() {
        h(n, "transition", ""), h(n, "transform", ""), n.animated = false, n.animatingX = false, n.animatingY = false;
      }, a);
    }
  } };
}
...
var lt = [], jt = { initializeByDefault: true }, Ot = { mount: function(t) {
  ...
  lt.forEach(function(a) {
    e[a.pluginName] && (e[a.pluginName][r] && e[a.pluginName][r](z({ sortable: e }, n)), e.options[a.pluginName] && e[a.pluginName][t] && e[a.pluginName][t](z({ sortable: e }, n)));
  });
...
function Le(o) {
  ...
  if (t = t || e && e[N], !!t) {
    ...
    window.CustomEvent && !V && !Ct ? y = new CustomEvent(n, { bubbles: true, cancelable: true }) : (y = document.createEvent("Event"), y.initEvent(n, true, true)), y.to = a || e, y.from = l || e, y.item = i || e, y.clone = r, y.oldIndex = s, y.newIndex = u, y.oldDraggableIndex = d, y.newDraggableIndex = c, y.originalEvent = b, y.pullMode = w ? w.lastPutMode : void 0;
...
var f, S, g, _, at, Ft, D, J, ft, X, Dt, Q, At, O, ut = false, Bt = false, Ht = [], it, H, $t, Ut, he, pe, bt, st, St, Tt = false, Pt = false, Rt, I, qt = [], Jt = false, Wt = [], Lt = typeof document < "u", xt = oe, ge = Ct || V ? "cssFloat" : "float", je = Lt && !ve && !oe && "draggable" in document.createElement("div"), Te = function() {
  ...
  var n = {}, i = t.group;
  (!i || Mt(i) != "object") && (i = { name: i }), n.name = i.name, n.checkPull = e(i.pull, true), n.checkPut = e(i.put), n.revertClone = i.revertClone, t.group = n;
}, Ie = function() {
...
function p(o, t) {
  ...
  var e = { group: null, sort: true, disabled: false, store: null, handle: null, draggable: /^[uo]l$/i.test(o.nodeName) ? ">li" : ">*", swapThreshold: 1, invertSwap: false, invertedSwapThreshold: null, removeCloneOnHide: true, direction: function() {
...
p.prototype = { constructor: p, _isOutsideThisEl: function(t) {
  ...
  if (t.cancelable) {
    ...
    if (nn(n), !f && !(/mousedown|pointerdown/.test(a) && t.button !== 0 || i.disabled) && !u.isContentEditable && !(!this.nativeDraggable && wt && s && s.tagName.toUpperCase() === "SELECT") && (s = W(s, i.draggable, n, false), !(s && s.animated) && Ft !== s)) {
      if (ft = Y(s), Dt = Y(s, i.draggable), typeof d == "function") {
        if (d.call(this, t, s, this)) {
          P({ sortable: e, rootEl: u, name: "filter", targetEl: s, toEl: n, fromEl: n }), x("filter", e, { evt: t }), r && t.preventDefault();
          return;
        }
      } else if (d && (d = d.split(",").some(function(c) {
        if (c = W(u, c.trim(), n, false), c)
          return P({ sortable: e, rootEl: c, name: "filter", targetEl: s, fromEl: n, toEl: n }), x("filter", e, { evt: t }), true;
      }), d)) {
        r && t.preventDefault();
        return;
      }
      i.handle && !W(u, i.handle, n, false) || this._prepareDragStart(t, l, s);
    }
  }
  ...
  if (n && !f && n.parentNode === r) {
    var u = C(n);
    if (_ = r, f = n, S = f.parentNode, at = f.nextSibling, Ft = n, At = a.group, p.dragged = f, it = { target: f, clientX: (e || t).clientX, clientY: (e || t).clientY }, he = it.clientX - u.left, pe = it.clientY - u.top, this._lastX = (e || t).clientX, this._lastY = (e || t).clientY, f.style["will-change"] = "all", s = function() {
      if (x("delayEnded", i, { evt: t }), p.eventCanceled) {
        i._onDrop();
        return;
      }
      i._disableDelayedDragEvents(), !ue && i.nativeDraggable && (f.draggable = true), i._triggerDragStart(t, e), P({ sortable: i, name: "choose", originalEvent: t }), R(f, a.chosenClass, true);
    }, a.ignore.split(",").forEach(function(d) {
      ye(f, d.trim(), Vt);
    }), v(l, "dragover", rt), v(l, "mousemove", rt), v(l, "touchmove", rt), a.supportPointer ? (v(l, "pointerup", i._onDrop), !this.nativeDraggable && v(l, "pointercancel", i._onDrop)) : (v(l, "mouseup", i._onDrop), v(l, "touchend", i._onDrop), v(l, "touchcancel", i._onDrop)), ue && this.nativeDraggable && (this.options.touchStartThreshold = 4, f.draggable = true), x("delayStart", this, { evt: t }), a.delay && (!a.delayOnTouchOnly || e) && (!this.nativeDraggable || !(Ct || V))) {
      if (p.eventCanceled) {
        this._onDrop();
        return;
      }
  ...
  if (ut = false, _ && f) {
    x("dragStarted", this, { evt: e }), this.nativeDraggable && v(document, "dragover", qe);
    var n = this.options;
    !t && R(f, n.dragClass, false), R(f, n.ghostClass, true), p.active = this, t && this._appendGhost(), P({ sortable: this, name: "start", originalEvent: e });
  } else
    this._nulling();
  ...
  if (H) {
    ...
    if (f.parentNode[N]._isOutsideThisEl(t), e)
      do {
        if (e[N]) {
          var n = void 0;
          if (n = e[N]._onDragOver({ clientX: H.clientX, clientY: H.clientY, target: t, rootEl: e }), n && !this.options.dragoverBubble)
            break;
        }
        t = e;
      } while (e = Ee(e));
  ...
  if (it) {
    var e = this.options, n = e.fallbackTolerance, i = e.fallbackOffset, r = t.touches ? t.touches[0] : t, a = g && ct(g, true), l = g && a && a.a, s = g && a && a.d, u = xt && I && de(I), d = (r.clientX - it.clientX + i.x) / (l || 1) + (u ? u[0] - qt[0] : 0) / (l || 1), c = (r.clientY - it.clientY + i.y) / (s || 1) + (u ? u[1] - qt[1] : 0) / (s || 1);
    if (!p.active && !ut) {
  ...
  if (!g) {
    var t = this.options.fallbackOnBody ? document.body : _, e = C(f, true, xt, true, t), n = this.options;
    if (xt) {
  ...
  x("setupClone", this), p.eventCanceled || (D = De(f), D.removeAttribute("id"), D.draggable = false, D.style["will-change"] = "", this._hideClone(), R(D, this.options.chosenClass, false), p.clone = D), n.cloneId = Xt(function() {
    x("clone", n), !p.eventCanceled && (n.options.removeCloneOnHide || _.insertBefore(D, f), n._hideClone(), P({ sortable: n, name: "clone" }));
  }), !e && R(f, r.dragClass, true), e ? (Bt = true, n._loopId = setInterval(n._emulateDragOver, 50)) : (m(document, "mouseup", n._onDrop), m(document, "touchend", n._onDrop), m(document, "touchcancel", n._onDrop), i && (i.effectAllowed = "move", r.setData && r.setData.call(n, i, f)), v(document, "drop", n), h(f, "transform", "translateZ(0)")), ut = true, n._dragStartId = Xt(n._dragStarted.bind(n, e, t)), v(document, "selectstart", n), bt = true, window.getSelection().removeAllRanges(), wt && h(document.body, "user-select", "none");
}, _onDragOver: function(t) {
  var e = this.el, n = t.target, i, r, a, l = this.options, s = l.group, u = p.active, d = At === s, c = l.sort, b = O || u, w, E = this, y = false;
  if (Jt)
    return;
  function k(vt, xe) {
    x(vt, E, z({ evt: t, isOwner: d, axis: w ? "vertical" : "horizontal", revert: a, dragRect: i, targetRect: r, canSort: c, fromSortable: b, target: n, completed: A, onMove: function(le, Ne) {
  ...
  function A(vt) {
    return k("dragOverCompleted", { insertion: vt }), vt && (d ? u._hideClone() : u._showClone(E), E !== b && (R(f, O ? O.options.ghostClass : u.options.ghostClass, false), R(f, l.ghostClass, true)), O !== E && E !== p.active ? O = E : E === p.active && O && (O = null), b === E && (E._ignoreWhileAnimating = n), E.animateAll(function() {
      k("dragOverAnimationComplete"), E._ignoreWhileAnimating = null;
    }), E !== b && (b.animateAll(), b._ignoreWhileAnimating = null)), (n === f && !f.animated || n === e && !n.animated) && (st = null), !l.dragoverBubble && !t.rootEl && n !== document && (f.parentNode[N]._isOutsideThisEl(t.target), !vt && rt(t)), !l.dragoverBubble && t.stopPropagation && t.stopPropagation(), y = true;
  }
  function B() {
    X = Y(f), Q = Y(f, l.draggable), P({ sortable: E, name: "change", toEl: e, newIndex: X, newDraggableIndex: Q, originalEvent: t });
  }
  if (t.preventDefault !== void 0 && t.cancelable && t.preventDefault(), n = W(n, l.draggable, e, true), k("dragOver"), p.eventCanceled)
    return y;
  ...
  if (Bt = false, u && !l.disabled && (d ? c || (a = S !== _) : O === this || (this.lastPutMode = At.checkPull(this, u, f, t)) && s.checkPut(this, u, f, t))) {
    ...
    if (!M || Qe(t, w, this) && !M.animated) {
      if (M === f)
        return A(false);
      if (M && e === t.target && (n = M), n && (r = C(n)), Nt(_, e, f, i, n, r, t, !!n) !== false)
        return j(), M && M.nextSibling ? e.insertBefore(f, M.nextSibling) : e.appendChild(f), S = e, B(), A(true);
    } else if (M && Ze(t, w, this)) {
      var et = dt(e, 0, l, true);
      if (et === f)
        return A(false);
      if (n = et, r = C(n), Nt(_, e, f, i, n, r, t, false) !== false)
        return j(), e.insertBefore(f, et), S = e, B(), A(true);
      ...
      st !== n && (nt = r[pt], Tt = false, Pt = !F && l.invertSwap || ht), G = Je(t, n, r, w, F ? 1 : l.swapThreshold, l.invertedSwapThreshold == null ? l.swapThreshold : l.invertedSwapThreshold, Pt, st === n);
      var $;
      if (G !== 0) {
        var ot = Y(f);
        do
      ...
      if (G === 0 || $ === n)
        return A(false);
      st = n, St = G;
      var mt = n.nextElementSibling, Z = false;
      Z = G === 1;
      var It = Nt(_, e, f, i, n, r, t, Z);
      if (It !== false)
        return (It === 1 || It === -1) && (Z = It === 1), Jt = true, setTimeout(Ke, 30), j(), Z && !mt ? e.appendChild(f) : n.parentNode.insertBefore(f, Z ? mt : n), K && _e(K, 0, gt - K.scrollTop), S = f.parentNode, nt !== void 0 && !Pt && (Rt = Math.abs(nt - C(n)[pt])), B(), A(true);
    }
    if (e.contains(f))
      return A(false);
  }
  ...
  if (X = Y(f), Q = Y(f, n.draggable), x("drop", this, { evt: t }), S = f && f.parentNode, X = Y(f), Q = Y(f, n.draggable), p.eventCanceled) {
    this._nulling();
    return;
  }
  ...
  for (var t = [], e, n = this.el.children, i = 0, r = n.length, a = this.options; i < r; i++)
    e = n[i], W(e, a.draggable, this.el, false) && t.push(e.getAttribute(a.dataIdAttr) || en(e));
  return t;
}, sort: function(t, e) {
  var n = {}, i = this.el;
  this.toArray().forEach(function(r, a) {
    var l = i.children[a];
    W(l, this.options.draggable, i, false) && (n[r] = l);
  ...
  return W(t, e || this.options.draggable, this.el, false);
}, option: function(t, e) {
  var n = this.options;
  if (e === void 0)
    return n[t];
...
function Nt(o, t, e, n, i, r, a, l) {
  ...
  return window.CustomEvent && !V && !Ct ? s = new CustomEvent("move", { bubbles: true, cancelable: true }) : (s = document.createEvent("Event"), s.initEvent("move", true, true)), s.to = t, s.from = o, s.dragged = e, s.draggedRect = n, s.related = i || t, s.relatedRect = r || C(t), s.willInsertAfter = l, s.originalEvent = a, o.dispatchEvent(s), d && (c = d.call(u, s, a)), c;
}
function Vt(o) {
  o.draggable = false;
}
...
function Ze(o, t, e) {
  var n = C(dt(e.el, 0, e.options, true)), i = Se(e.el, e.options, g), r = 10;
...
function Je(o, t, e, n, i, r, a, l) {
  var s = n ? o.clientY : o.clientX, u = n ? e.height : e.width, d = n ? e.top : e.left, c = n ? e.bottom : e.right, b = false;
  if (!a) {
    if (l && Rt < u * i) {
...
p.utils = { on: v, off: m, css: h, find: ye, is: function(t, e) {
  return !!W(t, e, t, false);
...
function on() {
  ...
  return o.prototype = { dragStarted: function(e) {
    ...
    if (Gt = e, n || this.options.forceAutoScrollFallback || Ct || V || wt) {
      ...
      Qt(e, this.options, tt(l, false), false);
    }
...
var Qt = we(function(o, t, e, n) {
  if (t.scroll) {
    ...
    ee !== e && (ee = e, Yt(), Et = t.scroll, d = t.scrollFn, Et === true && (Et = tt(e, true)));
    var c = 0, b = Et;
    do {
