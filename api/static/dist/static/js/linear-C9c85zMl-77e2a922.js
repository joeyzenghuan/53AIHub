import { d as O, e as or, g as P, o as Y, U as ur } from "./viewer-DpLhQV_x-5cf483f8.js";
...
function _(r) {
  let n, e, t;
  r.length !== 2 ? (n = X, e = (u, f) => X(r(u), f), t = (u, f) => r(u) - f) : (n = r === X || r === fr ? r : sr, e = r, t = r);
...
function mr(r, n, e) {
  n = +n, r = +r, e = +e;
  const t = n < r, i = t ? B(n, r, e) : B(r, n, e);
...
function T(r, n) {
  var e = typeof n, t;
  return n == null || e === "boolean" ? or(n) : (e === "number" ? O : e === "string" ? (t = P(n)) ? (n = t, Y) : ur : n instanceof P ? Y : n instanceof Date ? Nr : br(n) ? yr : Array.isArray(n) ? wr : typeof n.valueOf != "function" && typeof n.toString != "function" || isNaN(n) ? xr : O)(r, n);
}
function kr(r, n) {
...
function D(r) {
  ...
  var n;
  return new U({ fill: n[1], align: n[2], sign: n[3], symbol: n[4], zero: n[5], width: n[6], comma: n[7], precision: n[8] && n[8].slice(1), trim: n[9], type: n[10] });
}
...
function Xr(r) {
  ...
  function a(s) {
    s = D(s);
    var h = s.fill, m = s.align, M = s.sign, A = s.symbol, w = s.zero, S = s.width, F = s.comma, y = s.precision, V = s.trim, p = s.type;
    p === "n" ? (F = true, p = "g") : I[p] || (y === void 0 && (y = 12), V = true, p = "g"), (w || h === "0" && m === "=") && (w = true, h = "0", m = "=");
    var er = A === "$" ? e : A === "#" && /[boxX]/.test(p) ? "0" + p.toLowerCase() : "", ir = A === "$" ? t : /[%p]/.test(p) ? o : "", Z = I[p], ar = /[defgprs%]/.test(p);
    ...
    function G(l) {
      ...
      if (p === "c")
        ...
        l = +l;
        var z = l < 0 || 1 / l < 0;
        if (l = isNaN(l) ? f : Z(Math.abs(l), y), V && (l = $r(l)), z && +l == 0 && M !== "+" && (z = false), b = (z ? M === "(" ? M : u : M === "-" || M === "(" ? "" : M) + b, v = (p === "s" ? Q[8 + rr / 3] : "") + v + (z && M === "(" ? ")" : ""), ar) {
      ...
      switch (F && w && (l = n(d + l, d.length ? S - v.length : 1 / 0), d = ""), m) {
        case "<":
          l = b + l + v + d;
          break;
        case "=":
...
var E, nr, tr;
qr({ thousands: ",", grouping: [3], currency: ["$", ""] });
function qr(r) {
...
function Zr() {
  ...
  function g() {
    ...
    return o !== x && (o = Lr(r[0], r[h - 1])), u = h > 2 ? Ur : Tr, f = a = null, s;
  }
  function s(h) {
  ...
  return s.invert = function(h) {
    ...
    return arguments.length ? (r = Array.from(h, Br), g()) : r.slice();
  }, s.range = function(h) {
...
function Rr(r, n, e, t) {
  ...
  switch (t = D(t ?? ",f"), t.type) {
    ...
    case "p":
    case "r": {
      t.precision == null && !isNaN(c = Fr(i, Math.max(Math.abs(r), Math.abs(n)))) && (t.precision = c - (t.type === "e"));
      break;
    }
    case "f":
    case "%": {
...
function Pr(r) {
  ...
  return r.ticks = function(e) {
    ...
    var i = n();
    return Rr(i[0], i[i.length - 1], e ?? 10, t);
  }, r.nice = function(e) {
    e == null && (e = 10);
