import { A as x, C as g, Z as C, P as Z } from "./uc.micro-2ff9f57e.js";
function w(_) {
  const t = {};
...
const y = { fuzzyLink: true, fuzzyEmail: true, fuzzyIP: false };
function b(_) {
  return Object.keys(_ || {}).reduce(function(t, e) {
    return t || y.hasOwnProperty(e);
  }, false);
}
const $ = { "http:": { validate: function(_, t, e) {
  const r = _.slice(t);
...
} }, "https:": "http:", "ftp:": "http:", "//": { validate: function(_, t, e) {
  const r = _.slice(t);
  return e.re.no_http || (e.re.no_http = new RegExp("^" + e.re.src_auth + "(?:localhost|(?:(?:" + e.re.src_domain + ")\\.)+" + e.re.src_domain_root + ")" + e.re.src_port + e.re.src_host_terminator + e.re.src_path, "i")), e.re.no_http.test(r) ? t >= 3 && _[t - 3] === ":" || t >= 3 && _[t - 3] === "/" ? 0 : r.match(e.re.no_http)[0].length : 0;
} }, "mailto:": { validate: function(_, t, e) {
  const r = _.slice(t);
...
function u(_) {
  ...
  _.re.schema_test = RegExp("(^|(?!_)(?:[><\uFF5C]|" + t.src_ZPCc + "))(" + o + ")", "i"), _.re.schema_search = RegExp("(^|(?!_)(?:[><\uFF5C]|" + t.src_ZPCc + "))(" + o + ")", "ig"), _.re.schema_at_start = RegExp("^" + _.re.schema_search.source, "i"), _.re.pretest = RegExp("(" + _.re.schema_test.source + ")|(" + _.re.host_fuzzy_test.source + ")|@", "i"), S(_);
}
function L(_, t) {
...
function n(_, t) {
  if (!(this instanceof n))
    return new n(_, t);
  t || b(_) && (t = _, _ = {}), this.__opts__ = p({}, y, t), this.__index__ = -1, this.__last_index__ = -1, this.__schema__ = "", this.__text_cache__ = "", this.__schemas__ = p({}, $, _), this.__compiled__ = {}, this.__tlds__ = P, this.__tlds_replaced__ = false, this.re = {}, u(this);
}
...
n.prototype.tlds = function(t, e) {
  return t = Array.isArray(t) ? t : [t], e ? (this.__tlds__ = this.__tlds__.concat(t).sort().filter(function(r, c, h) {
    return r !== h[c - 1];
  }).reverse(), u(this), this) : (this.__tlds__ = t.slice(), this.__tlds_replaced__ = true, u(this), this);
};
