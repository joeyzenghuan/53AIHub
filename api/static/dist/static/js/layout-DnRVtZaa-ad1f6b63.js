import { L as b } from "./graph-BlpFl8hT-b0c4ce28.js";
import { O as Mn, b as $, y as jn, L as J, i as Cn, U as nn, a as s, l as hn, E as m, S as x, I as j, C as Sn, c as gn, f as $n, _ as L } from "./_baseUniq-Bc4pAwPa-cec378bd.js";
import { f as N, V as Vn, v as Fn, d as Gn, u as T, t as vn, g as p, o as I, m as ln, h as H, r as Bn, X as V } from "./_basePickBy-sC4qhKfT-afa609f8.js";
import { aw as Yn, aG as z, aP as qn, aQ as zn, aL as pn, aK as wn, aT as An, aU as A, aS as Dn, aR as Jn, aH as Hn, aN as Kn, ay as Qn } from "./mermaid-j5R1o_wi-141fd499.js";
function Xn(n) {
...
function K(n, r) {
  return n && n.length ? vn(n, J(r), Bn) : void 0;
}
function tr(n, r) {
  var e = n.length;
  for (n.sort(r); e--; )
...
function fr(n) {
  return function(r, e, t) {
    return t && typeof t != "number" && z(r, e, t) && (e = t = void 0), r = V(r), e === void 0 ? (e = r, r = 0) : e = V(e), t = t === void 0 ? r < e ? 1 : -1 : V(t), sr(r, e, t);
  };
}
...
function Tr(n) {
  var r = n.graph().rankdir.toLowerCase();
  (r === "bt" || r === "rl") && Mr(n), (r === "lr" || r === "rl") && (jr(n), yn(n));
}
function yn(n) {
...
function Mr(n) {
  s(n.nodes(), function(r) {
    ...
    var e = n.edge(r);
    s(e.points, G), Object.prototype.hasOwnProperty.call(e, "y") && G(e);
  });
}
function G(n) {
  n.y = -n.y;
...
function X(n) {
  ...
  function e(t) {
    ...
    if (Object.prototype.hasOwnProperty.call(r, t))
      return o.rank;
    r[t] = true;
    var i = I(p(n.outEdges(t), function(a) {
...
function kn(n) {
  ...
  for (var o, i; Vr(r, n) < t; )
    o = Fr(r, n), i = r.hasNode(o.v) ? P(n, o) : -P(n, o), Gr(r, n, i);
  return r;
}
function Vr(n, r) {
  function e(t) {
...
function Ln(n, r, e, t, o, i, a) {
  ...
  n.setParent(d, a), f.borderTop = d, n.setParent(c, a), f.borderBottom = c, s(u, function(h) {
    ...
    n.setEdge(d, v, { weight: w, minlen: _, nestingEdge: true }), n.setEdge(l, c, { weight: w, minlen: _, nestingEdge: true });
    ...
    return s(i, function(f, h) {
      ...
      (g || f === c) && (s(i.slice(u, h + 1), function(l) {
        s(n.predecessors(l), function(w) {
          ...
          (W < a || v < W) && !(_.dummy && n.node(l).dummy) && Tn(e, w, l);
        });
      }), u = h + 1, a = v);
    }), i;
  }
...
function be(n, r) {
  if (n.node(r).dummy)
    return H(n.predecessors(r), function(e) {
...
function Oe(n, r) {
  ...
  s(["u", "d"], function(i) {
    s(["l", "r"], function(a) {
      ...
      if (d !== r) {
        var f = x(d);
        c = a === "l" ? t - I(f) : o - y(f), c && (n[u] = C(d, function(h) {
          return h + c;
        }));
      }
    });
...
function Re(n) {
  n = mn(n), Te(n), rr(Ie(n), function(r, e) {
    n.node(e).x = r;
  });
}
function Te(n) {
...
function it(n, r) {
  ...
  e("layout", () => {
    ...
    e("  runLayout", () => Me(t, e)), e("  updateInputGraph", () => je(n, t));
  });
}
function Me(n, r) {
  r("    makeSpaceForEdgeLabels", () => ze(n)), r("    removeSelfEdges", () => Ze(n)), r("    acyclic", () => kr(n)), r("    nestingGraph.run", () => Kr(n)), r("    rank", () => Dr(mn(n))), r("    injectEdgeLabelProxies", () => Ae(n)), r("    removeEmptyRanks", () => _r(n)), r("    nestingGraph.cleanup", () => Ur(n)), r("    normalizeRanks", () => Or(n)), r("    assignRankMinMax", () => De(n)), r("    removeEdgeLabelProxies", () => Je(n)), r("    normalize.run", () => Cr(n)), r("    parentDummyChains", () => ve(n)), r("    addBorderSegments", () => Lr(n)), r("    order", () => he(n)), r("    insertSelfEdges", () => We(n)), r("    adjustCoordinateSystem", () => Rr(n)), r("    position", () => Re(n)), r("    positionSelfEdges", () => nt(n)), r("    removeBorderNodes", () => Ue(n)), r("    normalize.undo", () => $r(n)), r("    fixupEdgeLabelCoords", () => Qe(n)), r("    undoCoordinateSystem", () => Tr(n)), r("    translateGraph", () => He(n)), r("    assignNodeIntersects", () => Ke(n)), r("    reversePoints", () => Xe(n)), r("    acyclic.undo", () => Er(n));
}
function je(n, r) {
  s(n.nodes(), function(e) {
...
var Ce = ["nodesep", "edgesep", "ranksep", "marginx", "marginy"], Se = { ranksep: 50, edgesep: 20, nodesep: 50, rankdir: "tb" }, $e = ["acyclicer", "ranker", "rankdir", "align"], Ve = ["width", "height"], Fe = { width: 0, height: 0 }, Ge = ["minlen", "weight", "width", "height", "labeloffset"], Be = { minlen: 1, weight: 1, width: 0, height: 0, labeloffset: 10, labelpos: "r" }, Ye = ["labelpos"];
function qe(n) {
  var r = new b({ multigraph: true, compound: true }), e = q(n.graph());
  return r.setGraph(A({}, Se, Y(e, Ce), M(e, $e))), s(n.nodes(), function(t) {
    var o = q(n.node(t));
    r.setNode(t, Gn(Y(o, Ve), Fe)), r.setParent(t, n.parent(t));
  }), s(n.edges(), function(t) {
    var o = q(n.edge(t));
    r.setEdge(t, A({}, Be, Y(o, Ge), M(o, Ye)));
  }), r;
}
function ze(n) {
  var r = n.graph();
