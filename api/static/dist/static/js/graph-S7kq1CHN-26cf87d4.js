import { aw as E, ax as L, ay as g, az as v, aA as b } from "./mermaid-CI9Xz-tl-06ae91ae.js";
import { P as N, O as j, $ as _, _ as p, a, E as l, S as f, I as P } from "./_baseUniq-DmAMCrPp-6d586603.js";
var D = E(function(o) {
  return N(j(o, 1, L, true));
}), F = "\0", d = "\0", C = "";
class y {
  constructor(t = {}) {
  ...
  setEdge() {
    var t, e, s, i, r = false, n = arguments[0];
    typeof n == "object" && n !== null && "v" in n ? (t = n.v, e = n.w, s = n.name, arguments.length === 2 && (i = arguments[1], r = true)) : (t = n, e = arguments[1], s = arguments[3], arguments.length > 2 && (i = arguments[2], r = true)), t = "" + t, e = "" + e, l(s) || (s = "" + s);
  ...
  edge(t, e, s) {
    var i = arguments.length === 1 ? m(this._isDirected, arguments[0]) : c(this._isDirected, t, e, s);
  ...
  removeEdge(t, e, s) {
    var i = arguments.length === 1 ? m(this._isDirected, arguments[0]) : c(this._isDirected, t, e, s), r = this._edgeObjs[i];
