import { _ as r, A as mt, X as xt, x as bt, c as kt, l as S, T as _t, U as vt, V as wt, W as St } from "./mermaid-CI9Xz-tl-06ae91ae.js";
import { F as U } from "./viewer-DpLhQV_x-5cf483f8.js";
import { v as et } from "./arc-DRAgoghf-34b8a53f.js";
import "./index-8579fe4a.js";
import "./copy-NOBrwKqN-54f5154b.js";
var G = function() {
  var n = r(function(x, i, c, d) {
    for (c = c || {}, d = x.length; d--; c[x[d]] = i)
      ;
    return c;
  }, "o"), t = [6, 8, 10, 11, 12, 14, 16, 17, 20, 21], e = [1, 9], a = [1, 10], s = [1, 11], h = [1, 12], o = [1, 13], p = [1, 16], g = [1, 17], f = { trace: r(function() {
  }, "trace"), yy: {}, symbols_: { error: 2, start: 3, timeline: 4, document: 5, EOF: 6, line: 7, SPACE: 8, statement: 9, NEWLINE: 10, title: 11, acc_title: 12, acc_title_value: 13, acc_descr: 14, acc_descr_value: 15, acc_descr_multiline_value: 16, section: 17, period_statement: 18, event_statement: 19, period: 20, event: 21, $accept: 0, $end: 1 }, terminals_: { 2: "error", 4: "timeline", 6: "EOF", 8: "SPACE", 10: "NEWLINE", 11: "title", 12: "acc_title", 13: "acc_title_value", 14: "acc_descr", 15: "acc_descr_value", 16: "acc_descr_multiline_value", 17: "section", 20: "period", 21: "event" }, productions_: [0, [3, 3], [5, 0], [5, 2], [7, 2], [7, 1], [7, 1], [7, 1], [9, 1], [9, 2], [9, 2], [9, 1], [9, 1], [9, 1], [9, 1], [18, 1], [19, 1]], performAction: r(function(x, i, c, d, u, l, b) {
    var k = l.length - 1;
    switch (u) {
      case 1:
        return l[k - 1];
  ...
  }, "anonymous"), table: [{ 3: 1, 4: [1, 2] }, { 1: [3] }, n(t, [2, 2], { 5: 3 }), { 6: [1, 4], 7: 5, 8: [1, 6], 9: 7, 10: [1, 8], 11: e, 12: a, 14: s, 16: h, 17: o, 18: 14, 19: 15, 20: p, 21: g }, n(t, [2, 7], { 1: [2, 1] }), n(t, [2, 3]), { 9: 18, 11: e, 12: a, 14: s, 16: h, 17: o, 18: 14, 19: 15, 20: p, 21: g }, n(t, [2, 5]), n(t, [2, 6]), n(t, [2, 8]), { 13: [1, 19] }, { 15: [1, 20] }, n(t, [2, 11]), n(t, [2, 12]), n(t, [2, 13]), n(t, [2, 14]), n(t, [2, 15]), n(t, [2, 16]), n(t, [2, 4]), n(t, [2, 9]), n(t, [2, 10])], defaultActions: {}, parseError: r(function(x, i) {
    if (i.recoverable)
      this.trace(x);
    else {
      var c = new Error(x);
  ...
  }, "parseError"), parse: r(function(x) {
    var i = this, c = [0], d = [], u = [null], l = [], b = this.table, k = "", $ = 0, D = 0, H = 2, L = 1, N = l.slice.call(arguments, 1), m = Object.create(this.lexer), v = { yy: {} };
    ...
    r(j, "lex");
    for (var w, P, T, Y, C = {}, B, A, tt, q; ; ) {
      if (P = c[c.length - 1], this.defaultActions[P] ? T = this.defaultActions[P] : ((w === null || typeof w > "u") && (w = j()), T = b[P] && b[P][w]), typeof T > "u" || !T.length || !T[0]) {
        var Z = "";
        q = [];
        for (B in b[P])
          this.terminals_[B] && B > H && q.push("'" + this.terminals_[B] + "'");
        m.showPosition ? Z = "Parse error on line " + ($ + 1) + `:
` + m.showPosition() + `
Expecting ` + q.join(", ") + ", got '" + (this.terminals_[w] || w) + "'" : Z = "Parse error on line " + ($ + 1) + ": Unexpected " + (w == L ? "end of input" : "'" + (this.terminals_[w] || w) + "'"), this.parseError(Z, { text: m.match, token: this.terminals_[w] || w, line: m.yylineno, loc: M, expected: q });
      }
      if (T[0] instanceof Array && T.length > 1)
        throw new Error("Parse Error: multiple actions possible at state: " + P + ", token: " + w);
      switch (T[0]) {
        case 1:
          c.push(w), u.push(m.yytext), l.push(m.yylloc), c.push(T[1]), w = null, D = m.yyleng, k = m.yytext, $ = m.yylineno, M = m.yylloc;
          break;
        case 2:
          if (A = this.productions_[T[1]][1], C.$ = u[u.length - A], C._$ = { first_line: l[l.length - (A || 1)].first_line, last_line: l[l.length - 1].last_line, first_column: l[l.length - (A || 1)].first_column, last_column: l[l.length - 1].last_column }, R && (C._$.range = [l[l.length - (A || 1)].range[0], l[l.length - 1].range[1]]), Y = this.performAction.apply(C, [k, D, $, v.yy, T[1], u, l].concat(N)), typeof Y < "u")
            return Y;
          A && (c = c.slice(0, -1 * A * 2), u = u.slice(0, -1 * A), l = l.slice(0, -1 * A)), c.push(this.productions_[T[1]][0]), u.push(C.$), l.push(C._$), tt = b[c[c.length - 2]][c[c.length - 1]], c.push(tt);
          break;
        case 3:
          return true;
      }
    ...
    var x = { EOF: 1, parseError: r(function(i, c) {
      if (this.yy.parser)
        this.yy.parser.parseError(i, c);
      else
        throw new Error(i);
    }, "parseError"), setInput: r(function(i, c) {
      return this.yy = c || this.yy || {}, this._input = i, this._more = this._backtrack = this.done = false, this.yylineno = this.yyleng = 0, this.yytext = this.matched = this.match = "", this.conditionStack = ["INITIAL"], this.yylloc = { first_line: 1, first_column: 0, last_line: 1, last_column: 0 }, this.options.ranges && (this.yylloc.range = [0, 0]), this.offset = 0, this;
      ...
      return this.yylloc = { first_line: this.yylloc.first_line, last_line: this.yylineno + 1, first_column: this.yylloc.first_column, last_column: d ? (d.length === u.length ? this.yylloc.first_column : 0) + u[u.length - d.length].length - d[0].length : this.yylloc.first_column - c }, this.options.ranges && (this.yylloc.range = [l[0], l[0] + this.yyleng - c]), this.yyleng = this.yytext.length, this;
...
` + c + "^";
    }, "showPosition"), test_match: r(function(i, c) {
      var d, u, l;
      if (this.options.backtrack_lexer && (l = { yylineno: this.yylineno, yylloc: { first_line: this.yylloc.first_line, last_line: this.last_line, first_column: this.yylloc.first_column, last_column: this.yylloc.last_column }, yytext: this.yytext, match: this.match, matches: this.matches, matched: this.matched, yyleng: this.yyleng, offset: this.offset, _more: this._more, _input: this._input, yy: this.yy, conditionStack: this.conditionStack.slice(0), done: this.done }, this.options.ranges && (l.yylloc.range = this.yylloc.range.slice(0))), u = i[0].match(/(?:\r\n?|\n).*/g), u && (this.yylineno += u.length), this.yylloc = { first_line: this.yylloc.last_line, last_line: this.yylineno + 1, first_column: this.yylloc.last_column, last_column: u ? u[u.length - 1].length - u[u.length - 1].match(/\r?\n?/)[0].length : this.yylloc.last_column + i[0].length }, this.yytext += i[0], this.match += i[0], this.matches = i, this.yyleng = this.yytext.length, this.options.ranges && (this.yylloc.range = [this.offset, this.offset += this.yyleng]), this._more = false, this._backtrack = false, this._input = this._input.slice(i[0].length), this.matched += i[0], d = this.performAction.call(this, this.yy, this, c, this.conditionStack[this.conditionStack.length - 1]), this.done && this._input && (this.done = false), d)
        return d;
      if (this._backtrack) {
        for (var b in l)
          this[b] = l[b];
      ...
      for (var l = this._currentRules(), b = 0; b < l.length; b++)
        if (d = this._input.match(this.rules[l[b]]), d && (!c || d[0].length > c[0].length)) {
          if (c = d, u = b, this.options.backtrack_lexer) {
            if (i = this.test_match(d, l[b]), i !== false)
              return i;
            if (this._backtrack) {
              c = false;
              continue;
      ...
      return c ? (i = this.test_match(c, l[u]), i !== false ? i : false) : this._input === "" ? this.EOF : this.parseError("Lexical error on line " + (this.yylineno + 1) + `. Unrecognized text.
` + this.showPosition(), { text: "", token: null, line: this.yylineno });
    }, "next"), lex: r(function() {
      var i = this.next();
      return i || this.lex();
    }, "lex"), begin: r(function(i) {
    ...
    }, "_currentRules"), topState: r(function(i) {
      return i = this.conditionStack.length - 1 - Math.abs(i || 0), i >= 0 ? this.conditionStack[i] : "INITIAL";
    }, "topState"), pushState: r(function(i) {
      this.begin(i);
    }, "pushState"), stateStackSize: r(function() {
      return this.conditionStack.length;
    }, "stateStackSize"), options: { "case-insensitive": true }, performAction: r(function(i, c, d, u) {
      switch (d) {
        case 0:
          break;
        case 1:
...
G.parser = G;
var $t = G, rt = {};
mt(rt, { addEvent: () => pt, addSection: () => lt, addTask: () => ut, addTaskOrg: () => yt, clear: () => ct, default: () => Et, getCommonDb: () => ot, getSections: () => ht, getTasks: () => dt });
var F = "", at = 0, J = [], V = [], z = [], ot = r(() => xt, "getCommonDb"), ct = r(function() {
  J.length = 0, V.length = 0, F = "", z.length = 0, bt();
}, "clear"), lt = r(function(n) {
  F = n, J.push(n);
  ...
  for (; !n && e < t; )
    n = nt(), e++;
  return V.push(...z), V;
}, "getTasks"), ut = r(function(n, t, e) {
  const a = { id: at++, section: F, type: F, task: n, score: t || 0, events: e ? [e] : [] };
  z.push(a);
}, "addTask"), pt = r(function(n) {
  z.find((t) => t.id === at - 1).events.push(n);
}, "addEvent"), yt = r(function(n) {
  const t = { section: F, type: F, description: n, task: n, classes: [] };
  V.push(t);
}, "addTaskOrg"), nt = r(function() {
  ...
  for (const [e, a] of z.entries())
    n(e), t = t && a.processed;
  return t;
}, "compileTasks"), Et = { clear: ct, getCommonDb: ot, addSection: lt, getSections: ht, getTasks: dt, addTask: ut, addTaskOrg: yt, addEvent: pt }, Tt = 12, X = r(function(n, t) {
...
}, "drawLabel"), Lt = r(function(n, t, e) {
  const a = n.append("g"), s = K();
  s.x = t.x, s.y = t.y, s.fill = t.fill, s.width = e.width, s.height = e.height, s.class = "journey-section section-type-" + t.num, s.rx = 3, s.ry = 3, X(a, s), ft(e)(t.text, a, s.x, s.y, s.width, s.height, { class: "journey-section section-type-" + t.num }, e, t.colour);
}, "drawSection"), it = -1, Pt = r(function(n, t, e) {
  const a = t.x + e.width / 2, s = n.append("g");
  it++;
  const h = 300 + 5 * 30;
  s.append("line").attr("id", "task" + it).attr("x1", a).attr("y1", t.y).attr("x2", a).attr("y2", h).attr("class", "task-line").attr("stroke-width", "1px").attr("stroke-dasharray", "4 2").attr("stroke", "#666"), It(s, { cx: a, cy: 300 + (5 - t.score) * 30, score: t.score });
  const o = K();
  o.x = t.x, o.y = t.y, o.fill = t.fill, o.width = e.width, o.height = e.height, o.class = "task task-type-" + t.num, o.rx = 3, o.ry = 3, X(s, o), ft(e)(t.task, s, o.x, o.y, o.width, o.height, { class: "task" }, e, t.colour);
}, "drawTask"), Ot = r(function(n, t) {
  X(n, { x: t.startx, y: t.starty, width: t.stopx - t.startx, height: t.stopy - t.starty, fill: t.fill, class: "rect" }).lower();
}, "drawBackgroundRect"), Ht = r(function() {
  return { x: 0, y: 0, fill: void 0, "text-anchor": "start", width: 100, height: 100, textMargin: 0, rx: 0, ry: 0 };
}, "getTextObj"), K = r(function() {
...
function Q(n, t) {
  n.each(function() {
    var e = U(this), a = e.text().split(/(\s+|<br>)/).reverse(), s, h = [], o = 1.1, p = e.attr("y"), g = parseFloat(e.attr("dy")), f = e.text(null).append("tspan").attr("x", 0).attr("y", p).attr("dy", g + "em");
...
r(Q, "wrap");
var Ct = r(function(n, t, e, a) {
  var s;
  const h = e % Tt - 1, o = n.append("g");
  t.section = h, o.attr("class", (t.class ? t.class + " " : "") + "timeline-node " + ("section-" + h));
...
}, "getVirtualNodeHeight"), zt = r(function(n, t, e) {
...
}, "defaultBkg"), O = { drawRect: X, drawCircle: Mt, drawSection: Lt, drawText: gt, drawLabel: At, drawTask: Pt, drawBackgroundRect: Ot, getTextObj: Ht, getNoteRect: K, initGraphics: Rt, drawNode: Ct, getVirtualNodeHeight: Ft }, Dt = r(function(n, t, e, a) {
  var s, h;
  ...
  let f;
  g === "sandbox" && (f = U("#i" + t));
  const y = (g === "sandbox" ? U(f.nodes()[0].contentDocument.body) : U("body")).select("#" + t);
  y.append("g");
  ...
  i.forEach(function(m) {
    const v = { number: $, descr: m, section: $, width: 150, padding: 20, maxHeight: c }, I = O.getVirtualNodeHeight(y, v, o);
    S.debug("sectionHeight before draw", I), c = Math.max(c, I + 20);
  });
  let H = 0, L = 0;
  S.debug("tasks.length", _.length);
  for (const [m, v] of _.entries()) {
    const I = { number: m, descr: v, section: v.section, width: 150, padding: 20, maxHeight: d }, M = O.getVirtualNodeHeight(y, I, o);
    S.debug("taskHeight before draw", M), d = Math.max(d, M + 20), H = Math.max(H, v.events.length);
    let R = 0;
    for (const W of v.events) {
      const j = { descr: W, section: v.section, number: v.section, width: 150, padding: 20, maxHeight: 50 };
      R += O.getVirtualNodeHeight(y, j, o);
    }
    L = Math.max(L, R);
  }
  S.debug("maxSectionHeight before draw", c), S.debug("maxTaskHeight before draw", d), i && i.length > 0 ? i.forEach((m) => {
    const v = _.filter((W) => W.section === m), I = { number: $, descr: m, section: $, width: 200 * Math.max(v.length, 1) - 50, padding: 20, maxHeight: c };
    S.debug("sectionNode", I);
    const M = y.append("g"), R = O.drawNode(M, I, $, o);
    S.debug("sectionNode output", R), M.attr("transform", `translate(${b}, ${l})`), k += c + 50, v.length > 0 && st(y, v, $, b, k, d, o, H, L, c, false), b += 200 * Math.max(v.length, 1), k = l, $++;
  }) : (D = false, st(y, _, $, b, k, d, o, H, L, c, true));
  const N = y.node().getBBox();
  S.debug("bounds", N), x && y.append("text").text(x).attr("x", N.width / 2 - p).attr("font-size", "4ex").attr("font-weight", "bold").attr("y", 20), u = D ? c + d + 150 : d + 100, y.append("g").attr("class", "lineWrapper").append("line").attr("x1", p).attr("y1", u).attr("x2", N.width + 3 * p).attr("y2", u).attr("stroke-width", 4).attr("stroke", "black").attr("marker-end", "url(#arrowhead)"), _t(void 0, y, ((s = o.timeline) == null ? void 0 : s.padding) ?? 50, ((h = o.timeline) == null ? void 0 : h.useMaxWidth) ?? false);
}, "draw"), st = r(function(n, t, e, a, s, h, o, p, g, f, y) {
  var _;
  for (const x of t) {
    const i = { descr: x.task, section: e, number: e, width: 150, padding: 20, maxHeight: h };
    S.debug("taskNode", i);
    ...
    if (S.debug("taskHeight after draw", d), c.attr("transform", `translate(${a}, ${s})`), h = Math.max(h, d), x.events) {
      ...
      let l = h;
      s += 100, l = l + Nt(n, x.events, e, a, s, o), s -= 100, u.append("line").attr("x1", a + 190 / 2).attr("y1", s + h).attr("x2", a + 190 / 2).attr("y2", s + h + (y ? h : f) + g + 120).attr("stroke-width", 2).attr("stroke", "black").attr("marker-end", "url(#arrowhead)").attr("stroke-dasharray", "5,5");
    }
    a = a + 200, y && !((_ = o.timeline) != null && _.disableMulticolor) && e++;
  }
  s = s - 10;
}, "drawTasks"), Nt = r(function(n, t, e, a, s, h) {
  let o = 0;
  const p = s;
  s = s + 100;
  for (const g of t) {
    const f = { descr: g, section: e, number: e, width: 150, padding: 20, maxHeight: 50 };
    S.debug("eventNode", f);
    const y = n.append("g").attr("class", "eventWrapper"), _ = O.drawNode(y, f, e, h).height;
    o = o + _, y.attr("transform", `translate(${a}, ${s})`), s = s + 10 + _;
  }
  return s = p, o;
}, "drawEvents"), Wt = { setConf: r(() => {
}, "setConf"), draw: Dt }, jt = r((n) => {
  let t = "";
...
`, "getStyles"), qt = Bt, Gt = { db: rt, renderer: Wt, parser: $t, styles: qt };
export {
  Gt as diagram
};
