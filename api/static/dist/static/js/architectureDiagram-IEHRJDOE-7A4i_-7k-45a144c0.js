import { E as $e, _ as rt, aE as je, aD as qe, o as Ze, p as Ke, b as Qe, a as Je, s as ti, g as ei, c as he, l as Ge, x as ii, G as ri, T as ni, ag as Ne, aC as fe } from "./mermaid-j5R1o_wi-7b9be563.js";
import { m as oi } from "./chunk-4BMEZGHF-Bo7Lw3Zg-cc1263d3.js";
import { e as ai } from "./chunk-XZIHB7SX-BpJ6eI-3-681631a4.js";
import { u as si } from "./mermaid-parser.core-CNGL96jf-268968b7.js";
import { J as Pe } from "./cytoscape.esm-Swd9B-1A-1060bb3e.js";
import { E as hi } from "./index-7b696e01.js";
import { L as li } from "./helper-7WMIPux3-736d9956.js";
    ...
    (function(L, U) {
      ...
      return function(L) {
        ...
        function T(u) {
          if (U[u])
            return U[u].exports;
          var l = U[u] = { i: u, l: false, exports: {} };
          return L[u].call(l.exports, l, l.exports, T), l.l = true, l.exports;
        }
        return T.m = L, T.c = U, T.i = function(u) {
          return u;
        }, T.d = function(u, l, o) {
          T.o(u, l) || Object.defineProperty(u, l, { configurable: false, enumerable: true, get: o });
        }, T.n = function(u) {
        ...
        function i(h, r, f) {
          u.call(this, f), this.isOverlapingSourceAndTarget = false, this.vGraphObject = f, this.bendpoints = [], this.source = h, this.target = r;
        }
        ...
        function s(g, c, N) {
          u.call(this, N), this.estimatedSize = l.MIN_VALUE, this.margin = o.DEFAULT_GRAPH_MARGIN, this.edges = [], this.nodes = [], this.isConnected = false, this.parent = g, c != null && c instanceof i ? this.graphManager = c : c != null && c instanceof Layout && (this.graphManager = c.graphManager);
        }
        ...
        s.prototype.getNodes = function() {
          ...
          if (c == null && N == null) {
            ...
            return c.owner != N.owner ? null : (y.source = c, y.target = N, y.isInterGraph = false, this.getEdges().push(y), c.edges.push(y), N != c && N.edges.push(y), y);
          }
          ...
          for (var g = l.MAX_VALUE, c = l.MAX_VALUE, N, d, y, w = this.getNodes(), I = w.length, P = 0; P < I; P++) {
            var S = w[P];
          ...
          for (var c = l.MAX_VALUE, N = -l.MAX_VALUE, d = l.MAX_VALUE, y = -l.MAX_VALUE, w, I, P, S, Y, W = this.nodes, B = W.length, x = 0; x < B; x++) {
            var nt = W[x];
            g && nt.child != null && nt.updateBounds(), w = nt.getLeft(), I = nt.getRight(), P = nt.getTop(), S = nt.getBottom(), c > w && (c = w), N < I && (N = I), d > P && (d = P), y < S && (y = S);
          }
          ...
          for (var c = l.MAX_VALUE, N = -l.MAX_VALUE, d = l.MAX_VALUE, y = -l.MAX_VALUE, w, I, P, S, Y = g.length, W = 0; W < Y; W++) {
            var B = g[W];
            w = B.getLeft(), I = B.getRight(), P = B.getTop(), S = B.getBottom(), c > w && (c = w), N < I && (N = I), d > P && (d = P), y < S && (y = S);
          }
          ...
          var c = new e(), N = /* @__PURE__ */ new Set(), d = this.nodes[0], y, w, I = d.withChildren();
          ...
          if (this.isConnected = false, N.size >= this.nodes.length) {
            ...
            N.forEach(function(x) {
              x.owner == g && B++;
            }), B == this.nodes.length && (this.isConnected = true);
          }
        }, L.exports = s;
      }, function(L, U, T) {
        var u, l = T(1);
        ...
        o.prototype.addRoot = function() {
          ...
          if (h == null && r == null && f == null) {
            ...
            if (e == s)
              return h.isInterGraph = false, e.add(h, r, f);
            if (h.isInterGraph = true, h.source = r, h.target = f, this.edges.indexOf(h) > -1)
        ...
        l.calcSeparationAmount = function(o, i, t, h) {
          ...
          if (o.intersects(i))
            return t[0] = h, t[1] = r, t[2] = f, t[3] = e, true;
          var s = o.getX(), a = o.getY(), g = o.getRight(), c = o.getX(), N = o.getBottom(), d = o.getRight(), y = o.getWidthHalf(), w = o.getHeightHalf(), I = i.getX(), P = i.getY(), S = i.getRight(), Y = i.getX(), W = i.getBottom(), B = i.getRight(), x = i.getWidthHalf(), nt = i.getHeightHalf(), n = false, E = false;
          if (h === f) {
            if (r > e)
              return t[0] = h, t[1] = a, t[2] = f, t[3] = W, false;
            if (r < e)
              return t[0] = h, t[1] = N, t[2] = f, t[3] = P, false;
          } else if (r === e) {
            if (h > f)
              return t[0] = s, t[1] = r, t[2] = S, t[3] = e, false;
            if (h < f)
              return t[0] = g, t[1] = r, t[2] = I, t[3] = e, false;
          } else {
            var p = o.height / o.width, v = i.height / i.width, m = (e - r) / (f - h), O = void 0, _ = void 0, C = void 0, F = void 0, k = void 0, V = void 0;
            if (-p === m ? h > f ? (t[0] = c, t[1] = N, n = true) : (t[0] = g, t[1] = a, n = true) : p === m && (h > f ? (t[0] = s, t[1] = a, n = true) : (t[0] = d, t[1] = N, n = true)), -v === m ? f > h ? (t[2] = Y, t[3] = W, E = true) : (t[2] = S, t[3] = P, E = true) : v === m && (f > h ? (t[2] = I, t[3] = P, E = true) : (t[2] = B, t[3] = W, E = true)), n && E)
              return false;
          ...
          var r = o.x, f = o.y, e = i.x, s = i.y, a = t.x, g = t.y, c = h.x, N = h.y, d = void 0, y = void 0, w = void 0, I = void 0, P = void 0, S = void 0, Y = void 0, W = void 0, B = void 0;
          return w = s - f, P = r - e, Y = e * f - r * s, I = N - g, S = a - c, W = c * g - a * N, B = w * S - I * P, B === 0 ? null : (d = (P * W - S * Y) / B, y = (I * Y - w * W) / B, new u(d, y));
        ...
        var o = function(r) {
          ...
          function r(f) {
            var e = this;
            l(this, r), this.length = 0, this.head = null, this.tail = null, f == null ? void 0 : f.forEach(function(s) {
              return e.push(s);
            });
          }
          return u(r, [{ key: "size", value: function() {
            return this.length;
          } }, { key: "insertBefore", value: function(f, e) {
            return i(e.prev, o(f), e, this);
          } }, { key: "insertAfter", value: function(f, e) {
            return i(e, o(f), e.next, this);
          } }, { key: "insertNodeBefore", value: function(f, e) {
            return i(e.prev, f, e, this);
          } }, { key: "insertNodeAfter", value: function(f, e) {
          ...
          } }, { key: "set_object_at", value: function(f, e) {
            if (f <= this.length()) {
        ...
        s.RANDOM_SEED = 1, s.prototype = Object.create(e.prototype), s.prototype.getGraphManager = function() {
          ...
          var a;
          return this.checkLayoutSuccess() ? a = false : a = this.layout(), l.ANIMATE === "during" ? false : (a && (this.isSubLayout || this.doPostLayout()), this.tilingPostLayout && this.tilingPostLayout(), this.isLayoutFinished = true, a);
          ...
          for (var a = [], g = true, c = this.graphManager.getRoot().getNodes(), N = true, d = 0; d < c.length; d++)
            c[d].getChild() != null && (N = false);
          if (!N)
            return a;
          var y = /* @__PURE__ */ new Set(), w = [], I = /* @__PURE__ */ new Map(), P = [];
          ...
          for (var g = 0; g < a.length; g++) {
            ...
            if (c.bendpoints.length > 0) {
              for (var N = this.edgeToDummyNodes.get(c), d = 0; d < N.length; d++) {
                var y = N[d], w = new r(y.getCenterX(), y.getCenterY()), I = c.bendpoints.get(d);
                I.x = w.x, I.y = w.y, y.getOwner().remove(y);
              }
          ...
          if (c != null && N != null) {
            ...
            var I, P;
            return a <= 50 ? (I = 9 * g / 500, P = g / 10) : (I = 9 * g / 50, P = -8 * g), I * a + P;
          }
        }, s.findCenterOfTree = function(a) {
          var g = [];
          g = g.concat(a);
          var c = [], N = /* @__PURE__ */ new Map(), d = false, y = null;
          (g.length == 1 || g.length == 2) && (d = true, y = g[0]);
          for (var w = 0; w < g.length; w++) {
            var I = g[w], P = I.getNeighborsList().size;
            N.set(I, I.getNeighborsList().size), P == 1 && c.push(I);
          }
          var S = [];
          for (S = S.concat(c); !d; ) {
            var Y = [];
            Y = Y.concat(S), S = [];
            for (var w = 0; w < g.length; w++) {
              var I = g[w], W = g.indexOf(I);
              W >= 0 && g.splice(W, 1);
              var B = I.getNeighborsList();
            ...
            c = c.concat(S), (g.length == 1 || g.length == 2) && (d = true, y = g[0]);
          }
          return y;
        ...
        r.prototype.initParameters = function() {
          ...
          var e = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : true, s = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : false, a, g, c, N, d = this.getAllNodes(), y;
          ...
          var a = e.getRect(), g = s.getRect(), c = new Array(2), N = new Array(4), d, y, w, I, P, S, Y;
          if (a.intersects(g)) {
            ...
            for (var N, d = this.grid, y = e.startX - 1; y < e.finishX + 2; y++)
              for (var w = e.startY - 1; w < e.finishY + 2; w++)
                if (!(y < 0 || w < 0 || y >= d.length || w >= d[0].length)) {
                  for (var I = 0; I < d[y][w].length; I++)
                    if (N = d[y][w][I], !(e.getOwner() != N.getOwner() || e == N) && !s.has(N) && !c.has(N)) {
        ...
        var u = function() {
          function t(h, r) {
            for (var f = 0; f < r.length; f++) {
              var e = r[f];
              e.enumerable = e.enumerable || false, e.configurable = true, "value" in e && (e.writable = true), Object.defineProperty(h, e.key, e);
            }
          }
        ...
        var o = T(11), i = function() {
          ...
          return u(t, [{ key: "_quicksort", value: function(h, r, f) {
            if (r < f) {
              var e = this._partition(h, r, f);
              this._quicksort(h, r, e), this._quicksort(h, e + 1, f);
            }
          } }, { key: "_partition", value: function(h, r, f) {
          ...
          } }, { key: "_get", value: function(h, r) {
            return h instanceof o ? h.get_object_at(r) : h[r];
          } }, { key: "_set", value: function(h, r, f) {
            h instanceof o ? h.set_object_at(r, f) : h[r] = f;
          } }, { key: "_swap", value: function(h, r, f) {
            var e = this._get(h, r);
            this._set(h, r, this._get(h, f)), this._set(h, f, e);
          } }, { key: "_defaultCompareFunction", value: function(h, r) {
            return r > h;
          } }]), t;
        }();
        L.exports = i;
        ...
        u.svd = function(l) {
          ...
          for (var i = function(Mt) {
            for (var At = []; Mt-- > 0; )
              At.push(0);
            return At;
          }(this.n), t = function(Mt) {
            for (var At = []; Mt-- > 0; )
              At.push(0);
            return At;
          }(this.m), h = true, r = Math.min(this.m - 1, this.n), f = Math.max(0, Math.min(this.n - 2, this.m)), e = 0; e < Math.max(r, f); e++) {
            if (e < r) {
              this.s[e] = 0;
          ...
          for (var q = n - 1, et = Math.pow(2, -52), vt = Math.pow(2, -966); n > 0; ) {
            ...
            switch (j++, Dt) {
              ...
              case 3:
                {
                  var $t = Math.max(Math.max(Math.max(Math.max(Math.abs(this.s[n - 1]), Math.abs(this.s[n - 2])), Math.abs(i[n - 2])), Math.abs(this.s[j])), Math.abs(i[j])), dt = this.s[n - 1] / $t, M = this.s[n - 2] / $t, R = i[n - 2] / $t, $ = this.s[j] / $t, Q = i[j] / $t, K = ((M + dt) * (M - dt) + R * R) / 2, pt = dt * R * (dt * R), lt = 0;
                  (function(Mt, At) {
                    return Mt || At;
        ...
        var u = function() {
          function i(t, h) {
            for (var r = 0; r < h.length; r++) {
              var f = h[r];
              f.enumerable = f.enumerable || false, f.configurable = true, "value" in f && (f.writable = true), Object.defineProperty(t, f.key, f);
            }
          }
        ...
        var o = function() {
          ...
          return u(i, [{ key: "getScore", value: function() {
            return this.score;
          } }, { key: "getAlignments", value: function() {
            return this.alignments;
          } }, { key: "computeGrids", value: function() {
            for (var t = 1; t < this.jMax; t++)
              this.grid[0][t] = this.grid[0][t - 1] + this.gap_penalty, this.tracebackGrid[0][t] = [false, false, true];
            ...
            var t = [];
            for (t.push({ pos: [this.sequence1.length, this.sequence2.length], seq1: "", seq2: "" }); t[0]; ) {
              var h = t[0], r = this.tracebackGrid[h.pos[0]][h.pos[1]];
              r[0] && t.push({ pos: [h.pos[0] - 1, h.pos[1] - 1], seq1: this.sequence1[h.pos[0] - 1] + h.seq1, seq2: this.sequence2[h.pos[1] - 1] + h.seq2 }), r[1] && t.push({ pos: [h.pos[0] - 1, h.pos[1]], seq1: this.sequence1[h.pos[0] - 1] + h.seq1, seq2: "-" + h.seq2 }), r[2] && t.push({ pos: [h.pos[0], h.pos[1] - 1], seq1: "-" + h.seq1, seq2: this.sequence2[h.pos[1] - 1] + h.seq2 }), h.pos[0] === 0 && h.pos[1] === 0 && this.alignments.push({ sequence1: h.seq1, sequence2: h.seq2 }), t.shift();
            }
            return this.alignments;
          } }, { key: "getAllIndexes", value: function(t, h) {
            for (var r = [], f = -1; (f = t.indexOf(h, f + 1)) !== -1; )
              r.push(f);
            return r;
          } }, { key: "arrayAllMaxIndexes", value: function(t) {
        ...
        l.addListener = function(o, i) {
          this.listeners.push({ event: o, callback: i });
    ...
    (function(L, U) {
      ...
      return (() => {
        var U = { 45: (o, i, t) => {
          ...
          var h = t(551).FDLayout, r = t(578), f = t(880), e = t(991), s = t(767), a = t(806), g = t(902), c = t(551).FDLayoutConstants, N = t(551).LayoutConstants, d = t(551).Point, y = t(551).PointD, w = t(551).DimensionD, I = t(551).Layout, P = t(551).Integer, S = t(551).IGeometry, Y = t(551).LGraph, W = t(551).Transform, B = t(551).LinkedList;
          function x() {
          ...
          x.prototype.newGraphManager = function() {
            ...
            return Object.keys(this.constraints).length > 0 && (g.handleConstraints(this), this.initConstraintVariables()), this.initSpringEmbedder(), a.APPLY_LAYOUT && this.runSpringEmbedder(), true;
            ...
            for (var n = this.graphManager.getAllNodes(), E = {}, p = 0; p < n.length; p++) {
              ...
              E[m] = { id: m, x: v.getCenterX(), y: v.getCenterY(), w: v.width, h: v.height };
            }
            return E;
            ...
            for (var E = new d(0, 0), p = Math.ceil(Math.sqrt(n.length)), v = 0, m = 0, O = 0, _ = new y(0, 0), C = 0; C < n.length; C++) {
              ...
              var F = n[C], k = I.findCenterOfTree(F);
            ...
            var p = this.tileNodesByFavoringDim(n, E, true), v = this.tileNodesByFavoringDim(n, E, false), m = this.getOrgRatio(p), O = this.getOrgRatio(v), _;
            ...
            var v = a.TILING_PADDING_VERTICAL, m = a.TILING_PADDING_HORIZONTAL, O = a.TILING_COMPARE_BY, _ = { rows: [], rowWidth: [], rowHeight: [], width: 0, height: E, verticalPadding: v, horizontalPadding: m, centerX: 0, centerY: 0 };
          ...
          a.handleConstraints = function(g) {
            ...
            for (var N = /* @__PURE__ */ new Map(), d = /* @__PURE__ */ new Map(), y = [], w = [], I = g.getAllNodes(), P = 0, S = 0; S < I.length; S++) {
              var Y = I[S];
            ...
            c.relativePlacementConstraint && c.relativePlacementConstraint.forEach(function(M) {
              !M.gap && M.gap != 0 && (M.left ? M.gap = r.DEFAULT_EDGE_LENGTH + N.get(M.left).getWidth() / 2 + N.get(M.right).getWidth() / 2 : M.gap = r.DEFAULT_EDGE_LENGTH + N.get(M.top).getHeight() / 2 + N.get(M.bottom).getHeight() / 2);
            });
            var W = function(M, R) {
              ...
              function pt(ct, at) {
                var st = new Set(ct), It = true, ut = false, Ot = void 0;
                try {
                  for (var kt = at[Symbol.iterator](), Mt; !(It = (Mt = kt.next()).done); It = true) {
                    var At = Mt.value;
                    st.add(At);
                  }
                } catch (Ht) {
              ...
              lt.forEach(function(ct, at) {
                ...
                if (ct.forEach(function(ut) {
                  ...
                  ct.forEach(function(ut) {
                    R == "horizontal" ? It += d.has(ut) ? y[d.get(ut)] : Q.get(ut) : It += d.has(ut) ? w[d.get(ut)] : Q.get(ut);
              ...
              for (var Nt = function() {
                var ct = it.shift(), at = M.get(ct);
                at.forEach(function(st) {
                  if (tt.get(st.id) < tt.get(ct) + st.gap)
                    if ($ && $.has(st.id)) {
                      var It = void 0;
                      if (R == "horizontal" ? It = d.has(st.id) ? y[d.get(st.id)] : Q.get(st.id) : It = d.has(st.id) ? w[d.get(st.id)] : Q.get(st.id), tt.set(st.id, It), It < tt.get(ct) + st.gap) {
              ...
              if ($) {
                ...
                gt.forEach(function(ct, at) {
                  if (yt.has(at)) {
                    ...
                    try {
                      for (var kt = ct[Symbol.iterator](), Mt; !(It = (Mt = kt.next()).done); It = true) {
                        var At = Mt.value;
                        $.has(At) && (st = true);
                      }
                    } catch (Rt) {
                    ...
                    if (!st) {
                      ...
                      Ct.forEach(function(Rt, Ut) {
                        Rt.has([].concat(h(ct))[0]) && (Ht = true, Yt = Ut);
                  ...
                  var st = Number.POSITIVE_INFINITY, It = Number.POSITIVE_INFINITY, ut = Number.NEGATIVE_INFINITY, Ot = Number.NEGATIVE_INFINITY, kt = true, Mt = false, At = void 0;
                  try {
                    for (var Ht = ct[Symbol.iterator](), Yt; !(kt = (Yt = Ht.next()).done); kt = true) {
                      var Rt = Yt.value, Ut = void 0;
                      R == "horizontal" ? Ut = d.has(Rt) ? y[d.get(Rt)] : Q.get(Rt) : Ut = d.has(Rt) ? w[d.get(Rt)] : Q.get(Rt);
                      var Kt = tt.get(Rt);
                      Ut < st && (st = Ut), Ut > ut && (ut = Ut), Kt < It && (It = Kt), Kt > Ot && (Ot = Kt);
                    }
                  } catch (Zt) {
                    Mt = true, At = Zt;
                  } finally {
                  ...
                  var le = (st + ut) / 2 - (It + Ot) / 2, re = true, Qt = false, Jt = void 0;
                  try {
                    for (var qt = ct[Symbol.iterator](), te; !(re = (te = qt.next()).done); re = true) {
                      var oe = te.value;
            ...
            }, v = [], m = [], O = false, _ = false, C = /* @__PURE__ */ new Set(), F = /* @__PURE__ */ new Map(), k = /* @__PURE__ */ new Map(), V = [];
            if (c.fixedNodeConstraint && c.fixedNodeConstraint.forEach(function(M) {
              C.add(M.nodeId);
            }), c.relativePlacementConstraint && (c.relativePlacementConstraint.forEach(function(M) {
              M.left ? (F.has(M.left) ? F.get(M.left).push({ id: M.right, gap: M.gap, direction: "horizontal" }) : F.set(M.left, [{ id: M.right, gap: M.gap, direction: "horizontal" }]), F.has(M.right) || F.set(M.right, [])) : (F.has(M.top) ? F.get(M.top).push({ id: M.bottom, gap: M.gap, direction: "vertical" }) : F.set(M.top, [{ id: M.bottom, gap: M.gap, direction: "vertical" }]), F.has(M.bottom) || F.set(M.bottom, []));
              ...
              if (c.fixedNodeConstraint && c.fixedNodeConstraint.length > 1)
                c.fixedNodeConstraint.forEach(function(M, R) {
                  v[R] = [M.position.x, M.position.y], m[R] = [y[d.get(M.nodeId)], w[d.get(M.nodeId)]];
                }), O = true;
                  ...
                  if (c.alignmentConstraint.vertical) {
                    for (var R = c.alignmentConstraint.vertical, $ = function(tt) {
                      ...
                      it.size > 0 ? Nt = y[d.get(it.values().next().value)] : Nt = B(gt).x, R[tt].forEach(function(yt) {
                        v[M] = [Nt, w[d.get(yt)]], m[M] = [y[d.get(yt)], w[d.get(yt)]], M++;
                      });
                    }, Q = 0; Q < R.length; Q++)
                      $(Q);
                    O = true;
                  ...
                  if (c.alignmentConstraint.horizontal) {
                    for (var K = c.alignmentConstraint.horizontal, pt = function(tt) {
                      ...
                      it.size > 0 ? Nt = y[d.get(it.values().next().value)] : Nt = B(gt).y, K[tt].forEach(function(yt) {
                        v[M] = [y[d.get(yt)], Nt], m[M] = [y[d.get(yt)], w[d.get(yt)]], M++;
                      });
                    }, lt = 0; lt < K.length; lt++)
                      pt(lt);
                    O = true;
                  }
                  c.relativePlacementConstraint && (_ = true);
                })();
              else if (c.relativePlacementConstraint) {
                for (var z = 0, H = 0, Z = 0; Z < V.length; Z++)
                  V[Z].length > z && (z = V[Z].length, H = Z);
                if (z < k.size / 2)
                  nt(c.relativePlacementConstraint), O = false, _ = false;
                else {
                  var G = /* @__PURE__ */ new Map(), D = /* @__PURE__ */ new Map(), b = [];
                  V[H].forEach(function(M) {
                    F.get(M).forEach(function(R) {
                  ...
                  V[H].forEach(function(M, R) {
                    m[R] = [y[d.get(M)], w[d.get(M)]], v[R] = [], q.has(M) ? v[R][0] = q.get(M) : v[R][0] = y[d.get(M)], et.has(M) ? v[R][1] = et.get(M) : v[R][1] = w[d.get(M)];
                  }), O = true;
                }
              }
              if (O) {
            ...
            if (r.ENFORCE_CONSTRAINTS) {
              if (c.fixedNodeConstraint && c.fixedNodeConstraint.length > 0) {
                var wt = { x: 0, y: 0 };
                c.fixedNodeConstraint.forEach(function(M, R) {
                  var $ = { x: y[d.get(M.nodeId)], y: w[d.get(M.nodeId)] }, Q = M.position, K = W(Q, $);
                  wt.x += K.x, wt.y += K.y;
                }), wt.x /= c.fixedNodeConstraint.length, wt.y /= c.fixedNodeConstraint.length, y.forEach(function(M, R) {
                  y[R] += wt.x;
                }), w.forEach(function(M, R) {
                  w[R] += wt.y;
                }), c.fixedNodeConstraint.forEach(function(M) {
                  y[d.get(M.nodeId)] = M.position.x, w[d.get(M.nodeId)] = M.position.y;
                });
              }
              if (c.alignmentConstraint) {
                if (c.alignmentConstraint.vertical)
                  for (var zt = c.alignmentConstraint.vertical, bt = function(M) {
                    ...
                    bt(Gt);
                if (c.alignmentConstraint.horizontal)
                  for (var Ft = c.alignmentConstraint.horizontal, Vt = function(M) {
                    var R = /* @__PURE__ */ new Set();
                    Ft[M].forEach(function(K) {
                      R.add(K);
                    });
                    var $ = new Set([].concat(h(R)).filter(function(K) {
                      return C.has(K);
              ...
              c.relativePlacementConstraint && function() {
                var M = /* @__PURE__ */ new Map(), R = /* @__PURE__ */ new Map(), $ = /* @__PURE__ */ new Map(), Q = /* @__PURE__ */ new Map(), K = /* @__PURE__ */ new Map(), pt = /* @__PURE__ */ new Map(), lt = /* @__PURE__ */ new Set(), tt = /* @__PURE__ */ new Set();
                  ...
                  if (c.alignmentConstraint.vertical)
                    for (var gt = c.alignmentConstraint.vertical, it = function(ft) {
                      $.set("dummy" + ft, []), gt[ft].forEach(function(xt) {
                        M.set(xt, "dummy" + ft), $.get("dummy" + ft).push(xt), C.has(xt) && lt.add("dummy" + ft);
                ...
                var at = /* @__PURE__ */ new Map(), st = /* @__PURE__ */ new Map(), It = function(ft) {
                  F.get(ft).forEach(function(xt) {
                    ...
                    xt.direction == "horizontal" ? (Wt = M.get(ft) ? M.get(ft) : ft, M.get(xt.id) ? Bt = { id: M.get(xt.id), gap: xt.gap, direction: xt.direction } : Bt = xt, at.has(Wt) ? at.get(Wt).push(Bt) : at.set(Wt, [Bt]), at.has(Bt.id) || at.set(Bt.id, [])) : (Wt = R.get(ft) ? R.get(ft) : ft, R.get(xt.id) ? Bt = { id: R.get(xt.id), gap: xt.gap, direction: xt.direction } : Bt = xt, st.has(Wt) ? st.get(Wt).push(Bt) : st.set(Wt, [Bt]), st.has(Bt.id) || st.set(Bt.id, []));
                  });
                }, ut = true, Ot = false, kt = void 0;
                try {
                  for (var Mt = F.keys()[Symbol.iterator](), At; !(ut = (At = Mt.next()).done); ut = true) {
                    var Ht = At.value;
                    It(Ht);
                  }
                } catch (ft) {
                ...
                }, Zt = true, Ae = false, we = void 0;
                try {
                  for (var ce = qt.keys()[Symbol.iterator](), Ie; !(Zt = (Ie = ce.next()).done); Zt = true) {
                    var de = Ie.value;
                    oe(de);
                  }
                } catch (ft) {
                ...
                }, ge = true, Me = false, Le = void 0;
                try {
                  for (var ue = te.keys()[Symbol.iterator](), _e; !(ge = (_e = ue.next()).done); ge = true) {
                    var de = _e.value;
                    Be(de);
                  }
                } catch (ft) {
    ...
    (function(L, U) {
      ...
      return (() => {
        var U = { 658: (o) => {
          ...
          var h = function() {
            function e(s, a) {
              var g = [], c = true, N = false, d = void 0;
              try {
                for (var y = s[Symbol.iterator](), w; !(c = (w = y.next()).done) && (g.push(w.value), !(a && g.length === a)); c = true)
                  ;
              } catch (I) {
                N = true, d = I;
              } finally {
          ...
          f.getTopMostNodes = function(e) {
            ...
            var c = new r(), N = /* @__PURE__ */ new Set(), d = [], y = void 0, w = void 0, I = void 0, P = false, S = 1, Y = [], W = [], B = function() {
              var x = e.collection();
              W.push(x);
              ...
              }), d.length == a.length && (P = true), !P || P && S > 1) {
                w = d[0], I = w.connectedEdges().length, d.forEach(function(v) {
                  v.connectedEdges().length < I && (I = v.connectedEdges().length, w = v);
                }), Y.push(w.id());
                var p = e.collection();
            ...
            if (!a.fixedNodeConstraint) {
              ...
              if (a.quality == "draft") {
                var y = true, w = false, I = void 0;
                try {
                  for (var P = s.nodeIndexes[Symbol.iterator](), S; !(y = (S = P.next()).done); y = true) {
            ...
            for (var c = Number.MAX_SAFE_INTEGER, N = Number.MIN_SAFE_INTEGER, d = Number.MAX_SAFE_INTEGER, y = Number.MIN_SAFE_INTEGER, w = void 0, I = void 0, P = void 0, S = void 0, Y = e.descendants().not(":parent"), W = Y.length, B = 0; B < W; B++) {
              var x = Y[B];
              w = s[g.get(x.id())] - x.width() / 2, I = s[g.get(x.id())] + x.width() / 2, P = a[g.get(x.id())] - x.height() / 2, S = a[g.get(x.id())] + x.height() / 2, c > w && (c = w), N < I && (N = I), d > P && (d = P), y < S && (y = S);
            }
            var nt = {};
          ...
          var h = t(548), r = t(140).CoSELayout, f = t(140).CoSENode, e = t(140).layoutBase.PointD, s = t(140).layoutBase.DimensionD, a = t(140).layoutBase.LayoutConstants, g = t(140).layoutBase.FDLayoutConstants, c = t(140).CoSEConstants, N = function(d, y) {
            var w = d.cy, I = d.eles, P = I.nodes(), S = I.edges(), Y = void 0, W = void 0, B = void 0, x = {};
            d.randomize && (Y = y.nodeIndexes, W = y.xCoords, B = y.yCoords);
            var nt = function(C) {
              return typeof C == "function";
            }, n = function(C, F) {
              return nt(C) ? C(F) : C;
            }, E = h.calcParentsWithoutChildren(w, I), p = function C(F, k, V, z) {
              for (var H = k.length, Z = 0; Z < H; Z++) {
                var G = k[Z], D = null;
                G.intersection(E).length == 0 && (D = G.children());
                var b = void 0, q = G.layoutDimensions({ nodeDimensionsIncludeLabels: z.nodeDimensionsIncludeLabels });
          ...
          var h = function() {
            function y(w, I) {
              for (var P = 0; P < I.length; P++) {
                var S = I[P];
                S.enumerable = S.enumerable || false, S.configurable = true, "value" in S && (S.writable = true), Object.defineProperty(w, S.key, S);
              }
            }
            return function(w, I, P) {
              return I && y(w.prototype, I), P && y(w, P), w;
            };
          }();
          function r(y, w) {
            if (!(y instanceof w))
          ...
          var f = t(658), e = t(548), s = t(657), a = s.spectralLayout, g = t(816), c = g.coseLayout, N = Object.freeze({ quality: "default", randomize: true, animate: true, animationDuration: 1e3, animationEasing: void 0, fit: true, padding: 30, nodeDimensionsIncludeLabels: false, uniformNodeDimensions: false, packComponents: true, step: "all", samplingType: true, sampleSize: 25, nodeSeparation: 75, piTol: 1e-7, nodeRepulsion: function(y) {
            ...
            return h(y, [{ key: "run", value: function() {
              var w = this, I = this.options, P = I.cy, S = I.eles, Y = [], W = [], B = void 0, x = [];
              ...
              var nt = I.fixedNodeConstraint || I.alignmentConstraint || I.relativePlacementConstraint;
              nt && (I.tile = false, I.packComponents = false);
              var n = void 0, E = false;
              if (P.layoutUtilities && I.packComponents && (n = P.layoutUtilities("get"), n || (n = P.layoutUtilities()), E = true), S.nodes().length > 0)
                if (E) {
                  var p = e.getTopMostNodes(I.eles.nodes());
                  if (B = e.connectComponents(P, I.eles, p), B.forEach(function(J) {
                    var ot = J.boundingBox();
                    x.push({ x: ot.x1 + ot.w / 2, y: ot.y1 + ot.h / 2 });
                  }), I.randomize && B.forEach(function(J) {
                    I.eles = J, Y.push(a(I));
                    ...
                    B.forEach(function(J, ot) {
                      I.eles = J, W.push(c(I, Y[ot])), e.relocateComponent(x[ot], W[ot], I);
                    });
                  } else
                    B.forEach(function(J, ot) {
                      e.relocateComponent(x[ot], Y[ot], I);
                    });
                  ...
                  if (B.length > 1) {
                    ...
                    B.forEach(function(J, ot) {
                      var mt = void 0;
                      if (I.quality == "draft" && (mt = Y[ot].nodeIndexes), J.nodes().not(G).length > 0) {
                        var ht = {};
                        ht.edges = [], ht.nodes = [];
                        var Lt = void 0;
                    ...
                    var D = n.packComponents(Z, I.randomize).shifts;
                    if (I.quality == "draft")
                  ...
                  I.quality == "default" || I.quality == "proof" ? (W.push(c(I, Y[0])), e.relocateComponent(x[0], W[0], I)) : e.relocateComponent(x[0], Y[0], I);
                }
              var vt = function(J, ot) {
                if (I.quality == "default" || I.quality == "proof") {
                  ...
                  }), I.nodeDimensionsIncludeLabels && (ht.labelWidth && (ht.labelPosHorizontal == "left" ? mt.x += ht.labelWidth / 2 : ht.labelPosHorizontal == "right" && (mt.x -= ht.labelWidth / 2)), ht.labelHeight && (ht.labelPosVertical == "top" ? mt.y += ht.labelHeight / 2 : ht.labelPosVertical == "bottom" && (mt.y -= ht.labelHeight / 2))), mt == null && (mt = { x: J.position("x"), y: J.position("y") }), { x: mt.x, y: mt.y };
                } else {
                  var _t = void 0;
                  return Y.forEach(function(Tt) {
                    var wt = Tt.nodeIndexes.get(J.id());
                    wt != null && (_t = { x: Tt.xCoords[wt], y: Tt.yCoords[wt] });
                  }), _t == null && (_t = { x: J.position("x"), y: J.position("y") }), { x: _t.x, y: _t.y };
                }
              };
              if (I.quality == "default" || I.quality == "proof" || I.randomize) {
                ...
                I.eles = S.not(Dt), S.nodes().not(":parent").not(Dt).layoutPositions(w, I, vt), j.length > 0 && j.forEach(function(J) {
                  J.position(vt(J));
                });
              } else
          ...
          var h = t(548), r = t(140).layoutBase.Matrix, f = t(140).layoutBase.SVD, e = function(s) {
            var a = s.cy, g = s.eles, c = g.nodes(), N = g.nodes(":parent"), d = /* @__PURE__ */ new Map(), y = /* @__PURE__ */ new Map(), w = /* @__PURE__ */ new Map(), I = [], P = [], S = [], Y = [], W = [], B = [], x = [], nt = [], n = void 0, E = 1e8, p = 1e-9, v = s.piTol, m = s.samplingType, O = s.nodeSeparation, _ = void 0, C = function() {
              for (var dt = 0, M = 0, R = false; M < _; ) {
                dt = Math.floor(Math.random() * n), R = false;
                for (var $ = 0; $ < M; $++)
                  if (Y[$] == dt) {
                    R = true;
                    break;
              ...
              for (var dt = f.svd(x), M = dt.S, R = dt.U, $ = dt.V, Q = M[0] * M[0] * M[0], K = [], pt = 0; pt < _; pt++) {
                K[pt] = [];
                for (var lt = 0; lt < _; lt++)
                  K[pt][lt] = 0, pt == lt && (K[pt][lt] = M[pt] / (M[pt] * M[pt] + Q / (M[pt] * M[pt])));
              }
              nt = r.multMat(r.multMat($, K), r.transpose(R));
            }, z = function() {
              for (var dt = void 0, M = void 0, R = [], $ = [], Q = [], K = [], pt = 0; pt < n; pt++)
              ...
              for (tt = p; ; ) {
                for (var yt = 0; yt < n; yt++)
                  K[yt] = $[yt];
                if (K = r.minusOp(K, r.multCons(Q, r.dotProduct(Q, K))), $ = r.multGamma(r.multL(r.multGamma(K), B, nt)), M = r.dotProduct(K, $), $ = r.normalize($), lt = r.dotProduct(K, $), gt = Math.abs(lt / tt), gt <= 1 + v && gt >= 1)
                  break;
                tt = lt;
              }
              for (var Ct = 0; Ct < n; Ct++)
                K[Ct] = $[Ct];
              P = r.multCons(Q, Math.sqrt(Math.abs(dt))), S = r.multCons(K, Math.sqrt(Math.abs(M)));
            };
            ...
            try {
              for (var q = d.keys()[Symbol.iterator](), et; !(G = (et = q.next()).done); G = true) {
                var vt = et.value;
                y.set(vt, H++);
              }
            } catch (dt) {
            ...
            N.forEach(function(dt) {
              for (var M = dt.children().intersection(g); M.nodes(":childless").length == 0; )
                M = M.nodes()[0].children().intersection(g);
              var R = 0, $ = M.nodes(":childless")[0].connectedEdges().length;
              M.nodes(":childless").forEach(function(Q, K) {
                Q.connectedEdges().length < $ && ($ = Q.connectedEdges().length, R = K);
              }), w.set(dt.id(), M.nodes(":childless")[R].id());
            }), c.forEach(function(dt) {
              var M = void 0;
              dt.isParent() ? M = y.get(w.get(dt.id())) : M = y.get(dt.id()), dt.neighborhood().nodes().forEach(function(R) {
                g.intersection(dt.edgesWith(R)).length > 0 && (R.isParent() ? I[M].push(w.get(R.id())) : I[M].push(R.id()));
              });
            });
            var Dt = function(dt) {
              var M = y.get(dt), R = void 0;
              d.get(dt).forEach(function($) {
                a.getElementById($).isParent() ? R = w.get($) : R = $, I[M].push(R), I[y.get(R)].push(dt);
              });
            }, J = true, ot = false, mt = void 0;
            try {
              for (var ht = d.keys()[Symbol.iterator](), Lt; !(J = (Lt = ht.next()).done); J = true) {
                var _t = Lt.value;
                Dt(_t);
              }
            } catch (dt) {
            ...
            if (n > 2) {
              ...
              for (var zt = 0; zt < _; zt++)
                nt[zt] = [];
              return s.quality == "draft" || s.step == "all" ? (k(m), V(), z(), Tt = { nodeIndexes: y, xCoords: P, yCoords: S }) : (y.forEach(function(dt, M) {
                P.push(a.getElementById(M).position("x")), S.push(a.getElementById(M).position("y"));
...
var vi = pi();
const mi = hi(vi);
var Oe = { L: "left", R: "right", T: "top", B: "bottom" }, Re = { L: rt((A) => `${A},${A / 2} 0,${A} 0,0`, "L"), R: rt((A) => `0,${A / 2} ${A},0 ${A},${A}`, "R"), T: rt((A) => `0,0 ${A},0 ${A / 2},${A}`, "T"), B: rt((A) => `${A / 2},0 ${A},${A} 0,${A}`, "B") }, ae = { L: rt((A, X) => A - X + 2, "L"), R: rt((A, X) => A - 2, "R"), T: rt((A, X) => A - X + 2, "T"), B: rt((A, X) => A - 2, "B") }, yi = rt(function(A) {
  return Xt(A) ? A === "L" ? "R" : "L" : A === "T" ? "B" : "T";
}, "getOppositeArchitectureDirection"), be = rt(function(A) {
  const X = A;
  return X === "L" || X === "R" || X === "T" || X === "B";
}, "isArchitectureDirection"), Xt = rt(function(A) {
  const X = A;
  return X === "L" || X === "R";
}, "isArchitectureDirectionX"), jt = rt(function(A) {
  const X = A;
  return X === "T" || X === "B";
}, "isArchitectureDirectionY"), Te = rt(function(A, X) {
  const L = Xt(A) && jt(X), U = jt(A) && Xt(X);
  return L || U;
}, "isArchitectureDirectionXY"), Ei = rt(function(A) {
  const X = A[0], L = A[1], U = Xt(X) && jt(L), T = jt(X) && Xt(L);
  return U || T;
}, "isArchitecturePairXY"), Ni = rt(function(A) {
  return A !== "LL" && A !== "RR" && A !== "TT" && A !== "BB";
}, "isValidArchitectureDirectionPair"), ye = rt(function(A, X) {
  const L = `${A}${X}`;
  return Ni(L) ? L : void 0;
}, "getArchitectureDirectionPair"), Ti = rt(function([A, X], L) {
  const U = L[0], T = L[1];
  return Xt(U) ? jt(T) ? [A + (U === "L" ? -1 : 1), X + (T === "T" ? 1 : -1)] : [A + (U === "L" ? -1 : 1), X] : Xt(T) ? [A + (T === "L" ? 1 : -1), X + (U === "T" ? 1 : -1)] : [A, X + (U === "T" ? 1 : -1)];
}, "shiftPositionByArchitectureDirectionPair"), Ai = rt(function(A) {
  return A === "LT" || A === "TL" ? [1, 1] : A === "BL" || A === "LB" ? [1, -1] : A === "BR" || A === "RB" ? [-1, -1] : [-1, 1];
}, "getArchitectureDirectionXYFactors"), wi = rt(function(A, X) {
  return Te(A, X) ? "bend" : Xt(A) ? "horizontal" : "vertical";
}, "getArchitectureDirectionAlignment"), Ii = rt(function(A) {
  return A.type === "service";
}, "isArchitectureService"), Mi = rt(function(A) {
  return A.type === "junction";
}, "isArchitectureJunction"), Se = rt((A) => A.data(), "edgeData"), ie = rt((A) => A.data(), "nodeData"), Fe = $e.architecture, Et = new ai(() => ({ nodes: {}, groups: {}, edges: [], registeredIds: {}, config: Fe, dataStructures: void 0, elements: {} })), Li = rt(() => {
  Et.reset(), ii();
}, "clear"), _i = rt(function({ id: A, icon: X, in: L, title: U, iconText: T }) {
  if (Et.records.registeredIds[A] !== void 0)
    throw new Error(`The service id [${A}] is already in use by another ${Et.records.registeredIds[A]}`);
  if (L !== void 0) {
    if (A === L)
      throw new Error(`The service [${A}] cannot be placed within itself`);
    if (Et.records.registeredIds[L] === void 0)
      throw new Error(`The service [${A}]'s parent does not exist. Please make sure the parent is created before this service`);
    if (Et.records.registeredIds[L] === "node")
      throw new Error(`The service [${A}]'s parent is not a group`);
  }
  Et.records.registeredIds[A] = "node", Et.records.nodes[A] = { id: A, type: "service", icon: X, iconText: T, title: U, edges: [], in: L };
}, "addService"), xi = rt(() => Object.values(Et.records.nodes).filter(Ii), "getServices"), Ci = rt(function({ id: A, in: X }) {
  Et.records.registeredIds[A] = "node", Et.records.nodes[A] = { id: A, type: "junction", edges: [], in: X };
}, "addJunction"), Di = rt(() => Object.values(Et.records.nodes).filter(Mi), "getJunctions"), Oi = rt(() => Object.values(Et.records.nodes), "getNodes"), Ee = rt((A) => Et.records.nodes[A], "getNode"), Ri = rt(function({ id: A, icon: X, in: L, title: U }) {
  if (Et.records.registeredIds[A] !== void 0)
    throw new Error(`The group id [${A}] is already in use by another ${Et.records.registeredIds[A]}`);
  if (L !== void 0) {
    if (A === L)
      throw new Error(`The group [${A}] cannot be placed within itself`);
    if (Et.records.registeredIds[L] === void 0)
      throw new Error(`The group [${A}]'s parent does not exist. Please make sure the parent is created before this group`);
    if (Et.records.registeredIds[L] === "node")
      throw new Error(`The group [${A}]'s parent is not a group`);
  }
  Et.records.registeredIds[A] = "group", Et.records.groups[A] = { id: A, icon: X, title: U, in: L };
}, "addGroup"), bi = rt(() => Object.values(Et.records.groups), "getGroups"), Gi = rt(function({ lhsId: A, rhsId: X, lhsDir: L, rhsDir: U, lhsInto: T, rhsInto: u, lhsGroup: l, rhsGroup: o, title: i }) {
  if (!be(L))
    throw new Error(`Invalid direction given for left hand side of edge ${A}--${X}. Expected (L,R,T,B) got ${L}`);
  if (!be(U))
    throw new Error(`Invalid direction given for right hand side of edge ${A}--${X}. Expected (L,R,T,B) got ${U}`);
  if (Et.records.nodes[A] === void 0 && Et.records.groups[A] === void 0)
    throw new Error(`The left-hand id [${A}] does not yet exist. Please create the service/group before declaring an edge to it.`);
  if (Et.records.nodes[X] === void 0 && Et.records.groups[A] === void 0)
    throw new Error(`The right-hand id [${X}] does not yet exist. Please create the service/group before declaring an edge to it.`);
  const t = Et.records.nodes[A].in, h = Et.records.nodes[X].in;
  if (l && t && h && t == h)
    throw new Error(`The left-hand id [${A}] is modified to traverse the group boundary, but the edge does not pass through two groups.`);
  if (o && t && h && t == h)
    throw new Error(`The right-hand id [${X}] is modified to traverse the group boundary, but the edge does not pass through two groups.`);
  const r = { lhsId: A, lhsDir: L, lhsInto: T, lhsGroup: l, rhsId: X, rhsDir: U, rhsInto: u, rhsGroup: o, title: i };
...
}, "addEdge"), Pi = rt(() => Et.records.edges, "getEdges"), Si = rt(() => {
  if (Et.records.dataStructures === void 0) {
    const A = {}, X = Object.entries(Et.records.nodes).reduce((o, [i, t]) => (o[i] = t.edges.reduce((h, r) => {
      ...
      return h;
    }, {}), o), {}), L = Object.keys(X)[0], U = { [L]: 1 }, T = Object.keys(X).reduce((o, i) => i === L ? o : { ...o, [i]: 1 }, {}), u = rt((o) => {
      const i = { [o]: [0, 0] }, t = [o];
      for (; t.length > 0; ) {
        const h = t.shift();
        if (h) {
    ...
    Et.records.dataStructures = { adjList: X, spatialMaps: l, groupAlignments: A };
  }
  return Et.records.dataStructures;
}, "getDataStructures"), Fi = rt((A, X) => {
  Et.records.elements[A] = X;
}, "setElementForId"), ki = rt((A) => Et.records.elements[A], "getElementById"), se = { clear: Li, setDiagramTitle: Ze, getDiagramTitle: Ke, setAccTitle: Qe, getAccTitle: Je, setAccDescription: ti, getAccDescription: ei, addService: _i, getServices: xi, addJunction: Ci, getJunctions: Di, getNodes: Oi, getNode: Ee, addGroup: Ri, getGroups: bi, addEdge: Gi, getEdges: Pi, setElementForId: Fi, getElementById: ki, getDataStructures: Si };
function St(A) {
...
var Ui = rt((A, X) => {
  oi(A, X), A.groups.map(X.addGroup), A.services.map((L) => X.addService({ ...L, type: "service" })), A.junctions.map((L) => X.addJunction({ ...L, type: "junction" })), A.edges.map(X.addEdge);
}, "populateDb"), Yi = { parse: rt(async (A) => {
  const X = await si("architecture", A);
  Ge.debug(X), Ui(X, se);
}, "parse") }, Xi = rt((A) => `
  .edge {
...
`, "getStyles"), Hi = Xi, ee = rt((A) => `<g><rect width="80" height="80" style="fill: #087ebf; stroke-width: 0px;"/>${A}</g>`, "wrapIcon"), ne = { prefix: "mermaid-architecture", height: 80, width: 80, icons: { database: { body: ee('<path id="b" data-name="4" d="m20,57.86c0,3.94,8.95,7.14,20,7.14s20-3.2,20-7.14" style="fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;"/><path id="c" data-name="3" d="m20,45.95c0,3.94,8.95,7.14,20,7.14s20-3.2,20-7.14" style="fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;"/><path id="d" data-name="2" d="m20,34.05c0,3.94,8.95,7.14,20,7.14s20-3.2,20-7.14" style="fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;"/><ellipse id="e" data-name="1" cx="40" cy="22.14" rx="20" ry="7.14" style="fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;"/><line x1="20" y1="57.86" x2="20" y2="22.14" style="fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;"/><line x1="60" y1="57.86" x2="60" y2="22.14" style="fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;"/>') }, server: { body: ee('<rect x="17.5" y="17.5" width="45" height="45" rx="2" ry="2" style="fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;"/><line x1="17.5" y1="32.5" x2="62.5" y2="32.5" style="fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;"/><line x1="17.5" y1="47.5" x2="62.5" y2="47.5" style="fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;"/><g><path d="m56.25,25c0,.27-.45.5-1,.5h-10.5c-.55,0-1-.23-1-.5s.45-.5,1-.5h10.5c.55,0,1,.23,1,.5Z" style="fill: #fff; stroke-width: 0px;"/><path d="m56.25,25c0,.27-.45.5-1,.5h-10.5c-.55,0-1-.23-1-.5s.45-.5,1-.5h10.5c.55,0,1,.23,1,.5Z" style="fill: none; stroke: #fff; stroke-miterlimit: 10;"/></g><g><path d="m56.25,40c0,.27-.45.5-1,.5h-10.5c-.55,0-1-.23-1-.5s.45-.5,1-.5h10.5c.55,0,1,.23,1,.5Z" style="fill: #fff; stroke-width: 0px;"/><path d="m56.25,40c0,.27-.45.5-1,.5h-10.5c-.55,0-1-.23-1-.5s.45-.5,1-.5h10.5c.55,0,1,.23,1,.5Z" style="fill: none; stroke: #fff; stroke-miterlimit: 10;"/></g><g><path d="m56.25,55c0,.27-.45.5-1,.5h-10.5c-.55,0-1-.23-1-.5s.45-.5,1-.5h10.5c.55,0,1,.23,1,.5Z" style="fill: #fff; stroke-width: 0px;"/><path d="m56.25,55c0,.27-.45.5-1,.5h-10.5c-.55,0-1-.23-1-.5s.45-.5,1-.5h10.5c.55,0,1,.23,1,.5Z" style="fill: none; stroke: #fff; stroke-miterlimit: 10;"/></g><g><circle cx="32.5" cy="25" r=".75" style="fill: #fff; stroke: #fff; stroke-miterlimit: 10;"/><circle cx="27.5" cy="25" r=".75" style="fill: #fff; stroke: #fff; stroke-miterlimit: 10;"/><circle cx="22.5" cy="25" r=".75" style="fill: #fff; stroke: #fff; stroke-miterlimit: 10;"/></g><g><circle cx="32.5" cy="40" r=".75" style="fill: #fff; stroke: #fff; stroke-miterlimit: 10;"/><circle cx="27.5" cy="40" r=".75" style="fill: #fff; stroke: #fff; stroke-miterlimit: 10;"/><circle cx="22.5" cy="40" r=".75" style="fill: #fff; stroke: #fff; stroke-miterlimit: 10;"/></g><g><circle cx="32.5" cy="55" r=".75" style="fill: #fff; stroke: #fff; stroke-miterlimit: 10;"/><circle cx="27.5" cy="55" r=".75" style="fill: #fff; stroke: #fff; stroke-miterlimit: 10;"/><circle cx="22.5" cy="55" r=".75" style="fill: #fff; stroke: #fff; stroke-miterlimit: 10;"/></g>') }, disk: { body: ee('<rect x="20" y="15" width="40" height="50" rx="1" ry="1" style="fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;"/><ellipse cx="24" cy="19.17" rx=".8" ry=".83" style="fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;"/><ellipse cx="56" cy="19.17" rx=".8" ry=".83" style="fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;"/><ellipse cx="24" cy="60.83" rx=".8" ry=".83" style="fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;"/><ellipse cx="56" cy="60.83" rx=".8" ry=".83" style="fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;"/><ellipse cx="40" cy="33.75" rx="14" ry="14.58" style="fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;"/><ellipse cx="40" cy="33.75" rx="4" ry="4.17" style="fill: #fff; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;"/><path d="m37.51,42.52l-4.83,13.22c-.26.71-1.1,1.02-1.76.64l-4.18-2.42c-.66-.38-.81-1.26-.33-1.84l9.01-10.8c.88-1.05,2.56-.08,2.09,1.2Z" style="fill: #fff; stroke-width: 0px;"/>') }, internet: { body: ee('<circle cx="40" cy="40" r="22.5" style="fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;"/><line x1="40" y1="17.5" x2="40" y2="62.5" style="fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;"/><line x1="17.5" y1="40" x2="62.5" y2="40" style="fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;"/><path d="m39.99,17.51c-15.28,11.1-15.28,33.88,0,44.98" style="fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;"/><path d="m40.01,17.51c15.28,11.1,15.28,33.88,0,44.98" style="fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;"/><line x1="19.75" y1="30.1" x2="60.25" y2="30.1" style="fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;"/><line x1="19.75" y1="49.9" x2="60.25" y2="49.9" style="fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;"/>') }, cloud: { body: ee('<path d="m65,47.5c0,2.76-2.24,5-5,5H20c-2.76,0-5-2.24-5-5,0-1.87,1.03-3.51,2.56-4.36-.04-.21-.06-.42-.06-.64,0-2.6,2.48-4.74,5.65-4.97,1.65-4.51,6.34-7.76,11.85-7.76.86,0,1.69.08,2.5.23,2.09-1.57,4.69-2.5,7.5-2.5,6.1,0,11.19,4.38,12.28,10.17,2.14.56,3.72,2.51,3.72,4.83,0,.03,0,.07-.01.1,2.29.46,4.01,2.48,4.01,4.9Z" style="fill: none; stroke: #fff; stroke-miterlimit: 10; stroke-width: 2px;"/>') }, unknown: je, blank: { body: ee("") } } }, Wi = rt(async function(A, X) {
  ...
  await Promise.all(X.edges().map(async (o) => {
    ...
    if (e && (Xt(r) ? d += r === "L" ? -Y : Y : y += r === "T" ? -Y : Y + 18), c && (Xt(a) ? P += a === "L" ? -Y : Y : S += a === "T" ? -Y : Y + 18), !e && ((i = se.getNode(h)) == null ? void 0 : i.type) === "junction" && (Xt(r) ? d += r === "L" ? T : -T : y += r === "T" ? T : -T), !c && ((t = se.getNode(s)) == null ? void 0 : t.type) === "junction" && (Xt(a) ? P += a === "L" ? T : -T : S += a === "T" ? T : -T), o[0]._private.rscratch) {
      const W = A.insert("g");
      if (W.insert("path").attr("d", `M ${d},${y} L ${w},${I} L${P},${S} `).attr("class", "edge"), f) {
      ...
      if (N) {
        ...
        const nt = W.append("g");
        if (await Ne(nt, N, { useHtmlLabels: false, width: x, classes: "architecture-service-label" }, he()), nt.attr("dy", "1em").attr("alignment-baseline", "middle").attr("dominant-baseline", "middle").attr("text-anchor", "middle"), B === "X")
          nt.attr("transform", "translate(" + w + ", " + I + ")");
        else if (B === "Y")
          nt.attr("transform", "translate(" + w + ", " + I + ") rotate(-90)");
        else if (B === "XY") {
          const n = ye(r, a);
          if (n && Ei(n)) {
...
}, "drawEdges"), zi = rt(async function(A, X) {
  const L = St("padding") * 0.75, U = St("fontSize"), T = St("iconSize") / 2;
  await Promise.all(X.nodes().map(async (u) => {
    const l = ie(u);
    if (l.type === "group") {
      ...
      if (l.icon) {
        const s = r.append("g");
        s.html(`<g>${await fe(l.icon, { height: L, width: L, fallbackPrefix: ne.prefix })}</g>`), s.attr("transform", "translate(" + (f + T + 1) + ", " + (e + T + 1) + ")"), f += L, e += U / 2 - 1 - 2;
      }
      if (l.label) {
        const s = r.append("g");
        await Ne(s, l.label, { useHtmlLabels: false, width: i, classes: "architecture-service-label" }, he()), s.attr("dy", "1em").attr("alignment-baseline", "middle").attr("dominant-baseline", "start").attr("text-anchor", "start"), s.attr("transform", "translate(" + (f + T + 4) + ", " + (e + T + 2) + ")");
      }
    }
  }));
}, "drawGroups"), Vi = rt(async function(A, X, L) {
  for (const U of L) {
    const T = X.append("g"), u = St("iconSize");
    if (U.title) {
      const t = T.append("g");
      await Ne(t, U.title, { useHtmlLabels: false, width: u * 1.5, classes: "architecture-service-label" }, he()), t.attr("dy", "1em").attr("alignment-baseline", "middle").attr("dominant-baseline", "middle").attr("text-anchor", "middle"), t.attr("transform", "translate(" + u / 2 + ", " + u + ")");
    }
    const l = T.append("g");
    if (U.icon)
      l.html(`<g>${await fe(U.icon, { height: u, width: u, fallbackPrefix: ne.prefix })}</g>`);
    else if (U.iconText) {
      l.html(`<g>${await fe("blank", { height: u, width: u, fallbackPrefix: ne.prefix })}</g>`);
      const t = l.append("g").append("foreignObject").attr("width", u).attr("height", u).append("div").attr("class", "node-icon-text").attr("style", `height: ${u}px;`).append("div").html(U.iconText), h = parseInt(window.getComputedStyle(t.node(), null).getPropertyValue("font-size").replace(/\D/g, "")) ?? 16;
      t.attr("style", `-webkit-line-clamp: ${Math.floor((u - 2) / h)};`);
    } else
      l.append("path").attr("class", "node-bkg").attr("id", "node-" + U.id).attr("d", `M0 ${u} v${-u} q0,-5 5,-5 h${u} q5,0 5,5 v${u} H0 Z`);
  ...
  return 0;
}, "drawServices"), Bi = rt(function(A, X, L) {
  L.forEach((U) => {
    const T = X.append("g"), u = St("iconSize");
...
qe([{ name: ne.prefix, icons: ne }]);
Pe.use(mi);
function ke(A, X) {
  A.forEach((L) => {
    X.add({ group: "nodes", data: { type: "service", id: L.id, icon: L.icon, label: L.title, parent: L.in, width: St("iconSize"), height: St("iconSize") }, classes: "node-service" });
  });
}
rt(ke, "addServices");
function Ue(A, X) {
  A.forEach((L) => {
    X.add({ group: "nodes", data: { type: "junction", id: L.id, parent: L.in, width: St("iconSize"), height: St("iconSize") }, classes: "node-junction" });
  });
}
rt(Ue, "addJunctions");
function Ye(A, X) {
...
function Xe(A, X) {
  A.forEach((L) => {
    X.add({ group: "nodes", data: { type: "group", id: L.id, icon: L.icon, label: L.title, parent: L.in }, classes: "node-group" });
  });
}
rt(Xe, "addGroups");
function He(A, X) {
  A.forEach((L) => {
    const { lhsId: U, rhsId: T, lhsInto: u, lhsGroup: l, rhsInto: o, lhsDir: i, rhsDir: t, rhsGroup: h, title: r } = L, f = Te(L.lhsDir, L.rhsDir) ? "segments" : "straight", e = { id: `${U}-${T}`, label: r, source: U, sourceDir: i, sourceArrow: u, sourceGroup: l, sourceEndpoint: i === "L" ? "0 50%" : i === "R" ? "100% 50%" : i === "T" ? "50% 0" : "50% 100%", target: T, targetDir: t, targetArrow: o, targetGroup: h, targetEndpoint: t === "L" ? "0 50%" : t === "R" ? "100% 50%" : t === "T" ? "50% 0" : "50% 100%" };
    X.add({ group: "edges", data: e, classes: f });
  });
}
rt(He, "addEdges");
function We(A, X, L) {
  const U = rt((o, i) => Object.entries(o).reduce((t, [h, r]) => {
    var f;
    let e = 0;
    ...
    }), { horiz: Object.values(U(i, "horizontal")).filter((h) => h.length > 1), vert: Object.values(U(t, "vertical")).filter((h) => h.length > 1) };
  }), [u, l] = T.reduce(([o, i], { horiz: t, vert: h }) => [[...o, ...t], [...i, ...h]], [[], []]);
  return { horizontal: u, vertical: l };
}
rt(We, "getAlignments");
function ze(A) {
  const X = [], L = rt((T) => `${T[0]},${T[1]}`, "posToStr"), U = rt((T) => T.split(",").map((u) => parseInt(u)), "strToPos");
  return A.forEach((T) => {
    const u = Object.fromEntries(Object.entries(T).map(([t, h]) => [L(h), t])), l = [L([0, 0])], o = {}, i = { L: [-1, 0], R: [1, 0], T: [0, 1], B: [0, -1] };
    for (; l.length > 0; ) {
      const t = l.shift();
      if (t) {
        o[t] = 1;
        ...
        if (h) {
          ...
          Object.entries(i).forEach(([f, e]) => {
            ...
            a && !o[s] && (l.push(s), X.push({ [Oe[f]]: a, [Oe[yi(f)]]: h, gap: 1.5 * St("iconSize") }));
          });
        }
      }
    }
...
function Ve(A, X, L, U, T, { spatialMaps: u, groupAlignments: l }) {
  return new Promise((o) => {
    const i = li("body").append("div").attr("id", "cy").attr("style", "display:none"), t = Pe({ container: document.getElementById("cy"), style: [{ selector: "edge", style: { "curve-style": "straight", label: "data(label)", "source-endpoint": "data(sourceEndpoint)", "target-endpoint": "data(targetEndpoint)" } }, { selector: "edge.segments", style: { "curve-style": "segments", "segment-weights": "0", "segment-distances": [0.5], "edge-distances": "endpoints", "source-endpoint": "data(sourceEndpoint)", "target-endpoint": "data(targetEndpoint)" } }, { selector: "node", style: { "compound-sizing-wrt-labels": "include" } }, { selector: "node[label]", style: { "text-valign": "bottom", "text-halign": "center", "font-size": `${St("fontSize")}px` } }, { selector: ".node-service", style: { label: "data(label)", width: "data(width)", height: "data(height)" } }, { selector: ".node-junction", style: { width: "data(width)", height: "data(height)" } }, { selector: ".node-group", style: { padding: `${St("padding")}px` } }] });
    i.remove(), Xe(L, t), ke(A, t), Ue(X, t), He(U, t);
    const h = We(T, u, l), r = ze(u), f = t.layout({ name: "fcose", quality: "proof", styleEnabled: false, animate: false, nodeDimensionsIncludeLabels: false, idealEdgeLength(e) {
      const [s, a] = e.connectedNodes(), { parent: g } = ie(s), { parent: c } = ie(a);
      return g === c ? 1.5 * St("iconSize") : 0.5 * St("iconSize");
    }, edgeElasticity(e) {
      const [s, a] = e.connectedNodes(), { parent: g } = ie(s), { parent: c } = ie(a);
      return g === c ? 0.45 : 1e-3;
    }, alignmentConstraint: h, relativePlacementConstraint: r });
    f.one("layoutstop", () => {
      var e;
      function s(a, g, c, N) {
        let d, y;
        const { x: w, y: I } = a, { x: P, y: S } = g;
        y = (N - I + (w - c) * (I - S) / (w - P)) / Math.sqrt(1 + Math.pow((I - S) / (w - P), 2)), d = Math.sqrt(Math.pow(N - I, 2) + Math.pow(c - w, 2) - Math.pow(y, 2));
        const Y = Math.sqrt(Math.pow(P - w, 2) + Math.pow(S - I, 2));
        d = d / Y;
        let W = (P - w) * (N - I) - (S - I) * (c - w);
        switch (true) {
          case W >= 0:
            W = 1;
            break;
        ...
        return y = Math.abs(y) * W, d = d * B, { distances: y, weights: d };
      }
      ...
      for (const a of Object.values(t.edges()))
        if ((e = a.data) != null && e.call(a)) {
          ...
          if (g !== N && c !== d) {
            const y = a.sourceEndpoint(), w = a.targetEndpoint(), { sourceDir: I } = Se(a), [P, S] = jt(I) ? [y.x, w.y] : [w.x, y.y], { weights: Y, distances: W } = s(y, w, P, S);
...
var $i = rt(async (A, X, L, U) => {
  const T = U.db, u = T.getServices(), l = T.getJunctions(), o = T.getGroups(), i = T.getEdges(), t = T.getDataStructures(), h = ri(X), r = h.append("g");
  ...
  await Wi(r, s), await zi(e, s), Ye(T, s), ni(void 0, h, St("padding"), St("useMaxWidth"));
}, "draw"), ji = { draw: $i }, ar = { parser: Yi, db: se, renderer: ji, styles: Hi };
export {
  ar as diagram
};
