import { _ as a, l as tt, c as H, G as pt, ab as yt, ac as ft, ad as mt, T as bt, E as V, h as j, q as _t, J as Et, U as St, V as at, W as lt } from "./mermaid-CI9Xz-tl-06ae91ae.js";
...
var Q = function() {
  var i = a(function(k, t, n, r) {
    for (n = n || {}, r = k.length; r--; n[k[r]] = t)
      ;
    return n;
  }, "o"), u = [1, 4], d = [1, 13], s = [1, 12], g = [1, 15], D = [1, 16], S = [1, 20], h = [1, 19], O = [6, 7, 8], b = [1, 26], _ = [1, 24], C = [1, 25], o = [6, 7, 11], M = [1, 31], w = [6, 7, 11, 24], $ = [1, 6, 13, 16, 17, 20, 23], T = [1, 35], G = [1, 36], I = [1, 6, 7, 11, 13, 16, 17, 20, 23], U = [1, 38], y = { trace: a(function() {
  ...
  }, "anonymous"), table: [{ 3: 1, 4: 2, 5: 3, 6: [1, 5], 8: u }, { 1: [3] }, { 1: [2, 1] }, { 4: 6, 6: [1, 7], 7: [1, 8], 8: u }, { 6: d, 7: [1, 10], 9: 9, 12: 11, 13: s, 14: 14, 16: g, 17: D, 18: 17, 19: 18, 20: S, 23: h }, i(O, [2, 3]), { 1: [2, 2] }, i(O, [2, 4]), i(O, [2, 5]), { 1: [2, 6], 6: d, 12: 21, 13: s, 14: 14, 16: g, 17: D, 18: 17, 19: 18, 20: S, 23: h }, { 6: d, 9: 22, 12: 11, 13: s, 14: 14, 16: g, 17: D, 18: 17, 19: 18, 20: S, 23: h }, { 6: b, 7: _, 10: 23, 11: C }, i(o, [2, 24], { 18: 17, 19: 18, 14: 27, 16: [1, 28], 17: [1, 29], 20: S, 23: h }), i(o, [2, 19]), i(o, [2, 21], { 15: 30, 24: M }), i(o, [2, 22]), i(o, [2, 23]), i(w, [2, 25]), i(w, [2, 26]), i(w, [2, 28], { 20: [1, 32] }), { 21: [1, 33] }, { 6: b, 7: _, 10: 34, 11: C }, { 1: [2, 7], 6: d, 12: 21, 13: s, 14: 14, 16: g, 17: D, 18: 17, 19: 18, 20: S, 23: h }, i($, [2, 14], { 7: T, 11: G }), i(I, [2, 8]), i(I, [2, 9]), i(I, [2, 10]), i(o, [2, 16], { 15: 37, 24: M }), i(o, [2, 17]), i(o, [2, 18]), i(o, [2, 20], { 24: U }), i(w, [2, 31]), { 21: [1, 39] }, { 22: [1, 40] }, i($, [2, 13], { 7: T, 11: G }), i(I, [2, 11]), i(I, [2, 12]), i(o, [2, 15], { 24: U }), i(w, [2, 30]), { 22: [1, 41] }, i(w, [2, 27]), i(w, [2, 29])], defaultActions: { 2: [2, 1], 6: [2, 2] }, parseError: a(function(k, t) {
    if (t.recoverable)
      this.trace(k);
    else {
      var n = new Error(k);
    ...
    for (var E, B, x, K, F = {}, z, A, ot, q; ; ) {
      if (B = n[n.length - 1], this.defaultActions[B] ? x = this.defaultActions[B] : ((E === null || typeof E > "u") && (E = rt()), x = m[B] && m[B][E]), typeof x > "u" || !x.length || !x[0]) {
        ...
        q = [];
        for (z in m[B])
          this.terminals_[z] && z > ht && q.push("'" + this.terminals_[z] + "'");
        f.showPosition ? J = "Parse error on line " + (W + 1) + `:
` + f.showPosition() + `
Expecting ` + q.join(", ") + ", got '" + (this.terminals_[E] || E) + "'" : J = "Parse error on line " + (W + 1) + ": Unexpected " + (E == st ? "end of input" : "'" + (this.terminals_[E] || E) + "'"), this.parseError(J, { text: f.match, token: this.terminals_[E] || E, line: f.yylineno, loc: Y, expected: q });
      }
...
var kt = Q, L = [], et = [], Z = 0, it = {}, Nt = a(() => {
  ...
  for (const g of d) {
    ...
    for (const h of S) {
      const O = { id: h.id, parentId: g.id, label: j(h.label ?? "", s), isGroup: false, ticket: h == null ? void 0 : h.ticket, priority: h == null ? void 0 : h.priority, assigned: h == null ? void 0 : h.assigned, icon: h == null ? void 0 : h.icon, shape: "kanbanItem", level: h.level, rx: 5, ry: 5, cssStyles: ["text-align: left"] };
      u.push(O);
    }
  }
  ...
  const b = { id: j(u, h) || "kbn" + Z++, level: i, label: j(d, h), width: ((S = h.mindmap) == null ? void 0 : S.maxNodeWidth) ?? V.mindmap.maxNodeWidth, padding: O, isGroup: false };
  if (g !== void 0) {
    let C;
    g.includes(`
`) ? C = g + `
...
}, "addNode"), p = { DEFAULT: 0, NO_BORDER: 0, ROUNDED_RECT: 1, RECT: 2, CIRCLE: 3, CLOUD: 4, BANG: 5, HEXAGON: 6 }, Ot = a((i, u) => {
...
}, "type2Str"), It = a(() => tt, "getLogger"), At = a((i) => it[i], "getElementById"), $t = { clear: Nt, addNode: Lt, getSections: ct, getData: xt, nodeType: p, getType: Ot, setElementForId: vt, decorateNode: Ct, type2Str: wt, getLogger: It, getElementById: At }, Tt = $t, Rt = a(async (i, u, d, s) => {
  var g, D, S, h, O;
  tt.debug(`Rendering kanban diagram
` + i);
  const b = s.db.getData(), _ = H();
  _.htmlLabels = false;
  const C = pt(u), o = C.append("g");
  o.attr("class", "sections");
  const M = C.append("g");
  M.attr("class", "items");
  const w = b.nodes.filter((y) => y.isGroup);
  let $ = 0;
  const T = 10, G = [];
  let I = 25;
  for (const y of w) {
    ...
    const v = await yt(o, y);
    I = Math.max(I, (D = v == null ? void 0 : v.labelBBox) == null ? void 0 : D.height), G.push(v);
  }
  let U = 0;
  for (const y of w) {
    const R = G[U];
    U = U + 1;
    const v = ((S = _ == null ? void 0 : _.kanban) == null ? void 0 : S.sectionWidth) || 200, k = -v * 3 / 2 + I;
    let t = k;
    const n = b.nodes.filter((e) => e.parentId === y.id);
    for (const e of n) {
      if (e.isGroup)
        throw new Error("Groups within groups are not allowed in Kanban diagrams");
      e.x = y.x, e.width = v - 1.5 * T;
      const m = (await ft(M, e, { config: _ })).node().getBBox();
      e.y = t + m.height / 2, await mt(e), t = e.y + m.height / 2 + T / 2;
    }
    const r = R.cluster.select("rect"), c = Math.max(t - k + 3 * T, 50) + (I - 25);
    r.attr("height", c);
  }
  bt(void 0, C, ((h = _.mindmap) == null ? void 0 : h.padding) ?? V.kanban.padding, ((O = _.mindmap) == null ? void 0 : O.useMaxWidth) ?? V.kanban.useMaxWidth);
