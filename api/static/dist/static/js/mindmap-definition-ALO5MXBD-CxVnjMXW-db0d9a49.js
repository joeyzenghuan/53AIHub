import { _ as x, l as Q, ag as _t, M as Nt, c as st, G as At, T as Tt, E as J, h as tt, U as Lt, V as Ot, W as Dt } from "./mermaid-CI9Xz-tl-06ae91ae.js";
import { J as pt } from "./cytoscape.esm-Swd9B-1A-1060bb3e.js";
import { g as wt } from "./index-8579fe4a.js";
import { F as It } from "./viewer-DpLhQV_x-5cf483f8.js";
      ...
      return function(p) {
        ...
        t.calcSeparationAmount = function(e, r, a, h) {
          ...
          if (h === f) {
            ...
            var U = e.height / e.width, b = r.height / r.width, M = (o - s) / (f - h), G = void 0, F = void 0, Y = void 0, k = void 0, X = void 0, P = void 0;
            ...
            if (h > f ? s > o ? (G = this.getCardinalDirection(U, M, 4), F = this.getCardinalDirection(b, M, 2)) : (G = this.getCardinalDirection(-U, M, 3), F = this.getCardinalDirection(-b, M, 1)) : s > o ? (G = this.getCardinalDirection(-U, M, 1), F = this.getCardinalDirection(-b, M, 3)) : (G = this.getCardinalDirection(U, M, 2), F = this.getCardinalDirection(b, M, 4)), !C)
              switch (G) {
                case 1:
                  k = c, Y = h + -g / M, a[0] = Y, a[1] = k;
                  break;
                case 2:
                  Y = N, k = s + L * M, a[0] = Y, a[1] = k;
                  break;
                case 3:
                  k = m, Y = h + g / M, a[0] = Y, a[1] = k;
                  break;
                case 4:
                  Y = _, k = s + -L * M, a[0] = Y, a[1] = k;
                  break;
              }
            if (!S)
              switch (F) {
    ...
    (function(p, T) {
      ...
      return function(T) {
        ...
        g.prototype.newGraphManager = function() {
          ...
          var G = M.length;
          u != null && G--;
          for (var F = 0, Y = M.length, k, X = n.getEdgesBetween(u); X.length > 1; ) {
            var P = X[0];
            X.splice(0, 1);
            var B = M.indexOf(P);
            B >= 0 && M.splice(B, 1), Y--, G--;
          }
          u != null ? k = (M.indexOf(X[0]) + 1) % Y : k = 0;
          for (var $ = Math.abs(v - l) / G, W = k; F != G; W = ++W % Y) {
          ...
          for (var Y = _.MAX_VALUE, k, X, P = 0; P < G.length; P++)
            G[P] < Y ? (Y = G[P], k = 1, X = P) : G[P] == Y && k++;
          if (k == 3 && Y == 0)
      ...
      return function(T) {
        ...
        c.prototype.run = function() {
          ...
          var S = function(b, M) {
            ...
            }, G = O.options.refresh, F, Y = 0; Y < G && !F; Y++)
            ...
            var k = O.layout.getPositionsData();
            L.eles.nodes().positions(function(X, P) {
              if (typeof X == "number" && (X = P), !X.isParent()) {
                for (var B = X.id(), $ = k[B], W = X; $ == null && ($ = k[W.data("parent")] || k["DummyCompound_" + W.data("parent")], k[B] = $, W = W.parent()[0], W != null); )
                  ;
...
Expecting ` + K.join(", ") + ", got '" + (this.terminals_[P] || P) + "'" : et = "Parse error on line " + (w + 1) + ": Unexpected " + (P == S ? "end of input" : "'" + (this.terminals_[P] || P) + "'"), this.parseError(et, { text: b.match, token: this.terminals_[P] || P, line: b.yylineno, loc: F, expected: K });
      ...
      switch ($[0]) {
        case 1:
          ...
          break;
        case 2:
          if (j = this.productions_[$[1]][1], q.$ = u[u.length - j], q._$ = { first_line: l[l.length - (j || 1)].first_line, last_line: l[l.length - 1].last_line, first_column: l[l.length - (j || 1)].first_column, last_column: l[l.length - 1].last_column }, Y && (q._$.range = [l[l.length - (j || 1)].range[0], l[l.length - 1].range[1]]), W = this.performAction.apply(q, [A, I, w, M.yy, $[1], u, l].concat(U)), typeof W < "u")
            return W;
...
var Pt = ot, z = [], ft = 0, at = {}, Ut = x(() => {
  z = [], ft = 0, at = {};
}, "clear"), Yt = x(function(D) {
  for (let R = z.length - 1; R >= 0; R--)
    if (z[R].level < D)
      return z[R];
  return null;
}, "getParent"), kt = x(() => z.length > 0 ? z[0] : null, "getMindmap"), Xt = x((D, R, p, T) => {
  var y, i;
  ...
  const r = { id: ft++, nodeId: tt(R, t), level: D, descr: tt(p, t), type: T, children: [], width: ((i = t.mindmap) == null ? void 0 : i.maxNodeWidth) ?? J.mindmap.maxNodeWidth, padding: e }, a = Yt(D);
  if (a)
...
}, "type2Str"), Vt = x(() => Q, "getLogger"), jt = x((D) => at[D], "getElementById"), zt = { clear: Ut, addNode: Xt, getMindmap: kt, nodeType: H, getType: Bt, setElementForId: $t, decorateNode: Ht, type2Str: Wt, getLogger: Vt, getElementById: jt }, qt = zt, Zt = 12, Qt = x(function(D, R, p, T) {
