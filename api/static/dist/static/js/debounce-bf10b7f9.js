import { bA as C, a2 as v, bB as L } from "./index-6feda8be.js";
var M = /\s/;
function N(n) {
...
var $ = /^\s+/;
function R(n) {
  return n && n.slice(0, N(n) + 1).replace($, "");
}
...
function z(n, r, t) {
  ...
  r = S(r) || 0, v(t) && (b = !!t.leading, d = "maxWait" in t, l = d ? U(S(t.maxWait) || 0, r) : l, T = "trailing" in t ? !!t.trailing : T);
  function x(e) {
    var a = u, m = c;
