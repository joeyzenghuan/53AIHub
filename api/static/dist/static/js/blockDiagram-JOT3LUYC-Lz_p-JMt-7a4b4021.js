import { _ as g, c as B, l as L, ak as ce, D as at, af as G, ag as Wt, ah as he, u as tt, ae as ge, P as ue, d as ye, x as pe, z as be, Q as xe, ai as fe, aj as bt, j as me, h as Tt } from "./mermaid-CI9Xz-tl-06ae91ae.js";
import { a as we } from "./clone-DhFCwC0s-7a31c97a.js";
import { F as O } from "./viewer-DpLhQV_x-5cf483f8.js";
import { L as Le } from "./graph-S7kq1CHN-26cf87d4.js";
import { l as Se } from "./channel-CjSQKY6b-473d2e61.js";
...
var xt = function() {
  var e = g(function(D, c, p, f) {
    ...
    var c = this, p = [0], f = [], E = [null], d = [], m = this.table, h = "", I = 0, M = 0, z = 2, W = 1, F = d.slice.call(arguments, 1), R = Object.create(this.lexer), V = { yy: {} };
    ...
    function Dt() {
      var Y;
      return Y = f.pop() || R.lex() || W, typeof Y != "number" && (Y instanceof Array && (f = Y, Y = f.pop()), Y = c.symbols_[Y] || Y), Y;
    }
    g(Dt, "lex");
    for (var X, q, H, yt, Q = {}, it, J, Nt, st; ; ) {
      if (q = p[p.length - 1], this.defaultActions[q] ? H = this.defaultActions[q] : ((X === null || typeof X > "u") && (X = Dt()), H = m[q] && m[q][X]), typeof H > "u" || !H.length || !H[0]) {
        ...
        R.showPosition ? pt = "Parse error on line " + (I + 1) + `:
` + R.showPosition() + `
Expecting ` + st.join(", ") + ", got '" + (this.terminals_[X] || X) + "'" : pt = "Parse error on line " + (I + 1) + ": Unexpected " + (X == W ? "end of input" : "'" + (this.terminals_[X] || X) + "'"), this.parseError(pt, { text: R.match, token: this.terminals_[X] || X, line: R.yylineno, loc: ut, expected: st });
      }
      if (H[0] instanceof Array && H.length > 1)
        throw new Error("Parse Error: multiple actions possible at state: " + q + ", token: " + X);
      switch (H[0]) {
        case 1:
          p.push(X), E.push(R.yytext), d.push(R.yylloc), p.push(H[1]), X = null, M = R.yyleng, h = R.yytext, I = R.yylineno, ut = R.yylloc;
          break;
        case 2:
          if (J = this.productions_[H[1]][1], Q.$ = E[E.length - J], Q._$ = { first_line: d[d.length - (J || 1)].first_line, last_line: d[d.length - 1].last_line, first_column: d[d.length - (J || 1)].first_column, last_column: d[d.length - 1].last_column }, le && (Q._$.range = [d[d.length - (J || 1)].range[0], d[d.length - 1].range[1]]), yt = this.performAction.apply(Q, [h, M, I, V.yy, H[1], E, d].concat(F)), typeof yt < "u")
            return yt;
          J && (p = p.slice(0, -1 * J * 2), E = E.slice(0, -1 * J), d = d.slice(0, -1 * J)), p.push(this.productions_[H[1]][0]), E.push(Q.$), d.push(Q._$), Nt = m[p[p.length - 2]][p[p.length - 1]], p.push(Nt);
          break;
        case 3:
          return true;
      }
...
}, "getColumns"), Be = g(() => [...U.values()], "getBlocksFlat"), ze = g(() => kt || [], "getBlocks"), Re = g(() => St, "getEdges"), Ae = g((e) => U.get(e), "getBlock"), Me = g((e) => {
  U.set(e.id, e);
}, "setBlock"), Pe = g(() => console, "getLogger"), Xe = g(function() {
  return lt;
}, "getClasses"), We = { getConfig: g(() => at().block, "getConfig"), typeStr2Type: Kt, edgeTypeStr2Type: Ht, edgeStrToEdgeData: jt, getLogger: Pe, getBlocksFlat: Be, getBlocks: ze, getEdges: Re, setHierarchy: Ie, getBlock: Ae, setBlock: Me, getColumns: Oe, getClasses: Xe, clear: $e, generateId: Ce }, Fe = We, nt = g((e, t) => {
...
}, "barb"), er = { extension: je, composition: Ue, aggregation: Ze, dependency: Ge, lollipop: Je, point: Ve, circle: qe, cross: Qe, barb: tr }, rr = He, Ot, Bt, C = ((Bt = (Ot = B()) == null ? void 0 : Ot.block) == null ? void 0 : Bt.padding) ?? 8;
function Ut(e, t) {
...
var ir = g((e, t, a, n) => {
  let s = e || "";
  if (typeof s == "object" && (s = s[0]), G(B().flowchart.htmlLabels)) {
  ...
  const a = B(), n = G(a.flowchart.htmlLabels), s = t.labelType === "markdown" ? Wt(e, t.label, { style: t.labelStyle, useHtmlLabels: n, addSvgBackground: true }, a) : j(t.label, t.labelStyle), r = e.insert("g").attr("class", "edgeLabel"), i = r.insert("g").attr("class", "label");
...
var lr = g((e, t) => {
  ...
  const y = r.node(t.v);
  var u = r.node(t.w);
  u != null && u.intersect && y != null && y.intersect && (o = o.slice(1, a.points.length - 1), o.unshift(y.intersect(o[0])), o.push(u.intersect(o[o.length - 1]))), a.toCluster && (L.debug("to cluster abc88", n[a.toCluster]), o = Rt(a.points, n[a.toCluster].node), l = true), a.fromCluster && (L.debug("from cluster abc88", n[a.fromCluster]), o = Rt(o.reverse(), n[a.fromCluster].node).reverse(), l = true);
...
var fr = g((e, t) => {
...
}, "intersectRect"), mr = fr, T = { node: yr, circle: pr, ellipse: qt, polygon: xr, rect: mr }, A = g(async (e, t, a, n) => {
  const s = B();
  let r;
  const i = t.useHtmlLabels || G(s.flowchart.htmlLabels);
  ...
  const u = l.node();
  let b;
  t.labelType === "markdown" ? b = Wt(l, Tt(bt(y), s), { useHtmlLabels: i, width: t.width || s.flowchart.wrappingWidth, classes: "markdown-node-label" }, s) : b = u.appendChild(j(Tt(bt(y), s), t.labelStyle, false, n));
  let x = b.getBBox();
  const S = t.padding / 2;
...
var wr = g(async (e, t) => {
  ...
  const { shapeSvg: a, bbox: n, halfPadding: s } = await A(e, t, "node " + t.classes, true);
...
}, "note"), Lr = wr, At = g((e) => e ? " " + e : "", "formatClass"), K = g((e, t) => `${t || "node default"}${At(e.classes)} ${At(e.class)}`, "getClassesFromNode"), Mt = g(async (e, t) => {
  const { shapeSvg: a, bbox: n } = await A(e, t, K(t, void 0), true), s = n.width + t.padding, r = n.height + t.padding, i = s + r, o = [{ x: i / 2, y: 0 }, { x: i, y: -i / 2 }, { x: i / 2, y: -i }, { x: 0, y: -i / 2 }];
  ...
  const { shapeSvg: a, bbox: n } = await A(e, t, K(t, void 0), true), s = 4, r = n.height + t.padding, i = r / s, o = n.width + 2 * i + t.padding, l = [{ x: i, y: 0 }, { x: o - i, y: 0 }, { x: o, y: -r / 2 }, { x: o - i, y: -r }, { x: i, y: -r }, { x: 0, y: -r / 2 }], y = Z(a, o, r, l);
  return y.attr("style", t.style), $(t, y), t.intersect = function(u) {
    return T.polygon(t, l, u);
  }, a;
}, "hexagon"), _r = g(async (e, t) => {
  const { shapeSvg: a, bbox: n } = await A(e, t, void 0, true), s = 2, r = n.height + 2 * t.padding, i = r / s, o = n.width + 2 * i + t.padding, l = ur(t.directions, n, t), y = Z(a, o, r, l);
  return y.attr("style", t.style), $(t, y), t.intersect = function(u) {
    return T.polygon(t, l, u);
  }, a;
}, "block_arrow"), vr = g(async (e, t) => {
  const { shapeSvg: a, bbox: n } = await A(e, t, K(t, void 0), true), s = n.width + t.padding, r = n.height + t.padding, i = [{ x: -r / 2, y: 0 }, { x: s, y: 0 }, { x: s, y: -r }, { x: -r / 2, y: -r }, { x: 0, y: -r / 2 }];
  ...
  const { shapeSvg: a, bbox: n } = await A(e, t, K(t), true), s = n.width + t.padding, r = n.height + t.padding, i = [{ x: -2 * r / 6, y: 0 }, { x: s - r / 6, y: 0 }, { x: s + 2 * r / 6, y: -r }, { x: r / 6, y: -r }], o = Z(a, s, r, i);
  return o.attr("style", t.style), $(t, o), t.intersect = function(l) {
    return T.polygon(t, i, l);
  }, a;
}, "lean_right"), Dr = g(async (e, t) => {
  const { shapeSvg: a, bbox: n } = await A(e, t, K(t, void 0), true), s = n.width + t.padding, r = n.height + t.padding, i = [{ x: 2 * r / 6, y: 0 }, { x: s + r / 6, y: 0 }, { x: s - 2 * r / 6, y: -r }, { x: -r / 6, y: -r }], o = Z(a, s, r, i);
  return o.attr("style", t.style), $(t, o), t.intersect = function(l) {
    return T.polygon(t, i, l);
  }, a;
}, "lean_left"), Nr = g(async (e, t) => {
  const { shapeSvg: a, bbox: n } = await A(e, t, K(t, void 0), true), s = n.width + t.padding, r = n.height + t.padding, i = [{ x: -2 * r / 6, y: 0 }, { x: s + 2 * r / 6, y: 0 }, { x: s - r / 6, y: -r }, { x: r / 6, y: -r }], o = Z(a, s, r, i);
  return o.attr("style", t.style), $(t, o), t.intersect = function(l) {
    return T.polygon(t, i, l);
  }, a;
}, "trapezoid"), Tr = g(async (e, t) => {
  const { shapeSvg: a, bbox: n } = await A(e, t, K(t, void 0), true), s = n.width + t.padding, r = n.height + t.padding, i = [{ x: r / 6, y: 0 }, { x: s - r / 6, y: 0 }, { x: s + 2 * r / 6, y: -r }, { x: -2 * r / 6, y: -r }], o = Z(a, s, r, i);
  return o.attr("style", t.style), $(t, o), t.intersect = function(l) {
    return T.polygon(t, i, l);
  }, a;
}, "inv_trapezoid"), $r = g(async (e, t) => {
  const { shapeSvg: a, bbox: n } = await A(e, t, K(t, void 0), true), s = n.width + t.padding, r = n.height + t.padding, i = [{ x: 0, y: 0 }, { x: s + r / 2, y: 0 }, { x: s, y: -r / 2 }, { x: s + r / 2, y: -r }, { x: 0, y: -r }], o = Z(a, s, r, i);
  return o.attr("style", t.style), $(t, o), t.intersect = function(l) {
    return T.polygon(t, i, l);
  }, a;
}, "rect_right_inv_arrow"), Cr = g(async (e, t) => {
  const { shapeSvg: a, bbox: n } = await A(e, t, K(t, void 0), true), s = n.width + t.padding, r = s / 2, i = r / (2.5 + s / 50), o = n.height + i + t.padding, l = "M 0," + i + " a " + r + "," + i + " 0,0,0 " + s + " 0 a " + r + "," + i + " 0,0,0 " + -s + " 0 l 0," + o + " a " + r + "," + i + " 0,0,0 " + s + " 0 l 0," + -o, y = a.attr("label-offset-y", i).insert("path", ":first-child").attr("style", t.style).attr("d", l).attr("transform", "translate(" + -s / 2 + "," + -(o / 2 + i) + ")");
  ...
  const { shapeSvg: a, bbox: n, halfPadding: s } = await A(e, t, "node " + t.classes + " " + t.class, true), r = a.insert("rect", ":first-child"), i = t.positioned ? t.width : n.width + t.padding, o = t.positioned ? t.height : n.height + t.padding, l = t.positioned ? -i / 2 : -n.width / 2 - s, y = t.positioned ? -o / 2 : -n.height / 2 - s;
  ...
  const { shapeSvg: a, bbox: n, halfPadding: s } = await A(e, t, "node " + t.classes, true), r = a.insert("rect", ":first-child"), i = t.positioned ? t.width : n.width + t.padding, o = t.positioned ? t.height : n.height + t.padding, l = t.positioned ? -i / 2 : -n.width / 2 - s, y = t.positioned ? -o / 2 : -n.height / 2 - s;
...
var zr = g((e, t) => {
...
}, "rectWithTitle"), Rr = g(async (e, t) => {
  const { shapeSvg: a, bbox: n } = await A(e, t, K(t, void 0), true), s = n.height + t.padding, r = n.width + s / 4 + t.padding, i = a.insert("rect", ":first-child").attr("style", t.style).attr("rx", s / 2).attr("ry", s / 2).attr("x", -r / 2).attr("y", -s / 2).attr("width", r).attr("height", s);
  return $(t, i), t.intersect = function(o) {
    return T.rect(t, o);
  }, a;
}, "stadium"), Ar = g(async (e, t) => {
  const { shapeSvg: a, bbox: n, halfPadding: s } = await A(e, t, K(t, void 0), true), r = a.insert("circle", ":first-child");
  ...
  const { shapeSvg: a, bbox: n, halfPadding: s } = await A(e, t, K(t, void 0), true), r = 5, i = a.insert("g", ":first-child"), o = i.insert("circle"), l = i.insert("circle");
  ...
  const { shapeSvg: a, bbox: n } = await A(e, t, K(t, void 0), true), s = n.width + t.padding, r = n.height + t.padding, i = [{ x: 0, y: 0 }, { x: s, y: 0 }, { x: s, y: -r }, { x: 0, y: -r }, { x: 0, y: 0 }, { x: -8, y: 0 }, { x: s + 8, y: 0 }, { x: s + 8, y: -r }, { x: -8, y: -r }, { x: -8, y: 0 }], o = Z(a, s, r, i);
  return o.attr("style", t.style), $(t, o), t.intersect = function(l) {
    return T.polygon(t, i, l);
  }, a;
}, "subroutine"), Xr = g((e, t) => {
  ...
  t.classData.members.forEach((m) => {
    ...
    if (G(B().flowchart.htmlLabels)) {
      ...
      z = W.getBoundingClientRect(), F.attr("width", z.width), F.attr("height", z.height);
    }
...
}, "class_box"), Xt = { rhombus: Mt, composite: Or, question: Mt, rect: Ir, labelRect: Br, rectWithTitle: zr, choice: Sr, circle: Ar, doublecircle: Mr, stadium: Rr, hexagon: kr, block_arrow: _r, rect_left_inv_arrow: vr, lean_right: Er, lean_left: Dr, trapezoid: Nr, inv_trapezoid: Tr, rect_right_inv_arrow: $r, cylinder: Cr, start: Xr, end: Wr, note: Lr, subroutine: Pr, fork: Pt, join: Pt, class_box: Fr }, ot = {}, re = g(async (e, t, a) => {
  let n, s;
  if (t.link) {
    let r;
    B().securityLevel === "sandbox" ? r = "_top" : t.linkTarget && (r = t.linkTarget || "_blank"), n = e.insert("svg:a").attr("xlink:href", t.link).attr("target", r), s = await Xt[t.shape](n, t, a);
  } else
    s = await Xt[t.shape](e, t, a), n = s;
...
}, "getClasses"), Hr = g(async function(e, t, a, n) {
...
}, "draw"), jr = { draw: Hr, getClasses: Kr }, ea = { parser: ke, db: Fe, renderer: jr, styles: Ke };
export {
  ea as diagram
};
