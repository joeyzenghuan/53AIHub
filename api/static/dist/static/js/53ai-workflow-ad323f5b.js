...
import { E as B } from "./el-switch-1a77f9ca.js";
import { A as G } from "./agent-info-3b42dae9.js";
import { _ as z } from "./expand-config.vue_vue_type_script_setup_true_lang-979a7e3f.js";
...
const V = { class: "py-7" }, x = { class: "text-base text-[#1D1E1F] font-medium" }, O = { class: "text-base text-[#1D1E1F] font-medium mt-10 mb-6" }, j = { class: "w-full border" }, q = { class: "flex items-center gap-2 cursor-pointer" }, H = { class: "w-full h-[50px] flex items-center pl-5" }, J = { class: "w-full border" }, K = { class: "flex items-center gap-2 cursor-pointer" }, M = { class: "w-full h-[50px] flex items-center pl-5" }, P = { class: "text-base text-[#1D1E1F] font-medium mt-10 mb-6" }, he = g({ __name: "53ai-workflow", setup(Q) {
