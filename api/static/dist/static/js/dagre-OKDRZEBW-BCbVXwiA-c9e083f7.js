import { _ as v, an as L, ao as M, ap as F, aq as j, l as t, c as Y, ar as q, as as H, ac as _, av as Z, ah as $, ad as D, ab as z, at as K, au as Q } from "./mermaid-CI9Xz-tl-06ae91ae.js";
import { L as k } from "./graph-S7kq1CHN-26cf87d4.js";
import { o as U } from "./layout-4labnYEG-b2dd9f73.js";
import { E as S } from "./_baseUniq-DmAMCrPp-6d586603.js";
import { a as V } from "./clone-DhFCwC0s-7a31c97a.js";
import { g as G } from "./_basePickBy-9qJ8CywS-494a5f5d.js";
...
function X(e) {
  ...
  return S(e.graph()) || (n.value = V(e.graph())), n;
}
function W(e) {
...
var u = /* @__PURE__ */ new Map(), N = /* @__PURE__ */ new Map(), J = /* @__PURE__ */ new Map(), ne = v(() => {
  ...
  e.nodes().forEach(function(r) {
    e.children(r).length > 0 && (t.warn("Cluster identified", r, " Replacement id in edges: ", x(r, e, r)), N.set(r, B(r, e)), u.set(r, { id: x(r, e, r), clusterData: e.node(r) }));
  }), e.nodes().forEach(function(r) {
...
}, "adjustClustersAndEdges"), T = v((e, n) => {
  var r, s;
...
Parent cluster`, d.height), n.setNode(d.id, i), n.parent(g) || (t.trace("Setting parent", g, d.id), n.setParent(g, d.id, i));
    ...
    if (t.info("(Insert) Node XXX" + g + ": " + JSON.stringify(n.node(g))), o != null && o.clusterNode) {
      ...
      q(o, C), o.diff = m.diff || 0, t.info("New compound node after recursive render XAX", g, "width", o.width, "height", o.height), H(C, o);
    } else
      n.children(g).length > 0 ? (t.trace("Cluster - the non recursive path XBX", g, o.id, o, o.width, "Graph:", n), t.trace(x(o.id, n)), u.set(o.id, { id: x(o.id, n), node: o })) : (t.trace("Node - the non recursive path XAX", g, p, n.node(g), a), await _(p, n.node(g), { config: c, dir: a }));
  })), await v(async () => {
    const g = n.edges().map(async function(o) {
      const i = n.edge(o.v, o.w, o.name);
      t.info("Edge " + o.v + " -> " + o.w + ": " + JSON.stringify(o)), t.info("Edge " + o.v + " -> " + o.w + ": ", o, " ", JSON.stringify(n.edge(o))), t.info("Fix", u, "ids:", o.v, o.w, "Translating: ", u.get(o.v), u.get(o.w)), await Z(b, i);
    });
    await Promise.all(g);
  }, "processEdges")(), t.info("Graph before layout:", JSON.stringify(X(n))), t.info("############################################# XXX"), t.info("###                Layout                 ### XXX"), t.info("############################################# XXX"), U(n), t.info("Graph after layout:", JSON.stringify(X(n)));
  let h = 0, { subGraphTitleTotalMargin: y } = $(c);
  return await Promise.all(ae(n).map(async function(g) {
    ...
    if (t.info("Position XBX => " + g + ": (" + i.x, "," + i.y, ") width: ", i.width, " height: ", i.height), i != null && i.clusterNode)
      ...
      t.debug("OffsetY", C, "labelHeight", m, "halfPadding", w), await z(f, i), u.get(i.id).node = i;
    } else {
  ...
  L(E, e.markers, e.type, e.diagramId), M(), F(), j(), ne(), e.nodes.forEach((p) => {
