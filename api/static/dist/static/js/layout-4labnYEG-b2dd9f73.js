import { L as b } from "./graph-S7kq1CHN-26cf87d4.js";
import { O as jn, b as $, y as Mn, L as H, i as Cn, U as nn, a as s, l as hn, E as m, S as k, I as M, C as Sn, c as gn, f as $n, _ as L } from "./_baseUniq-DmAMCrPp-6d586603.js";
import { f as N, V as Fn, v as Gn, d as Vn, u as T, t as vn, g as p, o as _, m as ln, h as J, r as Bn, X as F } from "./_basePickBy-9qJ8CywS-494a5f5d.js";
import { aw as Yn, aG as z, aP as qn, aQ as zn, aL as pn, aK as wn, aT as An, aU as A, aS as Dn, aR as Hn, aH as Jn, aN as Kn, ay as Qn } from "./mermaid-CI9Xz-tl-06ae91ae.js";
function Xn(n) {
...
function C(n, r) {
  var e = {};
  return r = H(r), hn(n, function(t, o, i) {
    Dn(e, o, r(t, o, i));
  }), e;
}
function y(n) {
...
function K(n, r) {
  return n && n.length ? vn(n, H(r), Bn) : void 0;
}
function tr(n, r) {
  var e = n.length;
  for (n.sort(r); e--; )
...
function ur(n, r) {
  return Gn(n, r, function(e, t) {
    return Cn(n, t);
  });
}
var j = Xn(function(n, r) {
...
var E = fr(), R = Yn(function(n, r) {
  if (n == null)
    return [];
  var e = r.length;
  return e > 1 && z(n, r[0], r[1]) ? r = [] : e > 2 && z(r[0], r[1], r[2]) && (r = [r[0]]), ar(n, jn(r), []);
}), hr = 0;
function Q(n) {
  var r = ++hr;
  return $n(n) + r;
...
function xr(n) {
  var r = n.graph().acyclicer === "greedy" ? mr(n, e(n)) : kr(n);
  s(r, function(t) {
    var o = n.edge(t);
...
function kr(n) {
  var r = [], e = {}, t = {};
  function o(i) {
    Object.prototype.hasOwnProperty.call(t, i) || (t[i] = true, e[i] = true, s(n.outEdges(i), function(a) {
...
function Tr(n) {
  var r = n.graph().rankdir.toLowerCase();
  (r === "bt" || r === "rl") && jr(n), (r === "lr" || r === "rl") && (Mr(n), yn(n));
}
function yn(n) {
...
function Sr(n, r) {
  ...
  if (i !== t + 1) {
    ...
    var c = void 0, f, h;
    for (h = 0, ++t; t < i; ++h, ++t)
      u.points = [], c = { width: 0, height: 0, edgeLabel: u, edgeObj: r, rank: t }, f = O(n, "edge", c, "_d"), t === d && (c.width = u.width, c.height = u.height, c.dummy = "edge-label", c.labelpos = u.labelpos), n.setEdge(e, f, { weight: u.weight }, a), h === 0 && n.graph().dummyChains.push(f), e = f;
...
function X(n) {
  ...
  function e(t) {
    ...
    if (Object.prototype.hasOwnProperty.call(r, t))
      return o.rank;
    r[t] = true;
    var i = _(p(n.outEdges(t), function(a) {
      return e(a.w) - n.edge(a).minlen;
    }));
    return (i === Number.POSITIVE_INFINITY || i === void 0 || i === null) && (i = 0), o.rank = i;
  }
  s(n.sources(), e);
}
function P(n, r) {
...
function xn(n) {
  var r = new b({ directed: false }), e = n.nodes()[0], t = n.nodeCount();
  r.setNode(e, {});
...
function En(n, r, e, t, o, i) {
  Object.prototype.hasOwnProperty.call(t, r) || (t[r] = true, e || i.push(r), s(o(r), function(a) {
    En(n, a, e, t, o, i);
  }), e && i.push(r));
}
function Br(n, r) {
...
function Nn(n, r, e) {
  ...
  return a || (i = false, a = r.edge(o, e)), u = a.weight, s(r.nodeEdges(e), function(d) {
...
function On(n, r, e, t, o) {
  var i = e, a = n.node(t);
  return r[t] = true, s(n.neighbors(t), function(u) {
...
function Pn(n, r, e, t) {
  var o = e.v, i = e.w;
  n.removeEdge(o, i), n.setEdge(t.v, t.w, {}), Z(n), U(n, r), zr(n, r);
}
function zr(n, r) {
...
function Kr(n) {
  var r = O(n, "root", {}, "_root"), e = Qr(n), t = y(k(e)) - 1, o = 2 * t + 1;
...
function Ln(n, r, e, t, o, i, a) {
  ...
  n.setParent(d, a), f.borderTop = d, n.setParent(c, a), f.borderBottom = c, s(u, function(h) {
    ...
    n.setEdge(d, v, { weight: w, minlen: I, nestingEdge: true }), n.setEdge(l, c, { weight: w, minlen: I, nestingEdge: true });
...
function Wr(n, r, e) {
  var t = ne(n), o = new b({ compound: true }).setGraph({ root: t }).setDefaultNodeLabel(function(i) {
    return n.node(i);
  });
  return s(n.nodes(), function(i) {
    ...
    }), Object.prototype.hasOwnProperty.call(a, "minRank") && o.setNode(i, { borderLeft: a.borderLeft[r], borderRight: a.borderRight[r] }));
  }), o;
}
function ne(n) {
...
function ee(n, r, e) {
  for (var t = vr(e, p(e, function(c, f) {
    return f;
  })), o = N(p(r, function(c) {
    return R(p(n.outEdges(c), function(f) {
...
function ie(n, r) {
  var e = {};
  s(n, function(o, i) {
    var a = e[o.v] = { indegree: 0, in: [], out: [], vs: [o.v], i };
  ...
  function t(i, a, u, d, c) {
    ...
    s(E(a, u), function(h) {
      f = i[h], n.node(f).dummy && s(n.predecessors(f), function(g) {
        var v = n.node(g);
        v.dummy && (v.order < d || v.order > c) && Tn(e, g, f);
      });
    });
  }
  function o(i, a) {
...
function _e(n) {
  var r = S(n), e = A(we(n, r), me(n, r)), t = {}, o;
  s(["u", "d"], function(a) {
    o = a === "u" ? r : k(r).reverse(), s(["l", "r"], function(u) {
      u === "r" && (o = p(o, function(h) {
        return k(h).reverse();
      }));
      var d = (a === "u" ? n.predecessors : n.successors).bind(n), c = xe(n, o, e, d), f = ke(n, o, c.root, c.align, u === "r");
...
function Re(n) {
  n = mn(n), Te(n), rr(_e(n), function(r, e) {
    n.node(e).x = r;
  });
}
function Te(n) {
...
function it(n, r) {
  ...
  e("layout", () => {
    ...
    e("  runLayout", () => je(t, e)), e("  updateInputGraph", () => Me(n, t));
  });
}
function je(n, r) {
  r("    makeSpaceForEdgeLabels", () => ze(n)), r("    removeSelfEdges", () => Ze(n)), r("    acyclic", () => xr(n)), r("    nestingGraph.run", () => Kr(n)), r("    rank", () => Dr(mn(n))), r("    injectEdgeLabelProxies", () => Ae(n)), r("    removeEmptyRanks", () => Ir(n)), r("    nestingGraph.cleanup", () => Ur(n)), r("    normalizeRanks", () => Or(n)), r("    assignRankMinMax", () => De(n)), r("    removeEdgeLabelProxies", () => He(n)), r("    normalize.run", () => Cr(n)), r("    parentDummyChains", () => ve(n)), r("    addBorderSegments", () => Lr(n)), r("    order", () => he(n)), r("    insertSelfEdges", () => We(n)), r("    adjustCoordinateSystem", () => Rr(n)), r("    position", () => Re(n)), r("    positionSelfEdges", () => nt(n)), r("    removeBorderNodes", () => Ue(n)), r("    normalize.undo", () => $r(n)), r("    fixupEdgeLabelCoords", () => Qe(n)), r("    undoCoordinateSystem", () => Tr(n)), r("    translateGraph", () => Je(n)), r("    assignNodeIntersects", () => Ke(n)), r("    reversePoints", () => Xe(n)), r("    acyclic.undo", () => Er(n));
}
function Me(n, r) {
  s(n.nodes(), function(e) {
...
var Ce = ["nodesep", "edgesep", "ranksep", "marginx", "marginy"], Se = { ranksep: 50, edgesep: 20, nodesep: 50, rankdir: "tb" }, $e = ["acyclicer", "ranker", "rankdir", "align"], Fe = ["width", "height"], Ge = { width: 0, height: 0 }, Ve = ["minlen", "weight", "width", "height", "labeloffset"], Be = { minlen: 1, weight: 1, width: 0, height: 0, labeloffset: 10, labelpos: "r" }, Ye = ["labelpos"];
function qe(n) {
  var r = new b({ multigraph: true, compound: true }), e = q(n.graph());
  return r.setGraph(A({}, Se, Y(e, Ce), j(e, $e))), s(n.nodes(), function(t) {
    var o = q(n.node(t));
    r.setNode(t, Vn(Y(o, Fe), Ge)), r.setParent(t, n.parent(t));
  }), s(n.edges(), function(t) {
    var o = q(n.edge(t));
    r.setEdge(t, A({}, Be, Y(o, Ve), j(o, Ye)));
  }), r;
}
function ze(n) {
  var r = n.graph();
...
function Ue(n) {
  s(n.nodes(), function(r) {
    if (n.children(r).length) {
      var e = n.node(r), t = n.node(e.borderTop), o = n.node(e.borderBottom), i = n.node(T(e.borderLeft)), a = n.node(T(e.borderRight));
  ...
  s(r, function(e) {
    ...
    s(e, function(o, i) {
      ...
      a.order = i + t, s(a.selfEdges, function(u) {
        O(n, "selfedge", { width: u.label.width, height: u.label.height, rank: a.rank, order: i + ++t, e: u.e, label: u.label }, "_se");
      }), delete a.selfEdges;
    });
  });
}
function nt(n) {
  s(n.nodes(), function(r) {
    ...
    if (e.dummy === "selfedge") {
      ...
      n.setEdge(e.e, e.label), n.removeNode(r), e.label.points = [{ x: o + 2 * a / 3, y: i - u }, { x: o + 5 * a / 6, y: i - u }, { x: o + a, y: i }, { x: o + 5 * a / 6, y: i + u }, { x: o + 2 * a / 3, y: i + u }], e.label.x = e.x, e.label.y = e.y;
    }
  });
}
function Y(n, r) {
  return C(j(n, r), Number);
}
function q(n) {
  var r = {};
