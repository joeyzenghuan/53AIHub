import { y as E, b as H, c as L, m as B, p as R, d as f, a7 as k, e as T, q as F, t as Y, r as I, Z as K, $ as ee, j, w as W, f as b, u as $, b_ as te, b$ as ie, bX as se, L as _, n as oe, aG as P, G as V, a4 as q, a6 as re, a9 as D, bW as he, I as ae, s as U, F as ce, aB as ne, x as le } from "./index-8579fe4a.js";
const G = {};
...
const We = me(ve, [["render", Oe], ["__scopeId", "data-v-a742df44"]]), He = { class: "cropper" }, Xe = { class: "cropper_left" }, Ye = { class: "reupload_box" }, Me = { class: "cropper_right" }, Se = { class: "preview_text" }, Ie = ["src"], Le = { class: "dialog-footer" }, ke = E({ __name: "index", props: { type: { default: "systemLogo" }, allowTypeList: { default: () => ["jpg", "png", "jpeg"] }, limitSize: { default: 10 }, fixedNumber: { default: () => [1, 1] }, fixedNumberAider: { default: () => [1, 1] }, previewWidth: { default: 160 }, title: { default: "\u56FE\u7247\u88C1\u526A" }, showWidth: { default: 300 }, showHeight: { default: 300 }, action: { default: "ibos" }, uploadAvatar: { type: Boolean, default: false }, cropperDisabled: { type: Boolean, default: false } }, emits: ["confirm"], setup(e, { expose: t, emit: i }) {
  const s = /* @__PURE__ */ new Map([["jpg", "image/jpg"], ["png", "image/png"], ["jpeg", "image/jpeg"], ["ico", "image/x-icon,image/ico"]]), o = e, r = i, h = I(false), a = K({ img: "", autoCrop: true, autoCropWidth: 300, autoCropHeight: 300, fixedBox: false, info: true, outputSize: 1, outputType: "png", canScale: true, fixed: true, fixedNumber: [1, 1], full: true, canMove: false, original: false, centerBox: true, infoTrue: true, accept: "image/jpeg,image/jpg,image/png,image/gif,image/x-icon", fillColor: "transparent" }), c = I({ width: "", height: "" }), n = I([]), l = I({}), p = I({}), u = I(), m = I(false), M = (g) => {
    ...
    m.value = true, p.value.getCropData(async (g) => {
      const d = Q(g, "images.png"), y = await N(d).finally(() => {
        m.value = false;
  ...
  }, { deep: true, immediate: true }), t({ uploadFile: A, open(g) {
    a.img = g, h.value = true;
  } }), (g, d) => {
    const y = V, X = q, S = re;
    return H(), j(S, { "model-value": h.value, title: g.$t("image_cropper"), width: "550px", "close-on-click-modal": false, "close-on-press-escape": false, "append-to-body": "", onClose: d[4] || (d[4] = (O) => h.value = false) }, { default: W(() => [f("div", He, [f("div", Xe, [b($(We), { ref_key: "cropperRef", ref: p, style: k({ width: `${g.showWidth}px`, height: `${g.showHeight}px` }), img: a.img, info: true, "info-true": a.infoTrue, "auto-crop": a.autoCrop, "fixed-box": a.fixedBox, "can-move": a.canMove, "can-scale": a.canScale, "fixed-number": g.fixedNumber, fixed: a.fixed, full: a.full, "center-box": a.centerBox, "fill-color": a.fillColor, "output-type": a.outputType, onRealTime: J }, null, 8, ["style", "img", "info-true", "auto-crop", "fixed-box", "can-move", "can-scale", "fixed-number", "fixed", "full", "center-box", "fill-color", "output-type"]), f("div", Ye, [f("div", { class: "reupload_text", onClick: d[0] || (d[0] = (O) => A("reload")) }, Y(g.$t("reupload")), 1), f("div", null, [b(y, { class: "rotate_right", onClick: d[1] || (d[1] = (O) => x(1)) }, { default: W(() => [b($(te))]), _: 1 }), b(y, { class: "rotate_right", onClick: d[2] || (d[2] = (O) => x(-1)) }, { default: W(() => [b($(ie))]), _: 1 }), b(y, { class: "rotate_right", onClick: C }, { default: W(() => [b($(se))]), _: 1 })])])]), f("div", Me, [f("div", Se, Y(g.$t("action_preview")), 1), f("div", { style: k(c.value), class: "previewImg" }, [f("img", { style: k(l.value.img), src: l.value.img, alt: "" }, null, 12, Ie)], 4)])])]), footer: W(() => [f("span", Le, [b(X, { size: "large", onClick: d[3] || (d[3] = (O) => h.value = false) }, { default: W(() => [_(Y(g.$t("action_cancel")), 1)]), _: 1 }), b(X, { size: "large", type: "", onClick: w }, { default: W(() => [_(Y(g.$t("action_reset")), 1)]), _: 1 }), b(X, { size: "large", type: "primary", loading: m.value, onClick: Z }, { default: W(() => [_(Y(g.$t("action_confirm")), 1)]), _: 1 }, 8, ["loading"])])]), _: 1 }, 8, ["model-value", "title"]);
  };
} });
const $e = ae(ke, [["__scopeId", "data-v-143dbe6c"]]), _e = ["src"], Te = { key: 1, class: "w-full h-full flex items-center justify-center border rounded upload-image-placeholder" }, Ee = { class: "hidden group-hover:flex absolute top-0 right-0 bottom-0 left-0 bg-black bg-opacity-40 items-center justify-center gap-6 text-xs text-white" }, Ne = E({ __name: "image", props: { modelValue: { default: "" }, text: { default: "action_replace" }, showText: { type: Boolean, default: false }, cropperDisabled: { type: Boolean, default: false }, allowTypeList: {}, disabled: { type: Boolean, default: false } }, emits: ["update:modelValue", "confirm"], setup(e, { emit: t }) {
  const i = e, s = t, o = I(), r = () => {
  ...
  return (a, c) => {
    const n = q, l = V;
    return H(), L("div", { class: F(["w-[50px] h-[50px] rounded overflow-hidden relative cursor-pointer group", [a.disabled ? "cursor-not-allowed" : ""]]), onClick: le(r, ["stop"]) }, [U(a.$slots, "default", {}, () => [a.showText ? (H(), j(n, { key: 0, type: "text" }, { default: W(() => [_(Y(a.$t(a.text)), 1)]), _: 1 })) : (H(), L(ce, { key: 1 }, [a.modelValue ? (H(), L("img", { key: 0, class: "w-full h-full object-cover", src: a.modelValue, alt: "logo" }, null, 8, _e)) : (H(), L("div", Te, [b(l, { size: "16", color: "#9A9A9A" }, { default: W(() => [b($(ne))]), _: 1 })])), f("div", Ee, [U(a.$slots, "mask-text", {}, () => [_(Y(a.$t(a.text)), 1)])])], 64))]), b($e, { ref_key: "cropper_ref", ref: o, action: "python", cropperDisabled: a.cropperDisabled, allowTypeList: a.allowTypeList, onConfirm: h }, null, 8, ["cropperDisabled", "allowTypeList"])], 2);
  };
} });
export {
  Ne as _
