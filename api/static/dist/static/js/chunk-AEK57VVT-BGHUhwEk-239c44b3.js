import { b as ie, B as re } from "./chunk-RZ5BOZE2-D7vSOP4k-fa3f167d.js";
import { _ as h, l as T, R as ne, c as $, j as M, x as ae, r as oe, u as le, a as ce, b as he, g as de, s as ue, o as pe, p as ye } from "./mermaid-CI9Xz-tl-06ae91ae.js";
var ge = Object.defineProperty, me = (t, e, o) => e in t ? ge(t, e, { enumerable: true, configurable: true, writable: true, value: o }) : t[e] = o, k = (t, e, o) => me(t, typeof e != "symbol" ? e + "" : e, o), kt = function() {
  var t = h(function(I, r, n, y) {
    for (n = n || {}, y = I.length; y--; n[I[y]] = r)
      ;
    return n;
  }, "o"), e = [1, 2], o = [1, 3], a = [1, 4], i = [2, 4], c = [1, 9], p = [1, 11], m = [1, 16], d = [1, 17], S = [1, 18], b = [1, 19], L = [1, 32], X = [1, 20], F = [1, 21], A = [1, 22], u = [1, 23], x = [1, 24], O = [1, 26], P = [1, 27], Y = [1, 28], R = [1, 29], N = [1, 30], Z = [1, 31], tt = [1, 34], et = [1, 35], st = [1, 36], it = [1, 37], J = [1, 33], g = [1, 4, 5, 16, 17, 19, 21, 22, 24, 25, 26, 27, 28, 29, 33, 35, 37, 38, 42, 45, 48, 49, 50, 51, 54], rt = [1, 4, 5, 14, 15, 16, 17, 19, 21, 22, 24, 25, 26, 27, 28, 29, 33, 35, 37, 38, 42, 45, 48, 49, 50, 51, 54], $t = [4, 5, 16, 17, 19, 21, 22, 24, 25, 26, 27, 28, 29, 33, 35, 37, 38, 42, 45, 48, 49, 50, 51, 54], yt = { trace: h(function() {
  ...
  }, "anonymous"), table: [{ 3: 1, 4: e, 5: o, 6: a }, { 1: [3] }, { 3: 5, 4: e, 5: o, 6: a }, { 3: 6, 4: e, 5: o, 6: a }, t([1, 4, 5, 16, 17, 19, 22, 24, 25, 26, 27, 28, 29, 33, 35, 37, 38, 42, 45, 48, 49, 50, 51, 54], i, { 7: 7 }), { 1: [2, 1] }, { 1: [2, 2] }, { 1: [2, 3], 4: c, 5: p, 8: 8, 9: 10, 10: 12, 11: 13, 12: 14, 13: 15, 16: m, 17: d, 19: S, 22: b, 24: L, 25: X, 26: F, 27: A, 28: u, 29: x, 32: 25, 33: O, 35: P, 37: Y, 38: R, 42: N, 45: Z, 48: tt, 49: et, 50: st, 51: it, 54: J }, t(g, [2, 5]), { 9: 38, 10: 12, 11: 13, 12: 14, 13: 15, 16: m, 17: d, 19: S, 22: b, 24: L, 25: X, 26: F, 27: A, 28: u, 29: x, 32: 25, 33: O, 35: P, 37: Y, 38: R, 42: N, 45: Z, 48: tt, 49: et, 50: st, 51: it, 54: J }, t(g, [2, 7]), t(g, [2, 8]), t(g, [2, 9]), t(g, [2, 10]), t(g, [2, 11]), t(g, [2, 12], { 14: [1, 39], 15: [1, 40] }), t(g, [2, 16]), { 18: [1, 41] }, t(g, [2, 18], { 20: [1, 42] }), { 23: [1, 43] }, t(g, [2, 22]), t(g, [2, 23]), t(g, [2, 24]), t(g, [2, 25]), { 30: 44, 31: [1, 45], 56: [1, 46], 57: [1, 47] }, t(g, [2, 28]), { 34: [1, 48] }, { 36: [1, 49] }, t(g, [2, 31]), { 39: [1, 50], 41: [1, 51] }, { 43: [1, 52] }, { 46: [1, 53] }, t(rt, [2, 42], { 55: [1, 54] }), t(rt, [2, 43], { 55: [1, 55] }), t(g, [2, 36]), t(g, [2, 37]), t(g, [2, 38]), t(g, [2, 39]), t(g, [2, 6]), t(g, [2, 13]), { 13: 56, 24: L, 54: J }, t(g, [2, 17]), t($t, i, { 7: 57 }), { 24: [1, 58] }, { 24: [1, 59] }, { 23: [1, 60] }, { 24: [2, 46] }, { 24: [2, 47] }, t(g, [2, 29]), t(g, [2, 30]), { 40: [1, 61] }, { 40: [1, 62] }, { 44: [1, 63] }, { 47: [1, 64] }, { 24: [1, 65] }, { 24: [1, 66] }, t(g, [2, 14], { 14: [1, 67] }), { 4: c, 5: p, 8: 8, 9: 10, 10: 12, 11: 13, 12: 14, 13: 15, 16: m, 17: d, 19: S, 21: [1, 68], 22: b, 24: L, 25: X, 26: F, 27: A, 28: u, 29: x, 32: 25, 33: O, 35: P, 37: Y, 38: R, 42: N, 45: Z, 48: tt, 49: et, 50: st, 51: it, 54: J }, t(g, [2, 20], { 20: [1, 69] }), { 31: [1, 70] }, { 24: [1, 71] }, t(g, [2, 32]), t(g, [2, 33]), t(g, [2, 34]), t(g, [2, 35]), t(rt, [2, 44]), t(rt, [2, 45]), t(g, [2, 15]), t(g, [2, 19]), t($t, i, { 7: 72 }), t(g, [2, 26]), t(g, [2, 27]), { 4: c, 5: p, 8: 8, 9: 10, 10: 12, 11: 13, 12: 14, 13: 15, 16: m, 17: d, 19: S, 21: [1, 73], 22: b, 24: L, 25: X, 26: F, 27: A, 28: u, 29: x, 32: 25, 33: O, 35: P, 37: Y, 38: R, 42: N, 45: Z, 48: tt, 49: et, 50: st, 51: it, 54: J }, t(g, [2, 21])], defaultActions: { 5: [2, 1], 6: [2, 2], 46: [2, 46], 47: [2, 47] }, parseError: h(function(I, r) {
    if (r.recoverable)
      this.trace(I);
    else {
      var n = new Error(I);
    ...
    var r = this, n = [0], y = [], f = [null], s = [], E = this.table, l = "", G = 0, U = 0, at = 2, K = 1, gt = s.slice.call(arguments, 1), _ = Object.create(this.lexer), j = { yy: {} };
...
Expecting ` + lt.join(", ") + ", got '" + (this.terminals_[D] || D) + "'" : bt = "Parse error on line " + (G + 1) + ": Unexpected " + (D == K ? "end of input" : "'" + (this.terminals_[D] || D) + "'"), this.parseError(bt, { text: _.match, token: this.terminals_[D] || D, line: _.yylineno, loc: St, expected: lt });
      ...
      switch (C[0]) {
        case 1:
          n.push(D), f.push(_.yytext), s.push(_.yylloc), n.push(C[1]), D = null, U = _.yyleng, l = _.yytext, G = _.yylineno, St = _.yylloc;
          break;
        case 2:
          if (w = this.productions_[C[1]][1], H.$ = f[f.length - w], H._$ = { first_line: s[s.length - (w || 1)].first_line, last_line: s[s.length - 1].last_line, first_column: s[s.length - (w || 1)].first_column, last_column: s[s.length - 1].last_column }, ee && (H._$.range = [s[s.length - (w || 1)].range[0], s[s.length - 1].range[1]]), ft = this.performAction.apply(H, [l, U, G, j.yy, C[1], f, s].concat(gt)), typeof ft < "u")
            return ft;
          w && (n = n.slice(0, -1 * w * 2), f = f.slice(0, -1 * w), s = s.slice(0, -1 * w)), n.push(this.productions_[C[1]][0]), f.push(H.$), s.push(H._$), It = E[n[n.length - 2]][n[n.length - 1]], n.push(It);
          break;
        case 3:
          return true;
      }
...
kt.parser = kt;
var He = kt, Se = "TB", jt = "TB", Lt = "dir", dt = "state", Et = "relation", fe = "classDef", be = "style", _e = "applyClass", W = "default", zt = "divider", Mt = "fill:none", Xt = "fill: #333", Ut = "c", Ht = "text", Jt = "normal", _t = "rect", Tt = "rectWithTitle", Te = "stateStart", ke = "stateEnd", At = "divider", Ot = "roundedWithTitle", Ee = "note", De = "noteGroup", Q = "statediagram", ve = "state", Ce = `${Q}-${ve}`, Kt = "transition", $e = "note", xe = "note-edge", Ie = `${Kt} ${xe}`, Le = `${Q}-${$e}`, Ae = "cluster", Oe = `${Q}-${Ae}`, we = "cluster-alt", Re = `${Q}-${we}`, Vt = "parent", qt = "note", Ne = "state", Ct = "----", Be = `${Ct}${qt}`, wt = `${Ct}${Vt}`, Wt = h((t, e = jt) => {
  if (!t.doc)
    return e;
  let o = e;
  ...
  const S = 8;
  le.insertTitle(d, "statediagramTitleText", (c == null ? void 0 : c.titleTopMargin) ?? 25, a.db.getDiagramTitle()), re(d, S, Q, (c == null ? void 0 : c.useMaxWidth) ?? true);
}, "draw"), Je = { getClasses: Fe, draw: Pe, getDir: Wt }, ut = /* @__PURE__ */ new Map(), B = 0;
      ...
      case Et:
        {
          ...
          const S = { id: "edge" + B, start: d.state1.id, end: d.state2.id, arrowhead: "normal", arrowTypeEnd: "arrow_barb", style: Mt, labelStyle: "", label: M.sanitizeText(d.description, $()), arrowheadStyle: Xt, labelpos: Ut, labelType: Ht, thickness: Jt, classes: Kt, look: p };
          i.push(S), B++;
        }
        break;
    }
...
var q = h((t, e, o, a, i, c, p, m) => {
  var d, S;
  const b = e.id, L = o.get(b), X = Qt(L), F = Zt(L);
  if (T.info("dataFetcher parsedItem", e, L, F), b !== "root") {
    let A = _t;
    e.start === true ? A = Te : e.start === false && (A = ke), e.type !== W && (A = e.type), ut.get(b) || ut.set(b, { id: b, shape: A, description: M.sanitizeText(b, $()), cssClasses: `${X} ${Ce}`, cssStyles: F });
    const u = ut.get(b);
    e.description && (Array.isArray(u.description) ? (u.shape = Tt, u.description.push(e.description)) : ((d = u.description) == null ? void 0 : d.length) > 0 ? (u.shape = Tt, u.description === b ? u.description = [e.description] : u.description = [u.description, e.description]) : (u.shape = _t, u.description = e.description), u.description = M.sanitizeTextOrArray(u.description, $())), ((S = u.description) == null ? void 0 : S.length) === 1 && u.shape === Tt && (u.type === "group" ? u.shape = Ot : u.shape = _t), !u.type && e.doc && (T.info("Setting cluster for XCX", b, Rt(e)), u.type = "group", u.isGroup = true, u.dir = Rt(e), u.shape = e.type === zt ? At : Ot, u.cssClasses = `${u.cssClasses} ${Oe} ${c ? Re : ""}`);
    ...
    if (x.shape === At && (x.label = ""), t && t.id !== "root" && (T.trace("Setting node ", b, " to be child of its parent ", t.id), x.parentId = t.id), x.centerLabel = true, e.note) {
      const O = { labelStyle: "", shape: Ee, label: e.note.text, cssClasses: Le, cssStyles: [], cssCompilesStyles: [], id: b + Be + "-" + B, domId: pt(b, B, qt), type: u.type, isGroup: u.type === "group", padding: $().flowchart.padding, look: p, position: e.note.position }, P = b + wt, Y = { labelStyle: "", shape: De, label: e.note.text, cssClasses: u.cssClasses, cssStyles: [], id: b + wt, domId: pt(b, B, Vt), type: "group", isGroup: true, padding: 16, look: p, position: e.note.position };
      B++, Y.id = P, O.parentId = P, V(a, Y, m), V(a, O, m), V(a, x, m);
      let R = b, N = O.id;
      e.note.position === "left of" && (R = O.id, N = b), i.push({ id: R + "-" + N, start: R, end: N, arrowhead: "none", arrowTypeEnd: "", style: Mt, labelStyle: "", classes: Ie, arrowheadStyle: Xt, labelpos: Ut, labelType: Ht, thickness: Jt, look: p });
    } else
      V(a, x, m);
  }
...
var Gt = h(() => ({ relations: [], states: /* @__PURE__ */ new Map(), documents: {} }), "newDoc"), ct = h((t) => JSON.parse(JSON.stringify(t)), "clone"), ht, Ke = (ht = class {
  ...
  addState(t, e = W, o = null, a = null, i = null, c = null, p = null, m = null) {
  ...
  getData() {
    const t = $();
    return { nodes: this.nodes, edges: this.edges, other: {}, config: t, direction: Wt(this.getRootDocV2()) };
  }
  getConfig() {
    return $().state;
  }
