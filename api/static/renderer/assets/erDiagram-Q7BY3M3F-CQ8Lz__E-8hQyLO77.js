...
import { _ as p, A as pm, l as D, c as dt$1, n as J_, r as Q_, u as ge, b as Jm, a as ty, s as ey, g as ry, o as iy, p as ay, x as Qm, v as U_, z as xi } from "./mermaid-j5R1o_wi-dCQhMK9F.js";
...
var dt = function() {
  var s = /* @__PURE__ */ p(function(R, n, a, c) {
    for (a = a || {}, c = R.length; c--; a[R[c]] = n)
      ;
    return a;
  }, "o"), i = [6, 8, 10, 22, 24, 26, 28, 33, 34, 35, 36, 37, 40, 43, 44, 50], h = [1, 10], d = [1, 11], o = [1, 12], l2 = [1, 13], f = [1, 20], _ = [1, 21], E = [1, 22], V = [1, 23], Z = [1, 24], S = [1, 19], et = [1, 25], U = [1, 26], T = [1, 18], L = [1, 33], st = [1, 34], it = [1, 35], rt = [1, 36], nt = [1, 37], pt = [6, 8, 10, 13, 15, 17, 20, 21, 22, 24, 26, 28, 33, 34, 35, 36, 37, 40, 43, 44, 50, 63, 64, 65, 66, 67], O = [1, 42], A = [1, 43], M = [1, 52], B2 = [40, 50, 68, 69], F = [1, 63], Y = [1, 61], N = [1, 58], P = [1, 62], z = [1, 64], j = [6, 8, 10, 13, 17, 22, 24, 26, 28, 33, 34, 35, 36, 37, 40, 41, 42, 43, 44, 48, 49, 50, 63, 64, 65, 66, 67], yt = [63, 64, 65, 66, 67], ft = [1, 81], _t = [1, 80], gt = [1, 78], bt = [1, 79], mt = [6, 10, 42, 47], v = [6, 10, 13, 41, 42, 47, 48, 49], W = [1, 89], Q = [1, 88], X = [1, 87], G = [19, 56], Et = [1, 98], kt = [1, 97], at = [19, 56, 58, 60], ct = {
    ...
    performAction: /* @__PURE__ */ p(function(n, a, c, r, p2, t, K) {
      var e = t.length - 1;
      switch (p2) {
        case 1:
          break;
    ...
    parse: /* @__PURE__ */ p(function(n) {
      var a = this, c = [0], r = [], p$1 = [null], t = [], K = this.table, e = "", H = 0, St = 0, xt = 2, Tt = 1, It = t.slice.call(arguments, 1), y = Object.create(this.lexer), x = { yy: {} };
      ...
      function Ct(b2) {
        c.length = c.length - 2 * b2, p$1.length = p$1.length - b2, t.length = t.length - b2;
      }
      p(Ct, "popStack");
      function Ot() {
        var b2;
        return b2 = r.pop() || y.lex() || Tt, typeof b2 != "number" && (b2 instanceof Array && (r = b2, b2 = r.pop()), b2 = a.symbols_[b2] || b2), b2;
      }
      p(Ot, "lex");
...
Expecting ` + $.join(", ") + ", got '" + (this.terminals_[g] || g) + "'" : ut = "Parse error on line " + (H + 1) + ": Unexpected " + (g == Tt ? "end of input" : "'" + (this.terminals_[g] || g) + "'"), this.parseError(ut, {
        ...
        switch (m[0]) {
          case 1:
            c.push(g), p$1.push(y.yytext), t.push(y.yylloc), c.push(m[1]), g = null, St = y.yyleng, e = y.yytext, H = y.yylineno, ot = y.yylloc;
            break;
          case 2:
            if (k = this.productions_[m[1]][1], C.$ = p$1[p$1.length - k], C._$ = {
              ...
              return ht;
            k && (c = c.slice(0, -1 * k * 2), p$1 = p$1.slice(0, -1 * k), t = t.slice(0, -1 * k)), c.push(this.productions_[m[1]][0]), p$1.push(C.$), t.push(C._$), At = K[c[c.length - 2]][c[c.length - 1]], c.push(At);
            break;
          case 3:
            return true;
        }
...
` + a + "^";
      ...
      test_match: /* @__PURE__ */ p(function(n, a) {
        ...
        }, this.options.ranges && (p2.yylloc.range = this.yylloc.range.slice(0))), r = n[0].match(/(?:\r\n?|\n).*/g), r && (this.yylineno += r.length), this.yylloc = {
      ...
      next: /* @__PURE__ */ p(function() {
        ...
        for (var p2 = this._currentRules(), t = 0; t < p2.length; t++)
          if (c = this._input.match(this.rules[p2[t]]), c && (!a || c[0].length > a[0].length)) {
            if (a = c, r = t, this.options.backtrack_lexer) {
              if (n = this.test_match(c, p2[t]), n !== false)
                return n;
              if (this._backtrack) {
                a = false;
                continue;
        ...
        return a ? (n = this.test_match(a, p2[r]), n !== false ? n : false) : this._input === "" ? this.EOF : this.parseError("Lexical error on line " + (this.yylineno + 1) + `. Unrecognized text.
` + this.showPosition(), {
          text: "",
          token: null,
          line: this.yylineno
      ...
      performAction: /* @__PURE__ */ p(function(a, c, r, p2) {
        switch (r) {
          case 0:
  ...
  return p(q, "Parser"), q.prototype = ct, ct.Parser = q, new q();
}();
dt.parser = dt;
var Xt = dt, w, qt = (w = class {
  constructor() {
    ...
    }, this.setAccTitle = Jm, this.getAccTitle = ty, this.setAccDescription = ey, this.getAccDescription = ry, this.setDiagramTitle = iy, this.getDiagramTitle = ay, this.getConfig = /* @__PURE__ */ p(() => dt$1().er, "getConfig"), this.clear(), this.addEntity = this.addEntity.bind(this), this.addAttributes = this.addAttributes.bind(this), this.addRelationship = this.addRelationship.bind(this), this.setDirection = this.setDirection.bind(this), this.addCssStyles = this.addCssStyles.bind(this), this.addClass = this.addClass.bind(this), this.setClass = this.setClass.bind(this), this.setAccTitle = this.setAccTitle.bind(this), this.setAccDescription = this.setAccDescription.bind(this);
  }
  /**
   * Add entity
  ...
  addRelationship(i, h, d, o) {
    const l2 = this.entities.get(i), f = this.entities.get(d);
    if (!l2 || !f)
      return;
    const _ = {
      entityA: l2.id,
  ...
  getCompiledStyles(i) {
    ...
    for (const d of i) {
      ...
      o != null && o.styles && (h = [...h, ...o.styles ?? []].map((l2) => l2.trim())), o != null && o.textStyles && (h = [...h, ...o.textStyles ?? []].map((l2) => l2.trim()));
    }
    return h;
  }
  addCssStyles(i, h) {
  ...
  addClass(i, h) {
    i.forEach((d) => {
      ...
      o === void 0 && (o = { id: d, styles: [], textStyles: [] }, this.classes.set(d, o)), h && h.forEach(function(l2) {
        if (/color/.exec(l2)) {
          const f = l2.replace("fill", "bgFill");
          o.textStyles.push(f);
        }
        o.styles.push(l2);
      });
  ...
  clear() {
    this.entities = /* @__PURE__ */ new Map(), this.classes = /* @__PURE__ */ new Map(), this.relationships = [], Qm();
  }
  getData() {
    const i = [], h = [], d = dt$1();
    for (const l2 of this.entities.keys()) {
      const f = this.entities.get(l2);
      f && (f.cssCompiledStyles = this.getCompiledStyles(f.cssClasses.split(" ")), i.push(f));
    }
    let o = 0;
    for (const l2 of this.relationships) {
      const f = {
        id: U_(l2.entityA, l2.entityB, {
          prefix: "id",
          counter: o++
        }),
        type: "normal",
        ...
        arrowTypeStart: l2.relSpec.cardB.toLowerCase(),
        arrowTypeEnd: l2.relSpec.cardA.toLowerCase(),
        pattern: l2.relSpec.relType == "IDENTIFYING" ? "solid" : "dashed",
        look: d.look
      };
      h.push(f);
    }
...
var Ht = /* @__PURE__ */ p(async function(s, i, h, d) {
  D.info("REF0:"), D.info("Drawing er diagram (unified)", i);
  const { securityLevel: o, er: l2, layout: f } = dt$1(), _ = d.db.getData(), E = b(i, o);
  _.type = d.type, _.layoutAlgorithm = J_(f), _.config.flowchart.nodeSpacing = (l2 == null ? void 0 : l2.nodeSpacing) || 140, _.config.flowchart.rankSpacing = (l2 == null ? void 0 : l2.rankSpacing) || 80, _.direction = d.db.getDirection(), _.markers = ["only_one", "zero_or_one", "one_or_more", "zero_or_more"], _.diagramId = i, await Q_(_, E), _.layoutAlgorithm === "elk" && E.select(".edges").lower();
  const V = E.selectAll('[id*="-background"]');
  Array.from(V).length > 0 && V.each(function() {
    const S = Li(this), U = S.attr("id").replace("-background", ""), T = E.select(`#${CSS.escape(U)}`);
    if (!T.empty()) {
  ...
  ge.insertTitle(
    E,
    "erDiagramTitleText",
    (l2 == null ? void 0 : l2.titleTopMargin) ?? 25,
    d.db.getDiagramTitle()
  ), B(E, Z, "erDiagram", (l2 == null ? void 0 : l2.useMaxWidth) ?? true);
}, "draw"), Jt = /* @__PURE__ */ p((s, i) => {
  const h = l, d = h(s, "r"), o = h(s, "g"), l$1 = h(s, "b");
  return xi(d, o, l$1, i);
}, "fade"), $t = /* @__PURE__ */ p((s) => `
  .entityBox {
    fill: ${s.mainBkg};
