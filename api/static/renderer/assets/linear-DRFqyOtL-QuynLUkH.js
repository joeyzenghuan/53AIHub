import { k, $ as $t, d as V, f as Lt, h as dr } from "./helper-7WMIPux3-FiO_G2IV.js";
...
function R(n, t2, e) {
  const r = (t2 - n) / Math.max(0, e), i = Math.floor(Math.log10(r)), f = r / Math.pow(10, i), a = f >= gn ? 10 : f >= yn ? 5 : f >= Mn ? 2 : 1;
  let u, c, o;
...
function C(n, t2) {
  var e = typeof t2, r;
  return t2 == null || e === "boolean" ? $t(t2) : (e === "number" ? k : e === "string" ? (r = V(t2)) ? (t2 = r, Lt) : dr : t2 instanceof V ? Lt : t2 instanceof Date ? An : kn(t2) ? Nn : Array.isArray(t2) ? xn : typeof t2.valueOf != "function" && typeof t2.toString != "function" || isNaN(t2) ? vn : k)(n, t2);
}
function Sn(n, t2) {
...
function Rn(n) {
  ...
  function o(h) {
    h = D(h);
    var l = h.fill, p = h.align, y = h.sign, S = h.symbol, k2 = h.zero, b = h.width, T = h.comma, w = h.precision, G = h.trim, d = h.type;
    d === "n" ? (T = true, d = "g") : H[d] || (w === void 0 && (w = 12), G = true, d = "g"), (k2 || l === "0" && p === "=") && (k2 = true, l = "0", p = "=");
    ...
    function V2(m) {
      ...
      if (d === "c")
        ...
        m = +m;
        var P = m < 0 || 1 / m < 0;
        if (m = isNaN(m) ? c : O(Math.abs(m), w), G && (m = $n(m)), P && +m == 0 && y !== "+" && (P = false), N = (P ? y === "(" ? y : u : y === "-" || y === "(" ? "" : y) + N, g = (d === "s" ? Q[8 + nn / 3] : "") + g + (P && y === "(" ? ")" : ""), an) {
      ...
      switch (T && k2 && (m = t2(M + m, M.length ? b - g.length : 1 / 0), M = ""), p) {
        case "<":
          m = N + m + g + M;
          break;
        case "=":
    ...
    return V2.toString = function() {
      return h + "";
    }, V2;
  }
  function s(h, l) {
    var p = o((h = D(h), h.type = "f", h)), y = Math.max(-8, Math.min(8, Math.floor(v(l) / 3))) * 3, S = Math.pow(10, -y), k2 = Q[8 + y / 3];
    return function(b) {
      return p(S * b) + k2;
    };
  }
...
function Vn() {
  ...
  function s() {
    var l = Math.min(n.length, t2.length);
    return a !== A && (a = Cn(n[0], n[l - 1])), u = l > 2 ? Gn : Bn, c = o = null, h;
  }
  function h(l) {
    return l == null || isNaN(l = +l) ? f : (c || (c = u(n.map(r), t2, e)))(r(a(l)));
  }
  return h.invert = function(l) {
    return a(i((o || (o = u(t2, n.map(r), k)))(l)));
  }, h.domain = function(l) {
    return arguments.length ? (n = Array.from(l, qn), s()) : n.slice();
  }, h.range = function(l) {
    return arguments.length ? (t2 = Array.from(l), s()) : t2.slice();
  }, h.rangeRound = function(l) {
    return t2 = Array.from(l), e = Sn, s();
  }, h.clamp = function(l) {
    return arguments.length ? (a = l ? true : A, s()) : a !== A;
...
function Un(n, t2, e, r) {
  ...
  switch (r = D(r ?? ",f"), r.type) {
    ...
    case "p":
    case "r": {
      r.precision == null && !isNaN(f = In(i, Math.max(Math.abs(n), Math.abs(t2)))) && (r.precision = f - (r.type === "e"));
      break;
    }
    case "f":
    case "%": {
...
function Yn(n) {
  ...
  return n.ticks = function(e) {
    ...
    e == null && (e = 10);
    var r = t2(), i = 0, f = r.length - 1, a = r[i], u = r[f], c, o, s = 10;
