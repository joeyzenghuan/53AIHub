import { _ as p, l as D$1, c as dt, G as GC, ab as J2, ac as pp, ad as Z_, T as Xm, E as Nc, h as rr, q as g0, J as p0, U as Fi, V as G, W as it } from "./mermaid-j5R1o_wi-dCQhMK9F.js";
import "./main-zTjO05wq.js";
import "./helper-7WMIPux3-FiO_G2IV.js";
import "./copy-BS31ARP0-eab1H3tb.js";
var $ = function() {
  var t = /* @__PURE__ */ p(function(E, s, n, a) {
    for (n = n || {}, a = E.length; a--; n[E[a]] = s)
      ;
    return n;
  }, "o"), g = [1, 4], d = [1, 13], r = [1, 12], p$1 = [1, 15], _ = [1, 16], f = [1, 20], h = [1, 19], L = [6, 7, 8], C = [1, 26], w = [1, 24], N = [1, 25], i = [6, 7, 11], U = [1, 31], x = [6, 7, 11, 24], P = [1, 6, 13, 16, 17, 20, 23], M = [1, 35], j = [1, 36], A = [1, 6, 7, 11, 13, 16, 17, 20, 23], H = [1, 38], V = {
    ...
    performAction: /* @__PURE__ */ p(function(s, n, a, o, u, e, B) {
      var l = e.length - 1;
      switch (u) {
        case 6:
        case 7:
    ...
    table: [{ 3: 1, 4: 2, 5: 3, 6: [1, 5], 8: g }, { 1: [3] }, { 1: [2, 1] }, { 4: 6, 6: [1, 7], 7: [1, 8], 8: g }, { 6: d, 7: [1, 10], 9: 9, 12: 11, 13: r, 14: 14, 16: p$1, 17: _, 18: 17, 19: 18, 20: f, 23: h }, t(L, [2, 3]), { 1: [2, 2] }, t(L, [2, 4]), t(L, [2, 5]), { 1: [2, 6], 6: d, 12: 21, 13: r, 14: 14, 16: p$1, 17: _, 18: 17, 19: 18, 20: f, 23: h }, { 6: d, 9: 22, 12: 11, 13: r, 14: 14, 16: p$1, 17: _, 18: 17, 19: 18, 20: f, 23: h }, { 6: C, 7: w, 10: 23, 11: N }, t(i, [2, 24], { 18: 17, 19: 18, 14: 27, 16: [1, 28], 17: [1, 29], 20: f, 23: h }), t(i, [2, 19]), t(i, [2, 21], { 15: 30, 24: U }), t(i, [2, 22]), t(i, [2, 23]), t(x, [2, 25]), t(x, [2, 26]), t(x, [2, 28], { 20: [1, 32] }), { 21: [1, 33] }, { 6: C, 7: w, 10: 34, 11: N }, { 1: [2, 7], 6: d, 12: 21, 13: r, 14: 14, 16: p$1, 17: _, 18: 17, 19: 18, 20: f, 23: h }, t(P, [2, 14], { 7: M, 11: j }), t(A, [2, 8]), t(A, [2, 9]), t(A, [2, 10]), t(i, [2, 16], { 15: 37, 24: U }), t(i, [2, 17]), t(i, [2, 18]), t(i, [2, 20], { 24: H }), t(x, [2, 31]), { 21: [1, 39] }, { 22: [1, 40] }, t(P, [2, 13], { 7: M, 11: j }), t(A, [2, 11]), t(A, [2, 12]), t(i, [2, 15], { 24: H }), t(x, [2, 30]), { 22: [1, 41] }, t(x, [2, 27]), t(x, [2, 29])],
    defaultActions: { 2: [2, 1], 6: [2, 2] },
    parseError: /* @__PURE__ */ p(function(s, n) {
      if (n.recoverable)
        this.trace(s);
      else {
        var a = new Error(s);
...
Expecting ` + K.join(", ") + ", got '" + (this.terminals_[k] || k) + "'" : Z = "Parse error on line " + (z + 1) + ": Unexpected " + (k == re ? "end of input" : "'" + (this.terminals_[k] || k) + "'"), this.parseError(Z, {
        ...
        switch (v[0]) {
          case 1:
            ...
            break;
          case 2:
            if (I = this.productions_[v[1]][1], G2.$ = u[u.length - I], G2._$ = {
              ...
              return Q;
            I && (a = a.slice(0, -1 * I * 2), u = u.slice(0, -1 * I), e = e.slice(0, -1 * I)), a.push(this.productions_[v[1]][0]), u.push(G2.$), e.push(G2._$), oe = B[a[a.length - 2]][a[a.length - 1]], a.push(oe);
            break;
          case 3:
            return true;
        }
    ...
    var E = {
      ...
      setInput: /* @__PURE__ */ p(function(s, n) {
...
` + n + "^";
      ...
      test_match: /* @__PURE__ */ p(function(s, n) {
        var a, o, u;
      ...
      next: /* @__PURE__ */ p(function() {
        ...
        for (var u = this._currentRules(), e = 0; e < u.length; e++)
          if (a = this._input.match(this.rules[u[e]]), a && (!n || a[0].length > n[0].length)) {
            if (n = a, o = e, this.options.backtrack_lexer) {
              if (s = this.test_match(a, u[e]), s !== false)
                return s;
              if (this._backtrack) {
                n = false;
                continue;
        ...
        return n ? (s = this.test_match(n, u[o]), s !== false ? s : false) : this._input === "" ? this.EOF : this.parseError("Lexical error on line " + (this.yylineno + 1) + `. Unrecognized text.
` + this.showPosition(), {
          text: "",
          token: null,
          line: this.yylineno
      ...
      performAction: /* @__PURE__ */ p(function(n, a, o, u) {
        switch (o) {
          case 0:
  ...
  return p(O, "Parser"), O.prototype = V, V.Parser = O, new O();
}();
$.parser = $;
var Ne = $, D = [], ne = [], ee = 0, se = {}, xe = /* @__PURE__ */ p(() => {
  D = [], ne = [], ee = 0, se = {};
}, "clear"), ve = /* @__PURE__ */ p((t) => {
  if (D.length === 0)
    return null;
  const g = D[0].level;
  let d = null;
  ...
  return ne;
}, "getSections"), De = /* @__PURE__ */ p(function() {
  const t = [], g = [], d = he(), r = dt();
  for (const p2 of d) {
    const _ = {
      id: p2.id,
    ...
    g.push(_);
    const f = D.filter((h) => h.parentId === p2.id);
    for (const h of f) {
      const L = {
        id: h.id,
        parentId: p2.id,
  ...
  return { nodes: g, edges: t, other: {}, config: dt() };
}, "getData"), Le = /* @__PURE__ */ p((t, g, d, r, p2) => {
  var C, w;
  const _ = dt();
  let f = ((C = _.mindmap) == null ? void 0 : C.padding) ?? Nc.mindmap.padding;
  switch (r) {
    case y.ROUNDED_RECT:
    case y.RECT:
    case y.HEXAGON:
  ...
  const h = {
    ...
    level: t,
    label: rr(d, _),
    width: ((w = _.mindmap) == null ? void 0 : w.maxNodeWidth) ?? Nc.mindmap.maxNodeWidth,
    padding: f,
    isGroup: false
  };
  if (p2 !== void 0) {
...
` + p2 + `
  ...
  switch (D$1.debug("In get type", t, g), t) {
    case "[":
      return y.RECT;
    case "(":
...
}, "getType"), Ie = /* @__PURE__ */ p((t, g) => {
  se[t] = g;
}, "setElementForId"), Ce = /* @__PURE__ */ p((t) => {
  if (!t)
    return;
  const g = dt(), d = D[D.length - 1];
  t.icon && (d.icon = rr(t.icon, g)), t.class && (d.cssClasses = rr(t.class, g));
}, "decorateNode"), we = /* @__PURE__ */ p((t) => {
  switch (t) {
    case y.DEFAULT:
      return "no-border";
    case y.RECT:
...
}, "type2Str"), Ae = /* @__PURE__ */ p(() => D$1, "getLogger"), Te = /* @__PURE__ */ p((t) => se[t], "getElementById"), Re = {
  clear: xe,
  addNode: Le,
  getSections: he,
  getData: De,
  ...
  getLogger: Ae,
  getElementById: Te
}, Pe = Re, Ve = /* @__PURE__ */ p(async (t, g, d, r) => {
  var M, j, A, H, V;
  D$1.debug(`Rendering kanban diagram
` + t);
  const _ = r.db.getData(), f = dt();
  f.htmlLabels = false;
  const h = GC(g), L = h.append("g");
  ...
  for (const m of w) {
    ...
    const E = await J2(L, m);
    x = Math.max(x, (j = E == null ? void 0 : E.labelBBox) == null ? void 0 : j.height), U.push(E);
  }
  let P = 0;
  for (const m of w) {
    const O = U[P];
    ...
    for (const e of a) {
      ...
      const l = (await pp(C, e, { config: f })).node().getBBox();
      e.y = n + l.height / 2, await Z_(e), n = e.y + l.height / 2 + i / 2;
    }
  ...
  Xm(
    void 0,
    h,
    ((H = f.mindmap) == null ? void 0 : H.padding) ?? Nc.kanban.padding,
    ((V = f.mindmap) == null ? void 0 : V.useMaxWidth) ?? Nc.kanban.useMaxWidth
  );
}, "draw"), Be = {
  draw: Ve
}, Ge = /* @__PURE__ */ p((t) => {
  ...
  for (let r = 0; r < t.THEME_COLOR_LIMIT; r++)
    t["lineColor" + r] = t["lineColor" + r] || t["cScaleInv" + r], Fi(t["lineColor" + r]) ? t["lineColor" + r] = G(t["lineColor" + r], 20) : t["lineColor" + r] = it(t["lineColor" + r], 20);
  const d = /* @__PURE__ */ p((r, p2) => t.darkMode ? it(r, p2) : G(r, p2), "adjuster");
  for (let r = 0; r < t.THEME_COLOR_LIMIT; r++) {
    const p2 = "" + (17 - 3 * r);
    g += `
