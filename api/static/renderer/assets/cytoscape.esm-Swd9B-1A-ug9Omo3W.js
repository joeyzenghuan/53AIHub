...
function Kf(r, e) {
  for (var t = 0; t < e.length; t++) {
    var a = e[t];
    a.enumerable = a.enumerable || false, a.configurable = true, "value" in a && (a.writable = true), Object.defineProperty(r, Kl(a.key), a);
  }
}
function ft(r, e, t) {
...
var Ac = Pc(), Oa = /* @__PURE__ */ Ma(Ac), vi = Je ? Je.performance : null, av = vi && vi.now ? function() {
  ...
  return t;
}, Fo = true, Ic = console.warn != null, Oc = console.trace != null, Xs = Number.MAX_SAFE_INTEGER || 9007199254740991, ov = function() {
  return true;
}, bn = function() {
  return false;
}, Vo = function() {
  ...
  return e = {
    ...
    for (var C = function() {
      ...
      for (var N = B.connectedEdges().filter(function(Z) {
        ...
        X.length !== 0 && !h[Q] && (X = X[0], u.push(X), e.bfs && (h[Q] = true, v.push(X)), f[Q] = K, c[Q] = c[R] + 1);
      }
...
var $c = Uc(), Na = /* @__PURE__ */ Ma($c), Kc = fr({
  ...
  bellmanFord: function(e) {
    var t = this, a = ed(e), n = a.weight, i = a.directed, s = a.root, o = n, l = this, u = this.cy(), v = this.byGroup(), f = v.edges, c = v.nodes, h = c.length, d = new Kr(), y = false, g = [];
    ...
    for (var S = false, P = function(se, oe, ce, ge, de, ye) {
      var we = ge.dist + ye;
      we < de.dist && !ce.same(ge.edge) && (de.dist = we, de.pred = se, de.edge = ce, S = true);
    }, D = 1; D < h; D++) {
      S = false;
      for (var A = 0; A < p; A++) {
    ...
    if (S)
      for (var V = [], G = 0; G < p; G++) {
        ...
        if (Q + X < Z || !i && Z + X < Q)
          if (y || (Le("Graph contains a negative weight cycle for Bellman-Ford"), y = true), e.findNegativeWeightCycles !== false) {
            var re = [];
  ...
  if (c) {
    ...
    if (d = rt(e, t, a, n, y, g, p, m, false), d.length > 0)
      return d;
  }
  if (h) {
    var b = a + v + o, w = n - f + u - o, E = b, C = n + f - u + o;
    if (d = rt(e, t, a, n, b, w, E, C, false), d.length > 0)
      return d;
  }
  if (c) {
    var x = a - v + u - o, k = n + f + o, S = a + v - u + o, P = k;
    if (d = rt(e, t, a, n, x, k, S, P, false), d.length > 0)
      return d;
  }
  if (h) {
    var D = a - v - o, A = n - f + u - o, B = D, R = n + f - u + o;
    if (d = rt(e, t, a, n, D, A, B, R, false), d.length > 0)
      return d;
  }
  var M;
  {
  ...
  for (var h = 0; h < c.length / 4; h++)
    f = rt(e, t, n, i, c[h * 4], c[h * 4 + 1], c[h * 4 + 2], c[h * 4 + 3], false), f.length !== 0 && v.push(f[0], f[1]);
  if (v.length > 2) {
...
var Ld = fr({
  ...
  for (var m = true, b = 0; m && b < i.maxIterations; )
    m = false, f = Fd(v, l, i.expandFactor), v = Vd(f, l, i.inflateFactor), qd(v, f, u, 4) || (m = true), b++;
  var w = _d(v, l, t, n);
  return w = Hd(w), w;
}, Wd = {
  markovClustering: $o,
...
var Yd = fr({
    ...
    for (var c = 0; c < i.k; c++) {
      ...
      if (h.length !== 0) {
        for (var d = i.attributes.length, y = l[c], g = new Array(d), p = new Array(d), m = 0; m < d; m++) {
          ...
          g[m] = p[m] / h.length, Xd(g[m], y[m], i.sensitivityThreshold) || (u = true);
        }
    ...
    for (var d = 0; d < o.length; d++) {
      ...
      if (y.length !== 0) {
        ...
        for (var g = 0; g < y.length; g++)
          u = Zo(y[g], y, i.attributes), u < v[d] && (v[d] = u, o[d] = y[g], f = true);
        s[d] = t.collection(y);
      }
    }
    c++;
  ...
  for (var m = true, b = 0; m && b < n.maxIterations; )
    m = false, eh(s, a, o, u, n), rh(o, l, s, a, n), Zd(o, l, n.sensitivityThreshold) || (m = true), b++;
  return i = th(a, o, n, t), {
    clusters: i,
  ...
  hierholzer: function(e) {
    ...
    var a = gh(e), n = a.root, i = a.directed, s = this, o = false, l, u, v;
    ...
    i ? s.forEach(function(m) {
      ...
      if (m.isNode()) {
        ...
        C == 1 ? l ? o = true : l = b : x == 1 ? u ? o = true : u = b : (x > 1 || C > 1) && (o = true), f[b] = [], m.outgoers().forEach(function(k) {
  ...
  if (typeof a == "function") {
    ...
    try {
      a.call(
        ...
        function(i) {
          n || (n = true, i === t ? e.reject(new TypeError("circular thenable chain")) : Sv(e, i));
        },
        /*  rejectPromise  */
...
var ea = typeof Promise < "u" ? Promise : Ir, Rs = function(e, t, a) {
  ...
  if (s.target = e, s.style = s.style || s.css, s.started = false, s.playing = false, s.hooked = false, s.applying = false, s.progress = 0, s.completes = [], s.frames = [], s.complete && We(s.complete) && s.completes.push(s.complete), i) {
    var o = e.position();
...
var Ne = function() {
  ...
  populate: function(e, t) {
    if (e.currentSubject != null && e.currentSubject !== t)
      return Le("Redefinition of subject in selector `" + e.toString() + "`"), false;
    e.currentSubject = t;
...
var mg = function(e) {
  ...
  for (t.length = 1, a = bg(a); ; ) {
    var i = mg(a);
    if (i.expr == null)
      return Le("The selector `" + e + "`is invalid"), false;
  ...
  for (var u = 0; u < t.length; u++) {
    ...
    if (v.compoundCount > 0 && v.edgeCount > 0)
      return Le("The selector `" + e + "` is invalid because it uses both a compound selector and an edge selector"), false;
    if (v.edgeCount > 1)
      return Le("The selector `" + e + "` is invalid because it uses multiple edge selectors"), false;
  ...
  var n, i = fe(e), s = te(e), o = fe(a), l, u, v = false, f = false, c = false;
...
var Dg = function(e) {
  ...
  }) : fe(e) ? this.parse(e) || (this.invalid = true) : He("A selector must be created from a string; found "));
}, ut = ot.prototype;
...
Lr = Ov = {
  ...
  silentShift: function(e, t) {
    return Pe(e) ? this.shift(e, true) : fe(e) && te(t) && this.shift(e, t, true), this;
  },
...
ct.boundingBox = function(r) {
  var e, t = r === void 0 || r.useCache === void 0 || r.useCache === true, a = Yt(function(v) {
    var f = v._private;
...
var Zg = {
  ...
  eventMatches: function(e, t, a) {
    var n = t.qualifier;
    return n != null ? e !== a.target && Ra(a.target) && n.matches(a.target) : true;
  },
...
qe.unique = function() {
  return new vr(this._private.cy, this, true);
};
...
qe.clone = function() {
  for (var r = this.cy(), e = [], t = 0; t < this.length; t++) {
    var a = this[t], n = a.json(), i = new Mn(r, n, false);
    e.push(i);
  }
  return new vr(r, e);
};
  ...
  for (f = 0; f < o.length; f++) {
    ...
    if (h.isEdge()) {
      for (var m = h, b = ["source", "target"], w = b.length, E = false, C = 0; C < w; C++) {
        var x = b[C], k = y[x];
        te(k) && (k = y[x] = "" + y[x]), k == null || k === "" ? (He("Can not create edge `" + g + "` with unspecified " + x), E = true) : a.hasElementWithId(k) || (He("Can not create edge `" + g + "` with nonexistant " + x + " `" + k + "`"), E = true);
      }
      if (E) {
        c();
        continue;
  ...
  for (var D = 0; D < i.length; D++) {
    ...
    if (M || A._private.parent) {
      ...
      if (I.empty())
        ...
        for (var L = false, O = I; !O.empty(); ) {
          if (A.same(O)) {
            L = true, B.parent = void 0;
            break;
          }
          O = O.parent();
        }
        L || (I[0]._private.children.push(A), A._private.parent = I[0], n.hasCompoundNodes = true);
      }
    }
  }
  if (o.length > 0) {
...
qe.remove = function() {
  ...
  function y(R, M) {
    ...
    it(I, M), M._private.parent = null, d.ids[L] || (d.ids[L] = true, d.push(R));
  }
...
function ml(r, e) {
  ...
  function n(v, f) {
    ...
    for (var p = function(C) {
      ...
      !w.playing && !w.applying || (w.playing && w.applying && (w.applying = false), w.started || up(v, b, r), op(v, b, r, f), w.applying && (w.applying = false), p(w.frames), w.step != null && w.step(r), b.completed() && (h.splice(m, 1), w.hooked = false, w.playing = false, w.started = false, p(w.completes)), y = true);
    }
  ...
  switch (a.mapped) {
    case s.mapData: {
      ...
      if (te(p)) {
        ...
        return Le("Do not use continuous mappers without specifying numeric data (i.e. `" + a.field + ": " + p + "` for `" + r.id() + "` is non-numeric)"), false;
    ...
    case s.fn: {
      ...
      if (a.prevFnValue = N, N == null)
        return Le("Custom function mappers may not return null (i.e. `" + a.name + "` for ele `" + r.id() + "` is null)"), false;
      if (i = this.parse(a.name, N, a.bypass, c), !i)
        return Le("Custom function mappers may not return invalid values for the property type (i.e. `" + a.name + "` for ele `" + r.id() + "` is invalid)"), false;
      i.mapping = qr(a), a = i;
      break;
    }
    case void 0:
  ...
  if (n.length > 0 && i > 0) {
    for (var o = {}, l = false, u = 0; u < n.length; u++) {
      ...
      if (c) {
        ...
        d && (te(d.pfValue) && te(y.pfValue) ? (g = y.pfValue - d.pfValue, p = d.pfValue + m * g) : te(d.value) && te(y.value) ? (g = y.value - d.value, p = d.value + m * g) : Fe(d.value) && Fe(y.value) && (g = d.value[0] !== y.value[0] || d.value[1] !== y.value[1] || d.value[2] !== y.value[2], p = d.strValue), g && (o[v] = y.strValue, this.applyBypass(r, v, p), l = true));
      }
    }
    if (!l)
      return;
    a.transitioning = true, new ea(function(b) {
...
lo.appendFromString = function(r) {
  ...
  for (; ; ) {
    ...
    for (var y = []; ; ) {
      ...
      if (!p) {
        Le("Skipping parsing of block: Invalid formatting of style property and value definitions found in:" + h), d = true;
        break;
      }
      s = p[0];
...
(function() {
  ...
  var l = {
    ...
    triggersBoundsOfParallelEdges: function(q, H, ee) {
      return q === H ? false : ee.pstyle("curve-style").value === "bezier";
    }
  }, {
    name: "visibility",
    type: u.visibility,
...
Wn.parse = function(r, e, t, a) {
  ...
  var i = a === "mapping" || a === true || a === false || a == null ? "dontcare" : a, s = t ? "t" : "f", o = "" + e, l = sv(r, o, s, i), u = n.propCache = n.propCache || [], v;
...
Wn.parseImpl = function(r, e, t, a) {
  ...
  if (u.multiple && a !== "multiple") {
    ...
    if (l ? b = e.split(/\s+/) : Fe(e) ? b = e : b = [e], u.evenMultiple && b.length % 2 !== 0)
      return null;
    for (var w = [], E = [], C = [], x = "", k = false, S = 0; S < b.length; S++) {
...
var hp = {
  ...
  getZoomedViewport: function(e) {
    ...
    if (t.zoomingEnabled || (o = true), te(e) ? s = e : Pe(e) && (s = e.level, e.position != null ? i = Ln(e.position, n, a) : e.renderedPosition != null && (i = e.renderedPosition), i != null && !t.panningEnabled && (o = true)), s = s > t.maxZoom ? t.maxZoom : s, s = s < t.minZoom ? t.minZoom : s, o || !te(s) || s === n || i != null && (!te(i.x) || !te(i.y)))
      return null;
    if (i != null) {
      var l = a, u = n, v = s, f = {
        x: -v / u * (i.x - l.x) + i.x,
  ...
  viewport: function(e) {
    ...
    if (!e)
      return this;
    if (te(e.zoom) || (a = false), Pe(e.pan) || (n = false), !a && !n)
      return this;
    if (a) {
      var l = e.zoom;
...
var Ba = function(e) {
  ...
  v([o.style, o.elements], function(h) {
    ...
    u.styleEnabled && t.style().append(d), c(y, function() {
      t.startAnimationLoop(), u.ready = true, We(o.ready) && t.on("ready", o.ready);
...
he(Tn, {
  ...
  mount: function(e) {
    if (e != null) {
      ...
      return !yn(e) && yn(e[0]) && (e = e[0]), t.stopAnimationLoop(), t.destroyRenderer(), a.container = e, a.styleEnabled = true, t.invalidateSize(), t.initRenderer(he({}, n, n.renderer, {
...
Xv.prototype.run = function() {
  ...
  if (Dr(r.roots))
    ...
    v = e.collection();
    for (var g = function() {
      var oe = y[p], ce = oe.maxDegree(false), ge = oe.filter(function(de) {
        return de.degree(false) === ce;
      });
      v = v.add(ge);
    }, p = 0; p < y.length; p++)
      g();
  ...
  n.bfs({
    ...
    visit: function(oe, ce, ge, de, ye) {
      ...
      we.isChildless() && w(we, ye), b[De] = true;
    }
  });
...
Un.prototype.run = function() {
  ...
  t.stopped = false, (r.animate === true || r.animate === false) && t.emit({
    type: "layoutstart",
    layout: t
  }), r.debug === true ? gs = true : gs = false;
  var a = xp(e, t, r);
  gs && Cp(a), r.randomize && Tp(a);
  var n = Yr(), i = function() {
    Sp(a, e, r), r.fit === true && e.fit(r.padding);
  }, s = function(c) {
  ...
  for (var y = 0; y < n.length; y++) {
    ...
    if (g.isNode()) {
      ...
      if (S.edgeType === "bezier" || S.edgeType === "multibezier" || S.edgeType === "self" || S.edgeType === "compound" || S.edgeType === "segments" || S.edgeType === "haystack") {
        for (var P = k.rstyle.bezierPts || k.rstyle.linePts || k.rstyle.haystackPts, D = true, A = 0; A < P.length; A++)
          if (!yd(c, P[A])) {
            D = false;
            break;
          }
...
pr.findTaxiPoints = function(r, e) {
  ...
  }, B = A(P, k), R = A(D, S), M = false;
  m === u ? p = Math.abs(B) > Math.abs(R) ? n : a : m === l || m === o ? (p = a, M = true) : (m === i || m === s) && (p = n, M = true);
  var I = p === a, L = I ? R : B, O = I ? D : P, V = js(O), G = false;
  !(M && (w || C)) && (m === o && O < 0 || m === l && O > 0 || m === i && O > 0 || m === s && O < 0) && (V *= -1, L = V * Math.abs(L), G = true);
  var N;
  if (w) {
    var F = E < 0 ? 1 + E : E;
    N = F * L;
...
pr.checkForInvalidEdgeWarning = function(r) {
  ...
  e.nodesOverlap || te(e.startX) && te(e.startY) && te(e.endX) && te(e.endY) ? e.loggedErr = false : e.loggedErr || (e.loggedErr = true, Le("Edge `" + r.id() + "` has invalid endpoints and so it is impossible to draw.  Adjust your edge style (e.g. control points) accordingly or use an alternative edge type.  This is expected behaviour when the source node and the target node overlap."));
};
...
Va.findEndpoints = function(r) {
  ...
  d.startX = W[0], d.startY = W[1], d.arrowStartX = _[0], d.arrowStartY = _[1], C && (!te(d.startX) || !te(d.startY) || !te(d.endX) || !te(d.endY) ? d.badLine = true : d.badLine = false);
};
...
`)), s("labelWrapKey", l);
    ...
    var I = r.pstyle("text-max-width").pfValue, L = "", O = "…", V = false;
...
var cf = {}, Bl = 28, Pl = false;
cf.getNodeShape = function(r) {
  var e = this, t = r.pstyle("shape").value;
  if (t === "cutrectangle" && (r.width() < Bl || r.height() < Bl))
    return Pl || (Le("The `cutrectangle` node shape can not be used at small sizes so `rectangle` is used instead"), Pl = true), "rectangle";
  if (r.isParent())
...
aa.load = function() {
  ...
  var S = function() {
    ...
    for (var _ = r.findContainerClientCoords(), W = _[0], U = _[1], $ = _[2], ue = _[3], j = T.touches ? T.touches : [T], ve = false, Ee = 0; Ee < j.length; Ee++) {
      var Se = j[Ee];
    ...
    if (!ve)
      return false;
    for (var pe = r.container, Ce = T.target, me = Ce.parentNode, xe = false; me; ) {
      if (me === pe) {
        xe = true;
        break;
      }
  ...
  r.registerBinding(r.container, "mousedown", function(T) {
    if (P(T) && !(r.hoverData.which === 1 && T.which !== 1)) {
      T.preventDefault(), b(), r.hoverData.capture = true, r.hoverData.which = T.which;
      var _ = r.cy, W = [T.clientX, T.clientY], U = r.projectIntoViewport(W[0], W[1]), $ = r.selection, ue = r.findNearestElements(U[0], U[1], true, false), j = ue[0], ve = r.dragData.possibleDragElements;
      ...
      if (T.which == 3) {
        ...
        j ? (j.activate(), j.emit(Se), r.hoverData.down = j) : _.emit(Se), r.hoverData.downTime = (/* @__PURE__ */ new Date()).getTime(), r.hoverData.cxtDragged = false;
      } else if (T.which == 1) {
        j && j.activate();
        {
        ...
        n(j, ["mousedown", "tapstart", "vmousedown"], T, {
          ...
          x: U[0],
          y: U[1]
        }, r.redrawHint("select", true), r.redraw()) : j.pannable() && ($[4] = 1), Ee();
      }
      $[0] = $[2] = U[0], $[1] = $[3] = U[1];
    }
  }, false);
  ...
  r.registerBinding([e, D], "mousemove", function(T) {
    ...
    if (!(!_ && !P(T))) {
      var W = false, U = r.cy, $ = U.zoom(), ue = [T.clientX, T.clientY], j = r.projectIntoViewport(ue[0], ue[1]), ve = r.hoverData.mdownPos, Ee = r.hoverData.mdownGPos, Se = r.selection, pe = null;
      !r.hoverData.draggingEles && !r.hoverData.dragging && !r.hoverData.selecting && (pe = r.findNearestElement(j[0], j[1], true, false));
      ...
      var Jr = function() {
        ...
        }), Se[4] = 1, r.hoverData.selecting = true, r.redrawHint("select", true), r.redraw();
      };
      if (r.hoverData.which === 3) {
        if (Xe) {
          ...
          me ? me.emit(Wr) : U.emit(Wr), r.hoverData.cxtDragged = true, (!r.hoverData.cxtOver || pe !== r.hoverData.cxtOver) && (r.hoverData.cxtOver && r.hoverData.cxtOver.emit({
            originalEvent: T,
            type: "cxtdragout",
            position: {
              x: j[0],
        ...
        if (W = true, U.panningEnabled() && U.userPanningEnabled()) {
          var Rt;
          ...
          U.panBy(Rt), U.emit("dragpan"), r.hoverData.dragged = true;
        }
        ...
        if (Xe) {
          if (!r.hoverData.dragging && U.boxSelectionEnabled() && (br || !U.panningEnabled() || !U.userPanningEnabled()))
            ...
            gt && (r.hoverData.dragging = true, r.hoverData.justStartedPan = true, Se[4] = 0, r.data.bgActivePosistion = _t(ve), r.redrawHint("select", true), r.redraw());
          }
        ...
        if (me && me.pannable() && me.active() && me.unactivate(), (!me || !me.grabbed()) && pe != Ce && (Ce && n(Ce, ["mouseout", "tapdragout"], T, {
          ...
          if (Xe) {
            if (U.boxSelectionEnabled() && br)
              ...
              wr && r.redrawHint("eles", true), r.dragData.didDrag = true, r.hoverData.draggingEles || y(Oe, {
                inDragLayer: true
              });
              var dr = {
                x: 0,
              ...
              r.hoverData.draggingEles = true, Oe.silentShift(dr).emit("position drag"), r.redrawHint("drag", true), r.redraw();
            }
          } else
            Or();
        W = true;
      ...
      if (Se[2] = j[0], Se[3] = j[1], W)
        return T.stopPropagation && T.stopPropagation(), T.preventDefault && T.preventDefault(), false;
    }
  }, false);
  var A, B, R;
  r.registerBinding(e, "mouseup", function(T) {
    if (!(r.hoverData.which === 1 && T.which !== 1 && r.hoverData.capture)) {
      ...
      if (_) {
        ...
        var W = r.cy, U = r.projectIntoViewport(T.clientX, T.clientY), $ = r.selection, ue = r.findNearestElement(U[0], U[1], true, false), j = r.dragData.possibleDragElements, ve = r.hoverData.down, Ee = i(T);
        if (r.data.bgActivePosistion && (r.redrawHint("select", true), r.redraw()), r.hoverData.tapholdCancelled = true, r.data.bgActivePosistion = void 0, ve && ve.unactivate(), r.hoverData.which === 3) {
          var Se = {
            originalEvent: T,
            type: "cxttapend",
            position: {
          ...
          !r.hoverData.isOverThresholdDrag && (n(ve, ["click", "tap", "vclick"], T, {
            x: U[0],
            y: U[1]
          }), B = false, T.timeStamp - R <= W.multiClickDebounceTime() ? (A && clearTimeout(A), B = true, R = null, n(ve, ["dblclick", "dbltap", "vdblclick"], T, {
            x: U[0],
            y: U[1]
          ...
          }, W.multiClickDebounceTime()), R = T.timeStamp)), ve == null && !r.dragData.didDrag && !r.hoverData.selecting && !r.hoverData.dragged && !i(T) && (W.$(t).unselect(["tapunselect"]), j.length > 0 && r.redrawHint("eles", true), r.dragData.possibleDragElements = j = W.collection()), ue == ve && !r.dragData.didDrag && !r.hoverData.selecting && ue != null && ue._private.selectable && (r.hoverData.dragging || (W.selectionType() === "additive" || Ee ? ue.selected() ? ue.unselect(["tapunselect"]) : ue.select(["tapselect"]) : Ee || (W.$(t).unmerge(ue).unselect(["tapunselect"]), ue.select(["tapselect"]))), r.redrawHint("eles", true)), r.hoverData.selecting) {
            var Ce = W.collection(r.getAllInBox($[0], $[1], $[2], $[3]));
            r.redrawHint("select", true), Ce.length > 0 && r.redrawHint("eles", true), W.emit({
              type: "boxend",
              originalEvent: T,
              position: {
                x: U[0],
          ...
          if (r.hoverData.dragging && (r.hoverData.dragging = false, r.redrawHint("select", true), r.redrawHint("eles", true), r.redraw()), !$[4]) {
        ...
        $[4] = 0, r.hoverData.down = null, r.hoverData.cxtStarted = false, r.hoverData.draggingEles = false, r.hoverData.selecting = false, r.hoverData.isOverThresholdDrag = false, r.dragData.didDrag = false, r.hoverData.dragged = false, r.hoverData.dragDelta = [], r.hoverData.mdownPos = null, r.hoverData.mdownGPos = null, r.hoverData.which = null;
      }
    }
  }, false);
  var M = [], I = 4, L, O = 1e5, V = function(T, _) {
    ...
    if (!r.scrollingPage) {
      ...
      if (j.panningEnabled() && j.userPanningEnabled() && j.zoomingEnabled() && j.userZoomingEnabled()) {
        T.preventDefault(), r.data.wheelZooming = true, clearTimeout(r.data.wheelTimeout), r.data.wheelTimeout = setTimeout(function() {
  ...
  r.registerBinding(r.container, "wheel", N, true), r.registerBinding(e, "scroll", function(T) {
    r.scrollingPage = true, clearTimeout(r.scrollingPageTimeout), r.scrollingPageTimeout = setTimeout(function() {
      r.scrollingPage = false;
    }, 250);
  }, true), r.registerBinding(r.container, "gesturestart", function(T) {
  ...
  }, true), r.registerBinding(r.container, "mouseout", function(T) {
  ...
  }, false), r.registerBinding(r.container, "mouseover", function(T) {
    var _ = r.projectIntoViewport(T.clientX, T.clientY);
    r.cy.emit({
      originalEvent: T,
      type: "mouseover",
    ...
    if (r.hasTouchStarted = true, !!P(T)) {
      ...
      if (T.touches[1]) {
        ...
        if (re < Se && !T.touches[2]) {
          var pe = r.findNearestElement(W[0], W[1], true, true), Ce = r.findNearestElement(W[2], W[3], true, true);
          ...
          }), r.touchData.start && (r.touchData.start._private.grabbed = false), r.touchData.cxt = true, r.touchData.cxtDragged = false, r.data.bgActivePosistion = void 0, r.redraw();
          return;
        }
      }
      if (T.touches[2])
        ...
        if (T.touches[0]) {
          var me = r.findNearestElements(W[0], W[1], true, true), xe = me[0];
          if (xe != null && (xe.activate(), r.touchData.start = xe, r.touchData.starts = me, r.nodeIsGrabbable(xe))) {
            ...
            r.redrawHint("eles", true), r.redrawHint("drag", true), xe.selected() ? (Xe = _.$(function(Qe) {
          ...
          n(xe, ["touchstart", "tapstart", "vmousedown"], T, {
            ...
            r.touchData.singleTouchMoved === false && !r.pinching && !r.touchData.selecting && n(r.touchData.start, ["taphold"], T, {
              x: W[0],
              y: W[1]
            });
          }, r.tapholdDuration);
  ...
  r.registerBinding(e, "touchmove", se = function(T) {
    ...
    if (!(!_ && !P(T))) {
      ...
      if (_ && r.touchData.cxt) {
        ...
        r.data.bgActivePosistion = void 0, r.redrawHint("select", true), r.touchData.start ? r.touchData.start.emit(gt) : U.emit(gt), r.touchData.start && (r.touchData.start._private.grabbed = false), r.touchData.cxtDragged = true;
        var wr = r.findNearestElement($[0], $[1], true, true);
        ...
        }), r.touchData.selecting = true, r.touchData.didSelect = true, W[4] = 1, !W || W.length === 0 || W[0] === void 0 ? (W[0] = ($[0] + $[2] + $[4]) / 3, W[1] = ($[1] + $[3] + $[5]) / 3, W[2] = ($[0] + $[2] + $[4]) / 3 + 1, W[3] = ($[1] + $[3] + $[5]) / 3 + 1) : (W[2] = ($[0] + $[2] + $[4]) / 3, W[3] = ($[1] + $[3] + $[5]) / 3), r.redrawHint("select", true), r.redraw();
      else if (_ && T.touches[1] && !r.touchData.didSelect && U.zoomingEnabled() && U.panningEnabled() && U.userZoomingEnabled() && U.userPanningEnabled()) {
        T.preventDefault(), r.data.bgActivePosistion = void 0, r.redrawHint("select", true);
        var dr = r.dragData.touchDragEles;
        if (dr) {
          r.redrawHint("drag", true);
          for (var xr = 0; xr < dr.length; xr++) {
            var Ha = dr[xr]._private;
            Ha.grabbed = false, Ha.rscratch.inDragLayer = false;
          }
        }
        ...
        if (ne) {
          ...
          if (Nr && Nr.active()) {
            var dr = r.dragData.touchDragEles;
            p(dr), r.redrawHint("drag", true), r.redrawHint("eles", true), Nr.unactivate().emit("freeon"), dr.emit("free"), r.dragData.didDrag && (Nr.emit("dragfreeon"), dr.emit("dragfree"));
          }
          U.viewport({
            zoom: Yn,
            pan: Hf,
            cancelOnFailedZoom: true
          }), U.emit("pinchzoom"), Z = yo, F = ar, K = Ke, X = ur, Q = Qe, r.pinching = true;
        }
        if (T.touches[0]) {
          var ve = r.projectIntoViewport(T.touches[0].clientX, T.touches[0].clientY);
          $[0] = ve[0], $[1] = ve[1];
        ...
        if (!r.hoverData.draggingEles && !r.swipePanning && (wr = r.findNearestElement($[0], $[1], true, true)), _ && Ar != null && T.preventDefault(), _ && Ar != null && r.nodeIsDraggable(Ar))
          if (Se) {
            ...
            r.hoverData.draggingEles = true, dr.silentShift(sa).emit("position drag"), r.redrawHint("drag", true), r.touchData.startPosition[0] == ue[0] && r.touchData.startPosition[1] == ue[1] && r.redrawHint("eles", true), r.redraw();
          } else {
        ...
        if (n(Ar || wr, ["touchmove", "tapdrag", "vmousemove"], T, {
          ...
          for (var xr = 0; xr < $.length; xr++)
            $[xr] && r.touchData.startPosition[xr] && Se && (r.touchData.singleTouchMoved = true);
        if (_ && (Ar == null || Ar.pannable()) && U.panningEnabled() && U.userPanningEnabled()) {
          ...
          Wf && (T.preventDefault(), r.data.bgActivePosistion || (r.data.bgActivePosistion = _t(r.touchData.startPosition)), r.swipePanning ? (U.panBy({
            x: pe[0] * j,
            y: pe[1] * j
          }), U.emit("dragpan")) : Se && (r.swipePanning = true, U.panBy({
            x: me * j,
            y: Oe * j
          }), U.emit("dragpan"), Ar && (Ar.unactivate(), r.redrawHint("select", true), r.touchData.start = null)));
          var ve = r.projectIntoViewport(T.touches[0].clientX, T.touches[0].clientY);
          $[0] = ve[0], $[1] = ve[1];
        }
      }
      for (var Ce = 0; Ce < $.length; Ce++)
        ue[Ce] = $[Ce];
      _ && T.touches.length > 0 && !r.hoverData.draggingEles && !r.swipePanning && r.data.bgActivePosistion != null && (r.data.bgActivePosistion = void 0, r.redrawHint("select", true), r.redraw());
    }
  }, false);
  var oe;
  ...
  if (r.registerBinding(e, "touchend", ce = function(T) {
    ...
    if (W)
      T.touches.length === 0 && (r.touchData.capture = false), T.preventDefault();
    else
      return;
    var U = r.selection;
    ...
    if (!T.touches[2] && $.boxSelectionEnabled() && r.touchData.selecting) {
      ...
      U[0] = void 0, U[1] = void 0, U[2] = void 0, U[3] = void 0, U[4] = 0, r.redrawHint("select", true), $.emit({
        type: "boxend",
        originalEvent: T,
        position: {
          x: j[0],
      ...
      Ce.emit("box").stdFilter(me).select().emit("boxselect"), Ce.nonempty() && r.redrawHint("eles", true), r.redraw();
    }
      ...
      if (!T.touches[0]) {
        if (!T.touches[0]) {
          ...
          if (_ != null) {
            ...
            p(xe), r.redrawHint("drag", true), r.redrawHint("eles", true), Oe && (_.emit("freeon"), xe.emit("free"), r.dragData.didDrag && (_.emit("dragfreeon"), xe.emit("dragfree"))), n(_, ["touchend", "tapend", "vmouseup", "tapdragout"], T, {
              x: j[0],
              y: j[1]
            }), _.unactivate(), r.touchData.start = null;
          } else {
            var Xe = r.findNearestElement(j[0], j[1], true, true);
          ...
          r.touchData.singleTouchMoved || (_ || $.$(":selected").unselect(["tapunselect"]), n(_, ["tap", "vclick"], T, {
            x: j[0],
            y: j[1]
          }), ge = false, T.timeStamp - ye <= $.multiClickDebounceTime() ? (de && clearTimeout(de), ge = true, ye = null, n(_, ["dbltap", "vdblclick"], T, {
            x: j[0],
            y: j[1]
          ...
          }, $.multiClickDebounceTime()), ye = T.timeStamp)), _ != null && !r.dragData.didDrag && _._private.selectable && br < r.touchTapThreshold2 && !r.pinching && ($.selectionType() === "single" ? ($.$(t).unmerge(_).unselect(["tapunselect"]), _.select(["tapselect"])) : _.selected() ? _.unselect(["tapunselect"]) : _.select(["tapselect"]), r.redrawHint("eles", true)), r.touchData.singleTouchMoved = true;
        }
      }
    }
    for (var Or = 0; Or < j.length; Or++)
      ve[Or] = j[Or];
    r.dragData.didDrag = false, T.touches.length === 0 && (r.touchData.dragDelta = [], r.touchData.startPosition = [null, null, null, null, null, null], r.touchData.startGPosition = null, r.touchData.didSelect = false), T.touches.length < 2 && (T.touches.length === 1 && (r.touchData.startGPosition = [T.touches[0].clientX, T.touches[0].clientY]), r.pinching = false, r.redrawHint("eles", true), r.redraw());
...
Zr.generateBottomRoundrectangle = function() {
  return this.nodeShapes["bottom-round-rectangle"] = this.nodeShapes.bottomroundrectangle = {
    ...
    intersectLine: function(e, t, a, n, i, s, o, l) {
      var u = e - (a / 2 + o), v = t - (n / 2 + o), f = v, c = e + (a / 2 + o), h = rt(i, s, e, t, u, v, c, f, false);
...
tr.recycleTexture = function(r, e) {
  for (var t = this, a = t.getTextureQueue(r), n = t.getRetiredTextureQueue(r), i = 0; i < n.length; i++) {
    var s = n[i];
    if (s.width >= e)
      return s.retired = false, s.usedWidth = 0, s.invalidatedWidth = 0, s.fullnessChecks = 0, Qs(s.eleCaches), s.context.setTransform(1, 0, 0, 1, 0, 0), s.context.clearRect(0, 0, s.width, s.height), it(n, s), a.push(s), s;
  }
};
...
var oy = 1, ma = -4, kn = 2, uy = 3.99, ly = 50, vy = 50, fy = 0.15, cy = 0.1, dy = 0.9, hy = 0.9, gy = 1, Ml = 250, py = 4e3 * 4e3, Ll = 32767, yy = true, mf = function(e) {
  var t = this, a = t.renderer = e, n = a.cy;
  t.layersByLevel = {}, t.firstGet = true, t.lastInvalidationTime = Yr() - 2 * Ml, t.skipping = false, t.eleTxrDeqs = n.collection(), t.scheduleElementRefinement = Oa(function() {
    t.refineElementTextures(t.eleTxrDeqs), t.eleTxrDeqs.unmerge(t.eleTxrDeqs);
  }, vy), a.beforeRender(function(s, o) {
    o - t.lastInvalidationTime <= Ml ? t.skipping = true : t.skipping = false;
...
cr.drawEleInLayer = function(r, e, t, a) {
  ...
  o.w === 0 || o.h === 0 || !e.visible() || (t = n.getEleLevelForLayerLevel(t, a), i.setImgSmoothing(s, false), i.drawCachedElement(s, e, null, null, t, yy), i.setImgSmoothing(s, true));
};
...
cr.haveLayers = function() {
  for (var r = this, e = false, t = ma; t <= kn; t++) {
...
cr.invalidateLayer = function(r) {
  if (this.lastInvalidationTime = Yr(), !r.invalid) {
    ...
    it(a, r), r.elesQueue = [], r.invalid = true, r.replacement && (r.replacement.invalid = true);
  ...
  if (!(u.w === 0 || u.h === 0)) {
    ...
    if (v != null) {
      ...
      if (c !== 0) {
        ...
        p = h, m = d;
      var k;
      f !== 1 && (k = r.globalAlpha, r.globalAlpha = k * f), r.drawImage(v.texture.canvas, v.x, 0, v.width, v.height, p, m, y, g), f !== 1 && (r.globalAlpha = k), c !== 0 && (r.rotate(-c), r.translate(-b, -w), E || l.setImgSmoothing(r, false));
    } else
      t.drawElement(r, e);
  }
};
...
go.drawInscribedImage = function(r, e, t, a, n) {
  ...
  if (v(t, "background-width", "value", a) !== "auto" && (v(t, "background-width", "units", a) === "%" ? P = v(t, "background-width", "pfValue", a) * g : P = v(t, "background-width", "pfValue", a)), v(t, "background-height", "value", a) !== "auto" && (v(t, "background-height", "units", a) === "%" ? D = v(t, "background-height", "pfValue", a) * p : D = v(t, "background-height", "pfValue", a)), !(P === 0 || D === 0)) {
    ...
    var K = r.globalAlpha;
    r.globalAlpha = E;
    var X = i.getImgSmoothing(r), Q = false;
    if (C === "no" && X ? (i.setImgSmoothing(r, false), Q = true) : C === "yes" && !X && (i.setImgSmoothing(r, true), Q = true), c === "no-repeat")
...
dt.drawNode = function(r, e, t) {
  ...
  if (!(!te(f.x) || !te(f.y)) && !(i && !e.visible())) {
    ...
    var ae = function() {
      ...
      var W = s.nodePathCache = s.nodePathCache || [], U = sv(T === "polygon" ? T + "," + _.join(",") : T, "" + Y, "" + le, "" + re), $ = W[U], ue, j = false;
      return $ != null ? (ue = $, j = true, v.pathCache = ue) : (ue = new Path2D(), W[U] = v.pathCache = ue), {
        path: ue,
        cacheHit: j
      };
    ...
    var be = function() {
      ...
      for (var le = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : c, Y = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : true, T = u.backgrounding, _ = 0, W = 0; W < E.length; W++) {
      ...
      u.backgrounding = _ !== C, T !== u.backgrounding && e.updateStyle(false);
    }, Ie = function() {
      var le = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : false, Y = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : c;
    ...
    if (De) {
      ...
      r.translate(ze, Ue), z(), ge(), ae(Ae * B), be(), _e(Ye, true), J(Ae * N), ce(), Ie(D !== 0 || A !== 0), se(D !== 0 || A !== 0), _e(Ye, false), oe(Ye), r.translate(-ze, -Ue);
    }
    h && r.translate(-f.x, -f.y), ye(), h && r.translate(f.x, f.y), z(), ge(), ae(), be(), _e(c, true), J(), ce(), Ie(D !== 0 || A !== 0), se(D !== 0 || A !== 0), _e(c, false), oe(), h && r.translate(-f.x, -f.y), we(), de(), t && r.translate(p.x1, p.y1);
  }
};
var xf = function(e) {
  if (!["overlay", "underlay"].includes(e))
...
mr.render = function(r) {
  ...
  if (N[e.NODE] = !v[e.NODE] && c && !e.clearedForMotionBlur[e.NODE] || e.clearingMotionBlur, N[e.NODE] && (e.clearedForMotionBlur[e.NODE] = true), N[e.DRAG] = !v[e.DRAG] && c && !e.clearedForMotionBlur[e.DRAG] || e.clearingMotionBlur, N[e.DRAG] && (e.clearedForMotionBlur[e.DRAG] = true), v[e.NODE] || n || i || N[e.NODE]) {
    ...
    A(R, K), G ? e.drawCachedNodes(R, P.nondrag, l, O) : e.drawLayeredElements(R, P.nondrag, l, O), e.debug && e.drawDebugPoints(R, P.nondrag), !n && !c && (v[e.NODE] = false);
  }
  if (!i && (v[e.DRAG] || n || N[e.DRAG])) {
    var F = c && !N[e.DRAG] && h !== 1, R = a || (F ? e.data.bufferContexts[e.MOTIONBLUR_BUFFER_DRAG] : u.contexts[e.DRAG]);
    A(R, c && !F ? "motionBlur" : void 0), G ? e.drawCachedNodes(R, P.drag, l, O) : e.drawCachedElements(R, P.drag, l, O), e.debug && e.drawDebugPoints(R, P.drag), !n && !c && (v[e.DRAG] = false);
  }
  if (this.drawSelectionRectangle(r, A), c && h !== 1) {
    ...
    (v[e.NODE] || N[e.NODE]) && (ae(X, Q, N[e.NODE]), v[e.NODE] = false), (v[e.DRAG] || N[e.DRAG]) && (ae(Z, re, N[e.DRAG]), v[e.DRAG] = false);
  }
...
var Hy = /* @__PURE__ */ function() {
  function r(e, t, a, n) {
    vt(this, r), this.debugID = Math.floor(Math.random() * 1e4), this.r = e, this.texSize = t, this.texRows = a, this.texHeight = Math.floor(t / a), this.enableWrapping = true, this.locked = false, this.texture = null, this.needsBuffer = true, this.freePointer = {
      x: 0,
      row: 0
  ...
  return ft(r, [{
    ...
    key: "bufferIfNeeded",
    value: function(t) {
      this.texture || (this.texture = Ny(t, this.debugID)), this.needsBuffer && (this.texture.buffer(this.canvas), this.needsBuffer = false, this.locked && (this.canvas = null, this.scratch = null));
    }
  }, {
    key: "dispose",
    value: function() {
              ...
              var m = function() {
                ...
                if (v(E)) {
                  ...
                  if (s)
                    ...
                    D !== void 0 && !Iy(k, D) && (f = true, a.typeAndIdToKey.delete(P), D.forEach(function(A) {
                      return C.markKeyForGC(A);
                    }));
                  }
                }
    ...
    */
    ...
    value: function() {
      ...
      if (i !== 0) {
        ...
        t.uniform1f(s.uZoom, Ry(this.r)), t.uniformMatrix3fv(s.uPanZoomMatrix, false, this.panZoomMatrix), t.uniform1i(s.uAtlasSize, this.batchManager.getAtlasSize());
...
function om(r, e, t, a, n) {
  ...
  p.bindFramebuffer(p.FRAMEBUFFER, r.pickingFrameBuffer), r.pickingFrameBuffer.needsDraw && (p.viewport(0, 0, p.canvas.width, p.canvas.height), kf(r, null, ba.PICKING), r.pickingFrameBuffer.needsDraw = false);
  ...
  if (t.screen && r.data.canvasNeedsRedraw[r.SELECT_BOX] && nm(r, e), r.data.canvasNeedsRedraw[r.NODE] || t.picking) {
    ...
    if (i = l.length, n.startFrame(o, t), t.screen) {
      ...
      for (var f = 0; f < l.length; f++)
        Ts(r, f, l[f]);
    n.endFrame(), t.screen && r.webglDebugShowAtlases && (im(r), sm(r)), r.data.canvasNeedsRedraw[r.NODE] = false, r.data.canvasNeedsRedraw[r.DRAG] = false;
  }
  if (r.webglDebug) {
...
function Rf(r) {
  ...
  for (var u = 0; u < Te.CANVAS_LAYERS; u++) {
    ...
    e.data.contexts[u] = v.getContext(f), e.data.contexts[u] || He("Could not create canvas of type " + f), Object.keys(l).forEach(function(J) {
      v.style[J] = l[J];
    }), v.style.position = "absolute", v.setAttribute("data-id", "layer" + u), v.style.zIndex = String(Te.CANVAS_LAYERS - u), e.data.canvasContainer.appendChild(v), e.data.canvasNeedsRedraw[u] = false;
  }
  ...
  var c = Sr(), h = function(z) {
    ...
    return e.drawElement(z, q, H, false, false, ne);
