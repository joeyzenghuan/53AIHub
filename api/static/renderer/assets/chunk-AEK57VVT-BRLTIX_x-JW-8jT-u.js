import { b as b$1, B as B$1 } from "./chunk-RZ5BOZE2-mpnkmZCx-SD7v2Mwj.js";
import { _ as p, l as D, R as $1, c as dt$1, j as Hr, x as Qm, r as Q_, u as ge, a as ty, b as Jm, g as ry, s as ey, o as iy, p as ay } from "./mermaid-j5R1o_wi-dCQhMK9F.js";
var re = Object.defineProperty;
var ae = (e, t, s) => t in e ? re(e, t, { enumerable: true, configurable: true, writable: true, value: s }) : e[t] = s;
...
var bt = function() {
  var e = /* @__PURE__ */ p(function(P, l, h, a) {
    ...
    parse: /* @__PURE__ */ p(function(l) {
      var h = this, a = [0], T = [], _ = [null], i = [], K = this.table, u = "", V = 0, z = 0, ot = 2, J = 1, yt = i.slice.call(arguments, 1), D2 = Object.create(this.lexer), M = { yy: {} };
      for (var gt in this.yy)
        Object.prototype.hasOwnProperty.call(this.yy, gt) && (M.yy[gt] = this.yy[gt]);
      D2.setInput(l, M.yy), M.yy.lexer = D2, M.yy.parser = this, typeof D2.yylloc > "u" && (D2.yylloc = {});
      var Tt = D2.yylloc;
      i.push(Tt);
      var se = D2.options && D2.options.ranges;
      ...
      function Lt() {
        var C;
        return C = T.pop() || D2.lex() || J, typeof C != "number" && (C instanceof Array && (T = C, C = T.pop()), C = h.symbols_[C] || C), C;
      }
      p(Lt, "lex");
      for (var k, U, x, _t, W = {}, ct, N, It, ht; ; ) {
        if (U = a[a.length - 1], this.defaultActions[U] ? x = this.defaultActions[U] : ((k === null || typeof k > "u") && (k = Lt()), x = K[U] && K[U][k]), typeof x > "u" || !x.length || !x[0]) {
          ...
          D2.showPosition ? Et = "Parse error on line " + (V + 1) + `:
` + D2.showPosition() + `
Expecting ` + ht.join(", ") + ", got '" + (this.terminals_[k] || k) + "'" : Et = "Parse error on line " + (V + 1) + ": Unexpected " + (k == J ? "end of input" : "'" + (this.terminals_[k] || k) + "'"), this.parseError(Et, {
        ...
        switch (x[0]) {
          case 1:
            a.push(k), _.push(D2.yytext), i.push(D2.yylloc), a.push(x[1]), k = null, z = D2.yyleng, u = D2.yytext, V = D2.yylineno, Tt = D2.yylloc;
            break;
          case 2:
...
` + h + "^";
      ...
      next: /* @__PURE__ */ p(function() {
        ...
        for (var _ = this._currentRules(), i = 0; i < _.length; i++)
          if (a = this._input.match(this.rules[_[i]]), a && (!h || a[0].length > h[0].length)) {
            if (h = a, T = i, this.options.backtrack_lexer) {
              if (l = this.test_match(a, _[i]), l !== false)
                return l;
              if (this._backtrack) {
                h = false;
                continue;
        ...
        return h ? (l = this.test_match(h, _[T]), l !== false ? l : false) : this._input === "" ? this.EOF : this.parseError("Lexical error on line " + (this.yylineno + 1) + `. Unrecognized text.
` + this.showPosition(), {
          text: "",
          token: null,
          line: this.yylineno
...
var Xe = bt, Te = "TB", Mt = "TB", Rt = "dir", dt = "state", vt = "relation", _e = "classDef", Ee = "style", me = "applyClass", Z = "default", Ut = "divider", jt = "fill:none", Ht = "fill: #333", zt = "c", Wt = "text", Xt = "normal", mt = "rect", Dt = "rectWithTitle", De = "stateStart", be = "stateEnd", Ot = "divider", Nt = "roundedWithTitle", ve = "note", ke = "noteGroup", tt = "statediagram", Ce = "state", xe = `${tt}-${Ce}`, Kt = "transition", Ae = "note", Le = "note-edge", Ie = `${Kt} ${Le}`, Re = `${tt}-${Ae}`, Oe = "cluster", Ne = `${tt}-${Oe}`, we = "cluster-alt", $e = `${tt}-${we}`, Jt = "parent", qt = "note", Pe = "state", xt = "----", Be = `${xt}${qt}`, wt = `${xt}${Jt}`, Qt = /* @__PURE__ */ p((e, t = Mt) => {
  ...
  const { securityLevel: o, state: c, layout: r } = dt$1();
  n.db.extract(n.db.getRootDocV2());
  const d = n.db.getData(), f = b$1(t, o);
  d.type = n.type, d.layoutAlgorithm = r, d.nodeSpacing = (c == null ? void 0 : c.nodeSpacing) || 50, d.rankSpacing = (c == null ? void 0 : c.rankSpacing) || 50, d.markers = ["barb"], d.diagramId = t, await Q_(d, f);
  const g = 8;
  ge.insertTitle(
    f,
  ...
  ), B$1(f, g, tt, (c == null ? void 0 : c.useMaxWidth) ?? true);
}, "draw"), Ke = {
  getClasses: Ge,
  draw: Ye,
  getDir: Qt
      ...
      case vt:
        {
          ...
          const g = {
            ...
            style: jt,
            labelStyle: "",
            label: Hr.sanitizeText(f.description, dt$1()),
            arrowheadStyle: Ht,
            labelpos: zt,
            labelType: Wt,
            thickness: Xt,
...
var Q = /* @__PURE__ */ p((e, t, s, n, o, c, r, d) => {
  ...
  if (D.info("dataFetcher parsedItem", t, g, m), f !== "root") {
    let R = mt;
    t.start === true ? R = De : t.start === false && (R = be), t.type !== Z && (R = t.type), ft.get(f) || ft.set(f, {
      id: f,
      shape: R,
      description: Hr.sanitizeText(f, dt$1()),
      cssClasses: `${E} ${xe}`,
      cssStyles: m
    });
    const S = ft.get(f);
    t.description && (Array.isArray(S.description) ? (S.shape = Dt, S.description.push(t.description)) : ((I = S.description) == null ? void 0 : I.length) > 0 ? (S.shape = Dt, S.description === f ? S.description = [t.description] : S.description = [S.description, t.description]) : (S.shape = mt, S.description = t.description), S.description = Hr.sanitizeTextOrArray(S.description, dt$1())), ((G = S.description) == null ? void 0 : G.length) === 1 && S.shape === Dt && (S.type === "group" ? S.shape = Nt : S.shape = mt), !S.type && t.doc && (D.info("Setting cluster for XCX", f, $t(t)), S.type = "group", S.isGroup = true, S.dir = $t(t), S.shape = t.type === Ut ? Ot : Nt, S.cssClasses = `${S.cssClasses} ${Ne} ${c ? $e : ""}`);
    const L = {
      labelStyle: "",
      shape: S.shape,
      label: S.description,
    ...
    if (L.shape === Ot && (L.label = ""), e && e.id !== "root" && (D.trace("Setting node ", f, " to be child of its parent ", e.id), L.parentId = e.id), L.centerLabel = true, t.note) {
      const O = {
        labelStyle: "",
        shape: ve,
        label: t.note.text,
        ...
        type: S.type,
        isGroup: S.type === "group",
        padding: dt$1().flowchart.padding,
        look: r,
  ...
  t.doc && (D.trace("Adding nodes children "), Fe(t, t.doc, s, n, o, !c, r, d));
...
var Vt = /* @__PURE__ */ p(() => ({
  ...
  constructor(t) {
    ...
    b(this, "dividerCnt", 0);
    b(this, "getAccTitle", ty);
    b(this, "setAccTitle", Jm);
    b(this, "getAccDescription", ry);
    b(this, "setAccDescription", ey);
    b(this, "setDiagramTitle", iy);
    b(this, "getDiagramTitle", ay);
  ...
  extract(t) {
    let s;
    t.doc ? s = t.doc : s = t, D.info(s), this.clear(true), D.info("Extract initial document:", s), s.forEach((r) => {
      switch (D.warn("Statement", r.stmt), r.stmt) {
        case dt:
          this.addState(
            r.id.trim(),
            r.type,
    ...
    const n = this.getStates(), c = dt$1().look;
    Ve(), Q(
      void 0,
      this.getRootDocV2(),
      n,
  ...
  addState(t, s = Z, n = null, o = null, c = null, r = null, d = null, f = null) {
    ...
    if (this.currentDocument.states.has(g) ? (this.currentDocument.states.get(g).doc || (this.currentDocument.states.get(g).doc = n), this.currentDocument.states.get(g).type || (this.currentDocument.states.get(g).type = s)) : (D.info("Adding state ", g, o), this.currentDocument.states.set(g, {
      id: g,
      descriptions: [],
      type: s,
      doc: n,
      ...
      styles: [],
      textStyles: []
    })), o && (D.info("Setting state description", g, o), typeof o == "string" && this.addDescription(g, o.trim()), typeof o == "object" && o.forEach((E) => this.addDescription(g, E.trim()))), c) {
      const E = this.currentDocument.states.get(g);
      E.note = c, E.note.text = Hr.sanitizeText(E.note.text, dt$1());
    }
    r && (D.info("Setting state classes", g, r), (typeof r == "string" ? [r] : r).forEach((m) => this.setCssClass(g, m.trim()))), d && (D.info("Setting state styles", g, d), (typeof d == "string" ? [d] : d).forEach((m) => this.setStyle(g, m.trim()))), f && (D.info("Setting state styles", g, d), (typeof f == "string" ? [f] : f).forEach((m) => this.setTextStyle(g, m.trim())));
  }
  clear(t) {
    this.nodes = [], this.edges = [], this.documents = {
      root: Vt()
    }, this.currentDocument = this.documents.root, this.startEndCount = 0, this.classes = Ct(), t || Qm();
  }
  getState(t) {
  ...
  addRelationObjs(t, s, n) {
    ...
    this.addState(
      ...
      id1: o,
      id2: r,
      relationTitle: Hr.sanitizeText(n, dt$1())
    });
  }
  /**
