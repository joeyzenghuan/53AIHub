import { y as defineComponent, r as ref, o as onMounted, a as onUnmounted, Y as watch, b as openBlock, c as createElementBlock, Z as renderSlot, H as Fragment, I as renderList, p as defineStore } from "./main-zTjO05wq.js";
/**!
 * Sortable 1.15.6
  ...
  setup(__props, { emit: __emit }) {
    ...
    onMounted(() => {
      ...
      _sortable = Sortable.create(sortableEl, {
        onStart: ({ target, oldIndex: oldIndex2 }) => target.children[oldIndex2].style.background = props.dragBg,
...
const useBrowserSettingStore = defineStore("browser-setting", {
  state: () => ({
