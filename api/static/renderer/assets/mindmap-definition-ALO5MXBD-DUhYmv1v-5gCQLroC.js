import { _ as p, l as D, ag as He, M as sn, c as dt, G as GC, T as Xm, E as Nc, h as rr, U as Fi, V as G, W as it } from "./mermaid-j5R1o_wi-dCQhMK9F.js";
import { J as Jt$1 } from "./cytoscape.esm-Swd9B-1A-ug9Omo3W.js";
      ...
      return (
        ...
        function(f) {
          ...
          function y(r) {
            ...
            return f[r].call(t.exports, t, t.exports, y), t.l = true, t.exports;
          }
          ...
          function(f, m, y) {
            ...
            function i(g, a, v) {
              r.call(this, v), this.isOverlapingSourceAndTarget = false, this.vGraphObject = v, this.bendpoints = [], this.source = g, this.target = a;
            }
            ...
            a.prototype.getEdges = function() {
              ...
              if (n.add(this), this.child != null)
                for (var E = this.child.getNodes(), T = 0; T < E.length; T++)
                  c = E[T], l = c.withChildren(), l.forEach(function(D2) {
                    n.add(D2);
                  });
              return n;
              ...
              var T = -i.INITIAL_WORLD_BOUNDARY, D2 = i.INITIAL_WORLD_BOUNDARY;
              c = i.WORLD_CENTER_Y + o.nextDouble() * (D2 - T) + T, this.rect.x = n, this.rect.y = c;
          ...
          function(f, m, y) {
            ...
            function c(E, T, D2) {
              r.call(this, D2), this.estimatedSize = t.MIN_VALUE, this.margin = e.DEFAULT_GRAPH_MARGIN, this.edges = [], this.nodes = [], this.isConnected = false, this.parent = E, T != null && T instanceof i ? this.graphManager = T : T != null && T instanceof Layout && (this.graphManager = T.graphManager);
            }
            ...
            c.prototype.getNodes = function() {
            ...
            }, c.prototype.add = function(E, T, D2) {
              if (T == null && D2 == null) {
                var L = E;
                ...
                var O = E;
                if (!(this.getNodes().indexOf(T) > -1 && this.getNodes().indexOf(D2) > -1))
                  throw "Source or target not in graph!";
                if (!(T.owner == D2.owner && T.owner == this))
                  throw "Both owners must be this graph!";
                return T.owner != D2.owner ? null : (O.source = T, O.target = D2, O.isInterGraph = false, this.getEdges().push(O), T.edges.push(O), D2 != T && D2.edges.push(O), O);
              }
              ...
              if (E instanceof o) {
                ...
                for (var D2 = T.edges.slice(), L, O = D2.length, d = 0; d < O; d++)
                  L = D2[d], L.isInterGraph ? this.graphManager.remove(L) : L.source.owner.remove(L);
              ...
              for (var E = t.MAX_VALUE, T = t.MAX_VALUE, D2, L, O, d = this.getNodes(), N = d.length, s = 0; s < N; s++) {
                var h = d[s];
                D2 = h.getTop(), L = h.getLeft(), E > D2 && (E = D2), T > L && (T = L);
              }
              ...
              for (var T = t.MAX_VALUE, D2 = -t.MAX_VALUE, L = t.MAX_VALUE, O = -t.MAX_VALUE, d, N, s, h, u, p2 = this.nodes, A = p2.length, C = 0; C < A; C++) {
                var R = p2[C];
                E && R.child != null && R.updateBounds(), d = R.getLeft(), N = R.getRight(), s = R.getTop(), h = R.getBottom(), T > d && (T = d), D2 < N && (D2 = N), L > s && (L = s), O < h && (O = h);
              }
              var x = new a(T, L, D2 - T, O - L);
              T == t.MAX_VALUE && (this.left = this.parent.getLeft(), this.right = this.parent.getRight(), this.top = this.parent.getTop(), this.bottom = this.parent.getBottom()), p2[0].getParent().paddingLeft != null ? u = p2[0].getParent().paddingLeft : u = this.margin, this.left = x.x - u, this.right = x.x + x.width + u, this.top = x.y - u, this.bottom = x.y + x.height + u;
            }, c.calculateBounds = function(E) {
              for (var T = t.MAX_VALUE, D2 = -t.MAX_VALUE, L = t.MAX_VALUE, O = -t.MAX_VALUE, d, N, s, h, u = E.length, p2 = 0; p2 < u; p2++) {
                var A = E[p2];
                d = A.getLeft(), N = A.getRight(), s = A.getTop(), h = A.getBottom(), T > d && (T = d), D2 < N && (D2 = N), L > s && (L = s), O < h && (O = h);
              }
              var C = new a(T, L, D2 - T, O - L);
              return C;
              ...
              for (var E = 0, T = this.nodes, D2 = T.length, L = 0; L < D2; L++) {
                var O = T[L];
              ...
              var T = new n(), D2 = /* @__PURE__ */ new Set(), L = this.nodes[0], O, d, N = L.withChildren();
              for (N.forEach(function(C) {
                ...
                for (var s = O.length, h = 0; h < s; h++) {
                  var u = O[h];
                  if (d = u.getOtherEndInGraph(L, this), d != null && !D2.has(d)) {
                    var p2 = d.withChildren();
                    p2.forEach(function(C) {
                      T.push(C), D2.add(C);
                    });
                  }
                }
              }
              if (this.isConnected = false, D2.size >= this.nodes.length) {
                var A = 0;
          ...
          function(f, m, y) {
            ...
            e.prototype.addRoot = function() {
              ...
              if (g == null && a == null && v == null) {
                ...
                if (n == c)
                  return g.isInterGraph = false, n.add(g, a, v);
                if (g.isInterGraph = true, g.source = a, g.target = v, this.edges.indexOf(g) > -1)
          ...
          function(f, m, y) {
            ...
            t.calcSeparationAmount = function(e, i, o, g) {
              ...
              if (e.intersects(i))
                return o[0] = g, o[1] = a, o[2] = v, o[3] = n, true;
              var c = e.getX(), l = e.getY(), E = e.getRight(), T = e.getX(), D2 = e.getBottom(), L = e.getRight(), O = e.getWidthHalf(), d = e.getHeightHalf(), N = i.getX(), s = i.getY(), h = i.getRight(), u = i.getX(), p2 = i.getBottom(), A = i.getRight(), C = i.getWidthHalf(), R = i.getHeightHalf(), x = false, _ = false;
              if (g === v) {
                if (a > n)
                  return o[0] = g, o[1] = l, o[2] = v, o[3] = p2, false;
                if (a < n)
                  return o[0] = g, o[1] = D2, o[2] = v, o[3] = s, false;
              } else if (a === n) {
                if (g > v)
                ...
                var U = e.height / e.width, X = i.height / i.width, M = (n - a) / (v - g), G2 = void 0, F = void 0, b = void 0, Y = void 0, k = void 0, H = void 0;
                if (-U === M ? g > v ? (o[0] = T, o[1] = D2, x = true) : (o[0] = E, o[1] = l, x = true) : U === M && (g > v ? (o[0] = c, o[1] = l, x = true) : (o[0] = L, o[1] = D2, x = true)), -X === M ? v > g ? (o[2] = u, o[3] = p2, _ = true) : (o[2] = h, o[3] = s, _ = true) : X === M && (v > g ? (o[2] = N, o[3] = s, _ = true) : (o[2] = A, o[3] = p2, _ = true)), x && _)
                  return false;
                if (g > v ? a > n ? (G2 = this.getCardinalDirection(U, M, 4), F = this.getCardinalDirection(X, M, 2)) : (G2 = this.getCardinalDirection(-U, M, 3), F = this.getCardinalDirection(-X, M, 1)) : a > n ? (G2 = this.getCardinalDirection(-U, M, 1), F = this.getCardinalDirection(-X, M, 3)) : (G2 = this.getCardinalDirection(U, M, 2), F = this.getCardinalDirection(X, M, 4)), !x)
                  switch (G2) {
                    case 1:
              ...
              var a = e.x, v = e.y, n = i.x, c = i.y, l = o.x, E = o.y, T = g.x, D2 = g.y, L = void 0, O = void 0, d = void 0, N = void 0, s = void 0, h = void 0, u = void 0, p2 = void 0, A = void 0;
              return d = c - v, s = a - n, u = n * v - a * c, N = D2 - E, h = l - T, p2 = T * E - l * D2, A = d * h - N * s, A === 0 ? null : (L = (s * p2 - h * u) / A, O = (N * u - d * p2) / A, new r(L, O));
              ...
              var a = e.x, v = e.y, n = i.x, c = i.y, l = o.x, E = o.y, T = g.x, D2 = g.y, L = (n - a) * (D2 - E) - (T - l) * (c - v);
              if (L === 0)
                return false;
              var O = ((D2 - E) * (T - a) + (l - T) * (D2 - v)) / L, d = ((v - c) * (T - a) + (n - a) * (D2 - v)) / L;
          ...
          function(f, m, y) {
            ...
            c.RANDOM_SEED = 1, c.prototype = Object.create(n.prototype), c.prototype.getGraphManager = function() {
              ...
              if (l == null)
                ...
                var E = l;
                if (E.getChild() != null)
                  for (var T = E.getChild().getNodes(), D2 = 0; D2 < T.length; D2++)
                    update(T[D2]);
              ...
              if (l == null)
                ...
                if (T != null) {
                  ...
                  for (var D2 = this.getAllNodes(), L, O = 0; O < D2.length; O++)
                    L = D2[O], L.transform(E);
                }
              }
              ...
              if (l == null)
                ...
                for (var E, T, D2 = l.getNodes(), L = 0; L < D2.length; L++)
                  E = D2[L], T = E.getChild(), T == null || T.getNodes().length == 0 ? E.scatter() : (this.positionNodesRandomly(T), E.updateBounds());
            }, c.prototype.getFlatForest = function() {
              for (var l = [], E = true, T = this.graphManager.getRoot().getNodes(), D2 = true, L = 0; L < T.length; L++)
                T[L].getChild() != null && (D2 = false);
              if (!D2)
                return l;
              ...
              for (s = s.concat(T); s.length > 0 && E; ) {
                for (d.push(s[0]); d.length > 0 && E; ) {
                  ...
                  for (var u = h.getEdges(), L = 0; L < u.length; L++) {
                    var p2 = u[L].getOtherEnd(h);
                    if (N.get(h) != p2)
                      if (!O.has(p2))
                        d.push(p2), N.set(p2, h);
                      else {
                        E = false;
                        break;
                      }
              ...
              for (var E = [], T = l.source, D2 = this.graphManager.calcLowestCommonAncestor(l.source, l.target), L = 0; L < l.bendpoints.length; L++) {
                var O = this.newNode(null);
                O.setRect(new Point(0, 0), new Dimension(1, 1)), D2.add(O);
                var d = this.newEdge(null);
                this.graphManager.add(d, T, O), E.add(O), T = O;
              }
              var d = this.newEdge(null);
              return this.graphManager.add(d, T, l.target), this.edgeToDummyNodes.set(l, E), l.isInterGraph() ? this.graphManager.remove(l) : D2.remove(l), E;
              ...
              for (var E = 0; E < l.length; E++) {
                ...
                if (T.bendpoints.length > 0) {
                  for (var D2 = this.edgeToDummyNodes.get(T), L = 0; L < D2.length; L++) {
                    var O = D2[L], d = new a(O.getCenterX(), O.getCenterY()), N = T.bendpoints.get(L);
                    N.x = d.x, N.y = d.y, O.getOwner().remove(O);
                  }
                  this.graphManager.add(T, T.source, T.target);
                }
              }
            }, c.transform = function(l, E, T, D2) {
              if (T != null && D2 != null) {
                var L = E;
                if (l <= 50) {
                  var O = E / T;
              ...
              var E = [];
              E = E.concat(l);
              var T = [], D2 = /* @__PURE__ */ new Map(), L = false, O = null;
              (E.length == 1 || E.length == 2) && (L = true, O = E[0]);
              for (var d = 0; d < E.length; d++) {
                var N = E[d], s = N.getNeighborsList().size;
                D2.set(N, N.getNeighborsList().size), s == 1 && T.push(N);
              }
              var h = [];
              for (h = h.concat(T); !L; ) {
                var u = [];
                u = u.concat(h), h = [];
                for (var d = 0; d < E.length; d++) {
                  var N = E[d], p2 = E.indexOf(N);
                  p2 >= 0 && E.splice(p2, 1);
                  var A = N.getNeighborsList();
                  A.forEach(function(x) {
                    if (T.indexOf(x) < 0) {
                      var _ = D2.get(x), U = _ - 1;
                      U == 1 && h.push(x), D2.set(x, U);
                    }
                  });
                }
          ...
          function(f, m, y) {
            ...
            a.prototype.initParameters = function() {
              ...
              for (var n, c, l, E, T, D2, L = this.getGraphManager().getAllEdges(), O = 0; O < L.length; O++)
                n = L[O], n.idealLength = this.idealEdgeLength, n.isInterGraph && (l = n.getSource(), E = n.getTarget(), T = n.getSourceInLca().getEstimatedSize(), D2 = n.getTargetInLca().getEstimatedSize(), this.useSmartIdealEdgeLengthCalculation && (n.idealLength += T + D2 - 2 * i.SIMPLE_NODE_SIZE), c = n.getLca().getInclusionTreeDepth(), n.idealLength += e.DEFAULT_EDGE_LENGTH * e.PER_LEVEL_IDEAL_EDGE_LENGTH_FACTOR * (l.getInclusionTreeDepth() + E.getInclusionTreeDepth() - 2 * c));
              ...
              var n = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : true, c = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : false, l, E, T, D2, L = this.getAllNodes(), O;
              if (this.useFRGridVariant)
                ...
                for (l = 0; l < L.length; l++)
                  for (T = L[l], E = l + 1; E < L.length; E++)
                    D2 = L[E], T.getOwner() == D2.getOwner() && this.calcRepulsionForce(T, D2);
              ...
              var l = n.getSource(), E = n.getTarget(), T, D2, L, O;
              if (this.uniformLeafNodeSizes && l.getChild() == null && E.getChild() == null)
                ...
                return;
              T = n.getLength(), T != 0 && (D2 = this.springConstant * (T - c), L = D2 * (n.lengthX / T), O = D2 * (n.lengthY / T), l.springForceX += L, l.springForceY += O, E.springForceX -= L, E.springForceY -= O);
            }, a.prototype.calcRepulsionForce = function(n, c) {
              var l = n.getRect(), E = c.getRect(), T = new Array(2), D2 = new Array(4), L, O, d, N, s, h, u;
              if (l.intersects(E)) {
                o.calcSeparationAmount(l, E, T, e.DEFAULT_EDGE_LENGTH / 2), h = 2 * T[0], u = 2 * T[1];
                var p2 = n.noOfChildren * c.noOfChildren / (n.noOfChildren + c.noOfChildren);
                n.repulsionForceX -= p2 * h, n.repulsionForceY -= p2 * u, c.repulsionForceX += p2 * h, c.repulsionForceY += p2 * u;
              } else
                this.uniformLeafNodeSizes && n.getChild() == null && c.getChild() == null ? (L = E.getCenterX() - l.getCenterX(), O = E.getCenterY() - l.getCenterY()) : (o.getIntersection(l, E, D2), L = D2[2] - D2[0], O = D2[3] - D2[1]), Math.abs(L) < e.MIN_REPULSION_DIST && (L = g.sign(L) * e.MIN_REPULSION_DIST), Math.abs(O) < e.MIN_REPULSION_DIST && (O = g.sign(O) * e.MIN_REPULSION_DIST), d = L * L + O * O, N = Math.sqrt(d), s = this.repulsionConstant * n.noOfChildren * c.noOfChildren / d, h = s * L / N, u = s * O / N, n.repulsionForceX -= h, n.repulsionForceY -= u, c.repulsionForceX += h, c.repulsionForceY += u;
            }, a.prototype.calcGravitationalForce = function(n) {
              var c, l, E, T, D2, L, O, d;
              c = n.getOwner(), l = (c.getRight() + c.getLeft()) / 2, E = (c.getTop() + c.getBottom()) / 2, T = n.getCenterX() - l, D2 = n.getCenterY() - E, L = Math.abs(T) + n.getWidth() / 2, O = Math.abs(D2) + n.getHeight() / 2, n.getOwner() == this.graphManager.getRoot() ? (d = c.getEstimatedSize() * this.gravityRangeFactor, (L > d || O > d) && (n.gravitationForceX = -this.gravityConstant * T, n.gravitationForceY = -this.gravityConstant * D2)) : (d = c.getEstimatedSize() * this.compoundGravityRangeFactor, (L > d || O > d) && (n.gravitationForceX = -this.gravityConstant * T * this.compoundGravityConstant, n.gravitationForceY = -this.gravityConstant * D2 * this.compoundGravityConstant));
              ...
              var E = 0, T = 0, D2 = 0, L = 0;
              E = parseInt(Math.floor((n.getRect().x - c) / this.repulsionRange)), T = parseInt(Math.floor((n.getRect().width + n.getRect().x - c) / this.repulsionRange)), D2 = parseInt(Math.floor((n.getRect().y - l) / this.repulsionRange)), L = parseInt(Math.floor((n.getRect().height + n.getRect().y - l) / this.repulsionRange));
              for (var O = E; O <= T; O++)
                for (var d = D2; d <= L; d++)
                  this.grid[O][d].push(n), n.setGridCoordinates(E, T, D2, L);
              ...
              if (this.totalIterations % e.GRID_CALCULATION_CHECK_PERIOD == 1 && l || E) {
                ...
                for (var D2, L = this.grid, O = n.startX - 1; O < n.finishX + 2; O++)
                  for (var d = n.startY - 1; d < n.finishY + 2; d++)
                    if (!(O < 0 || d < 0 || O >= L.length || d >= L[0].length)) {
                      for (var N = 0; N < L[O][d].length; N++)
                        if (D2 = L[O][d][N], !(n.getOwner() != D2.getOwner() || n == D2) && !c.has(D2) && !T.has(D2)) {
                          var s = Math.abs(n.getCenterX() - D2.getCenterX()) - (n.getWidth() / 2 + D2.getWidth() / 2), h = Math.abs(n.getCenterY() - D2.getCenterY()) - (n.getHeight() / 2 + D2.getHeight() / 2);
                          s <= this.repulsionRange && h <= this.repulsionRange && T.add(D2);
                        }
                    }
                ...
                value: function() {
                  ...
                  for (var v = 1; v < this.iMax; v++)
                    for (var n = 1; n < this.jMax; n++) {
                      ...
                      var l = this.grid[v - 1][n] + this.gap_penalty, E = this.grid[v][n - 1] + this.gap_penalty, T = [c, l, E], D2 = this.arrayAllMaxIndexes(T);
                      this.grid[v][n] = T[D2[0]], this.tracebackGrid[v][n] = [D2.includes(0), D2.includes(1), D2.includes(2)];
                    }
      ...
      return (
        ...
        function(m) {
          ...
          function r(t) {
            ...
            return m[t].call(e.exports, e, e.exports, r), e.l = true, e.exports;
          }
          ...
          function(m, y, r) {
            ...
            for (var i in t)
              e[i] = t[i];
            e.DEFAULT_USE_MULTI_LEVEL_SCALING = false, e.DEFAULT_RADIAL_SEPARATION = t.DEFAULT_EDGE_LENGTH, e.DEFAULT_COMPONENT_SEPERATION = 60, e.TILE = true, e.TILING_PADDING_VERTICAL = 10, e.TILING_PADDING_HORIZONTAL = 10, e.TREE_REDUCTION_ON_INCREMENTAL = false, m.exports = e;
          },
          /* 2 */
          /***/
          function(m, y, r) {
          ...
          /***/
          function(m, y, r) {
            var t = r(0).FDLayout, e = r(4), i = r(3), o = r(5), g = r(2), a = r(1), v = r(0).FDLayoutConstants, n = r(0).LayoutConstants, c = r(0).Point, l = r(0).PointD, E = r(0).Layout, T = r(0).Integer, D2 = r(0).IGeometry, L = r(0).LGraph, O = r(0).Transform;
            function d() {
            ...
            d.prototype.newGraphManager = function() {
              ...
              if (this.nodesWithGravity = this.calculateNodesToApplyGravitationTo(), this.graphManager.setAllNodesToApplyGravitation(this.nodesWithGravity), this.calcNoOfChildrenForAllNodes(), this.graphManager.calcLowestCommonAncestors(), this.graphManager.calcInclusionTreeDepths(), this.graphManager.getRoot().calcEstimatedSize(), this.calcIdealEdgeLengths(), this.incremental) {
                ...
                if (s.length > 0)
                  ...
                  this.reduceTrees(), this.graphManager.resetAllNodesToApplyGravitation();
                  var h = new Set(this.getAllNodes()), u = this.nodesWithGravity.filter(function(p2) {
                    return h.has(p2);
                  });
              ...
              var u = !this.isTreeGrowing && !this.isGrowthFinished, p2 = this.growTreeIterations % 10 == 1 && this.isTreeGrowing || this.afterGrowthIterations % 10 == 1 && this.isGrowthFinished;
              return this.totalDisplacement = 0, this.graphManager.updateBounds(), this.calcSpringForces(), this.calcRepulsionForces(u, p2), this.calcGravitationalForces(), this.moveNodes(), this.animate(), false;
            }, d.prototype.getPositionsData = function() {
              for (var s = this.graphManager.getAllNodes(), h = {}, u = 0; u < s.length; u++) {
                var p2 = s[u].rect, A = s[u].id;
                h[A] = {
                  id: A,
                  x: p2.getCenterX(),
                  y: p2.getCenterY(),
              ...
              var s = [], h, u = this.graphManager.getGraphs(), p2 = u.length, A;
              for (A = 0; A < p2; A++)
              ...
              for (u = 0; u < s.length; u++) {
                var p2 = s[u];
                if (!h.has(p2)) {
                  var A = p2.getSource(), C = p2.getTarget();
                  if (A == C)
                    p2.getBendpoints().push(new l()), p2.getBendpoints().push(new l()), this.createDummyNodesForBendpoints(p2), h.add(p2);
                  else {
                    var R = [];
              ...
              for (var h = new c(0, 0), u = Math.ceil(Math.sqrt(s.length)), p2 = 0, A = 0, C = 0, R = new l(0, 0), x = 0; x < s.length; x++) {
                x % u == 0 && (C = 0, A = p2, x != 0 && (A += a.DEFAULT_COMPONENT_SEPERATION), p2 = 0);
                var _ = s[x], U = E.findCenterOfTree(_);
                h.x = C, h.y = A, R = d.radialLayout(_, U, h), R.y > p2 && (p2 = Math.floor(R.y)), C = Math.floor(R.x + a.DEFAULT_COMPONENT_SEPERATION);
              }
              this.transform(new l(n.WORLD_CENTER_X - R.x / 2, n.WORLD_CENTER_Y - R.y / 2));
            }, d.radialLayout = function(s, h, u) {
              var p2 = Math.max(this.maxDiagonalInTree(s), a.DEFAULT_RADIAL_SEPARATION);
              d.branchRadialLayout(h, null, 0, 359, 0, p2);
            ...
            }, d.branchRadialLayout = function(s, h, u, p2, A, C) {
              var R = (p2 - u + 1) / 2;
              R < 0 && (R += 180);
              var x = (R + u) % 360, _ = x * D2.TWO_PI / 360, U = A * Math.cos(_), X = A * Math.sin(_);
              s.setCenter(U, X);
              var M = [];
              ...
              for (var F = 0, b = M.length, Y, k = s.getEdgesBetween(h); k.length > 1; ) {
                ...
                k.splice(0, 1);
                var P = M.indexOf(H);
                P >= 0 && M.splice(P, 1), b--, G2--;
              }
              h != null ? Y = (M.indexOf(k[0]) + 1) % b : Y = 0;
              for (var B = Math.abs(p2 - u) / G2, $ = Y; F != G2; $ = ++$ % b) {
              ...
              for (var u = [], p2 = this.graphManager.getAllNodes(), A = 0; A < p2.length; A++) {
                var C = p2[A], R = C.getParent();
              ...
              Object.keys(h).forEach(function(_) {
                if (h[_].length > 1) {
                  ...
                  var G2 = s.getGraphManager().add(s.newGraph(), M), F = X.getChild();
                  F.add(M);
              ...
              Object.keys(this.memberGroups).forEach(function(u) {
                var p2 = s.idToDummyNode[u];
                h[u] = s.tileNodes(s.memberGroups[u], p2.paddingLeft + p2.paddingRight), p2.rect.width = h[u].width, p2.rect.height = h[u].height;
              });
            }, d.prototype.repopulateCompounds = function() {
              for (var s = this.compoundOrder.length - 1; s >= 0; s--) {
                var h = this.compoundOrder[s], u = h.id, p2 = h.paddingLeft, A = h.paddingTop;
                this.adjustLocations(this.tiledMemberPack[u], h.rect.x, h.rect.y, p2, A);
              }
            }, d.prototype.repopulateZeroDegreeMembers = function() {
              var s = this, h = this.tiledZeroDegreePack;
              Object.keys(h).forEach(function(u) {
                var p2 = s.idToDummyNode[u], A = p2.paddingLeft, C = p2.paddingTop;
                s.adjustLocations(h[u], p2.rect.x, p2.rect.y, A, C);
              });
              ...
              for (var p2 = u.getNodes(), A = 0; A < p2.length; A++) {
                var C = p2[A];
              ...
              s.id;
              for (var h = s.getEdges(), u = 0, p2 = 0; p2 < h.length; p2++) {
                var A = h[p2];
              ...
              if (s.getChild() == null)
                return h;
              for (var u = s.getChild().getNodes(), p2 = 0; p2 < u.length; p2++) {
                var A = u[p2];
            ...
            }, d.prototype.adjustLocations = function(s, h, u, p2, A) {
              h += p2, u += A;
              ...
              var u = this;
              this.tiledMemberPack = [], Object.keys(s).forEach(function(p2) {
                var A = h[p2];
                u.tiledMemberPack[p2] = u.tileNodes(s[p2], A.paddingLeft + A.paddingRight), A.rect.width = u.tiledMemberPack[p2].width, A.rect.height = u.tiledMemberPack[p2].height;
              });
            }, d.prototype.tileNodes = function(s, h) {
              var u = a.TILING_PADDING_VERTICAL, p2 = a.TILING_PADDING_HORIZONTAL, A = {
                rows: [],
                rowWidth: [],
                rowHeight: [],
                width: 0,
              ...
              return A;
            }, d.prototype.insertNodeToRow = function(s, h, u, p2) {
              var A = p2;
              if (u == s.rows.length) {
                var C = [];
              ...
              for (var h = -1, u = Number.MAX_VALUE, p2 = 0; p2 < s.rows.length; p2++)
                s.rowWidth[p2] < u && (h = p2, u = s.rowWidth[p2]);
              return h;
            }, d.prototype.getLongestRowIndex = function(s) {
              for (var h = -1, u = Number.MIN_VALUE, p2 = 0; p2 < s.rows.length; p2++)
                s.rowWidth[p2] > u && (h = p2, u = s.rowWidth[p2]);
              return h;
            }, d.prototype.canAddHorizontal = function(s, h, u) {
              var p2 = this.getShortestRowIndex(s);
              if (p2 < 0)
                return true;
              var A = s.rowWidth[p2];
              if (A + s.horizontalPadding + h <= s.width)
                return true;
              var C = 0;
              s.rowHeight[p2] < u && p2 > 0 && (C = u + s.verticalPadding - s.rowHeight[p2]);
              var R;
              ...
              var h = this.getLongestRowIndex(s), u = s.rowWidth.length - 1, p2 = s.rows[h], A = p2[p2.length - 1], C = A.width + s.horizontalPadding;
              if (s.width - s.rowWidth[u] > C && h != u) {
                p2.splice(-1, 1), s.rows[u].push(A), s.rowWidth[h] = s.rowWidth[h] - C, s.rowWidth[u] = s.rowWidth[u] + C, s.width = s.rowWidth[instance.getLongestRowIndex(s)];
                for (var R = Number.MIN_VALUE, x = 0; x < p2.length; x++)
                  p2[x].height > R && (R = p2[x].height);
              ...
              for (var s = [], h = true, u; h; ) {
                var p2 = this.graphManager.getAllNodes(), A = [];
                h = false;
                for (var C = 0; C < p2.length; C++)
                  u = p2[C], u.getEdges().length == 1 && !u.getEdges()[0].isInterGraph && u.getChild() == null && (A.push([u, u.getEdges()[0], u.getOwner()]), h = true);
                if (h == true) {
              ...
              for (var h = s.length, u = s[h - 1], p2, A = 0; A < u.length; A++)
                p2 = u[A], this.findPlaceforPrunedNode(p2), p2[2].add(p2[0]), p2[2].add(p2[1], p2[1].source, p2[1].target);
              ...
              var h, u, p2 = s[0];
              p2 == s[1].source ? u = s[1].target : u = s[1].source;
              var A = u.startX, C = u.finishX, R = u.startY, x = u.finishY, _ = 0, U = 0, X = 0, M = 0, G2 = [_, X, U, M];
              if (R > 0)
                for (var F = A; F <= C; F++)
                  G2[0] += this.grid[F][R - 1].length + this.grid[F][R].length - 1;
              if (C < this.grid.length - 1)
                for (var F = R; F <= x; F++)
                  G2[1] += this.grid[C + 1][F].length + this.grid[C][F].length - 1;
              if (x < this.grid[0].length - 1)
                for (var F = A; F <= C; F++)
                  G2[2] += this.grid[F][x + 1].length + this.grid[F][x].length - 1;
              if (A > 0)
                for (var F = R; F <= x; F++)
                  G2[3] += this.grid[A - 1][F].length + this.grid[A][F].length - 1;
              for (var b = T.MAX_VALUE, Y, k, H = 0; H < G2.length; H++)
                G2[H] < b ? (b = G2[H], Y = 1, k = H) : G2[H] == b && Y++;
              if (Y == 3 && b == 0)
                G2[0] == 0 && G2[1] == 0 && G2[2] == 0 ? h = 1 : G2[0] == 0 && G2[1] == 0 && G2[3] == 0 ? h = 0 : G2[0] == 0 && G2[2] == 0 && G2[3] == 0 ? h = 3 : G2[1] == 0 && G2[2] == 0 && G2[3] == 0 && (h = 2);
              else if (Y == 2 && b == 0) {
                var P = Math.floor(Math.random() * 2);
                G2[0] == 0 && G2[1] == 0 ? P == 0 ? h = 0 : h = 1 : G2[0] == 0 && G2[2] == 0 ? P == 0 ? h = 0 : h = 2 : G2[0] == 0 && G2[3] == 0 ? P == 0 ? h = 0 : h = 3 : G2[1] == 0 && G2[2] == 0 ? P == 0 ? h = 1 : h = 2 : G2[1] == 0 && G2[3] == 0 ? P == 0 ? h = 1 : h = 3 : P == 0 ? h = 2 : h = 3;
              } else if (Y == 4 && b == 0) {
                var P = Math.floor(Math.random() * 4);
                h = P;
              } else
                h = k;
              h == 0 ? p2.setCenter(u.getCenterX(), u.getCenterY() - u.getHeight() / 2 - v.DEFAULT_EDGE_LENGTH - p2.getHeight() / 2) : h == 1 ? p2.setCenter(u.getCenterX() + u.getWidth() / 2 + v.DEFAULT_EDGE_LENGTH + p2.getWidth() / 2, u.getCenterY()) : h == 2 ? p2.setCenter(u.getCenterX(), u.getCenterY() + u.getHeight() / 2 + v.DEFAULT_EDGE_LENGTH + p2.getHeight() / 2) : p2.setCenter(u.getCenterX() - u.getWidth() / 2 - v.DEFAULT_EDGE_LENGTH - p2.getWidth() / 2, u.getCenterY());
            }, m.exports = d;
          },
          /* 7 */
          /***/
      ...
      return (
        ...
        function(m) {
          ...
          function(m, y, r) {
            ...
            function l(D2) {
              this.options = c(n, D2), E(this.options);
            }
            var E = function(L) {
            ...
            l.prototype.run = function() {
              ...
              for (var p2 = 0; p2 < u.length; p2++) {
                var A = u[p2], C = this.idToLNode[A.data("source")], R = this.idToLNode[A.data("target")];
              ...
              var _ = function(M, G2) {
                ...
                for (var M = function() {
                  O.fit && O.cy.fit(O.eles, O.padding), D2 || (D2 = true, N.cy.one("layoutready", O.ready), N.cy.trigger({ type: "layoutready", layout: N }));
                }, G2 = N.options.refresh, F, b = 0; b < G2 && !F; b++)
                  F = N.stopped || N.layout.tick();
                if (F) {
                  d.checkLayoutSuccess() && !d.isSubLayout && d.doPostLayout(), d.tilingPostLayout && d.tilingPostLayout(), d.isLayoutFinished = true, N.options.eles.nodes().positions(_), M(), N.cy.one("layoutstop", N.options.stop), N.cy.trigger({ type: "layoutstop", layout: N }), L && cancelAnimationFrame(L), D2 = false;
                  return;
                }
              ...
              }), d.runLayout(), this.options.animate !== "during" && (N.options.eles.nodes().not(":parent").layoutPositions(N, N.options, _), D2 = false), this;
            }, l.prototype.getTopMostNodes = function(D2) {
              for (var L = {}, O = 0; O < D2.length; O++)
                L[D2[O].id()] = true;
              var d = D2.filter(function(N, s) {
                typeof N == "number" && (N = s);
              ...
              return d;
            }, l.prototype.processChildrenList = function(D2, L, O) {
              for (var d = L.length, N = 0; N < d; N++) {
                var s = L[N], h = s.children(), u, p2 = s.layoutDimensions({
                  nodeDimensionsIncludeLabels: this.options.nodeDimensionsIncludeLabels
                });
                if (s.outerWidth() != null && s.outerHeight() != null ? u = D2.add(new g(O.graphManager, new a(s.position("x") - p2.w / 2, s.position("y") - p2.h / 2), new v(parseFloat(p2.w), parseFloat(p2.h)))) : u = D2.add(new g(this.graphManager)), u.id = s.data("id"), u.paddingLeft = parseInt(s.css("padding")), u.paddingTop = parseInt(s.css("padding")), u.paddingRight = parseInt(s.css("padding")), u.paddingBottom = parseInt(s.css("padding")), this.options.nodeDimensionsIncludeLabels && s.isParent()) {
...
var bt = Ft();
const Ut = /* @__PURE__ */ E0(bt);
var at = function() {
  var I = /* @__PURE__ */ p(function(O, d, N, s) {
    ...
    performAction: /* @__PURE__ */ p(function(d, N, s, h, u, p2, A) {
      var C = p2.length - 1;
      switch (u) {
        case 6:
        case 7:
        ...
        case 12:
          ...
          break;
        case 15:
          h.getLogger().info("Node: ", p2[C].id), h.addNode(p2[C - 1].length, p2[C].id, p2[C].descr, p2[C].type);
          break;
        case 16:
          h.getLogger().trace("Icon: ", p2[C]), h.decorateNode({ icon: p2[C] });
          break;
        case 17:
        case 21:
          h.decorateNode({ class: p2[C] });
          break;
        case 18:
          h.getLogger().trace("SPACELIST");
          break;
        case 19:
          h.getLogger().trace("Node: ", p2[C].id), h.addNode(0, p2[C].id, p2[C].descr, p2[C].type);
          break;
        case 20:
          h.decorateNode({ icon: p2[C] });
          break;
        case 25:
          h.getLogger().trace("node found ..", p2[C - 2]), this.$ = { id: p2[C - 1], descr: p2[C - 1], type: h.getType(p2[C - 2], p2[C]) };
          break;
        case 26:
          this.$ = { id: p2[C], descr: p2[C], type: h.nodeType.DEFAULT };
          break;
        case 27:
          h.getLogger().trace("node found ..", p2[C - 3]), this.$ = { id: p2[C - 3], descr: p2[C - 1], type: h.getType(p2[C - 2], p2[C]) };
          break;
      }
    }, "anonymous"),
    ...
    parseError: /* @__PURE__ */ p(function(d, N) {
      if (N.recoverable)
        this.trace(d);
      else {
        var s = new Error(d);
    ...
    parse: /* @__PURE__ */ p(function(d) {
      var N = this, s = [0], h = [], u = [null], p$1 = [], A = this.table, C = "", R = 0, x = 0, _ = 2, U = 1, X = p$1.slice.call(arguments, 1), M = Object.create(this.lexer), G2 = { yy: {} };
      for (var F in this.yy)
        Object.prototype.hasOwnProperty.call(this.yy, F) && (G2.yy[F] = this.yy[F]);
      M.setInput(d, G2.yy), G2.yy.lexer = M, G2.yy.parser = this, typeof M.yylloc > "u" && (M.yylloc = {});
      var b = M.yylloc;
      p$1.push(b);
      ...
      function k(V) {
        s.length = s.length - 2 * V, u.length = u.length - V, p$1.length = p$1.length - V;
      }
      p(k, "popStack");
      function H() {
        var V;
...
Expecting ` + J.join(", ") + ", got '" + (this.terminals_[P] || P) + "'" : st = "Parse error on line " + (R + 1) + ": Unexpected " + (P == U ? "end of input" : "'" + (this.terminals_[P] || P) + "'"), this.parseError(st, {
        ...
        switch ($[0]) {
          case 1:
            s.push(P), u.push(M.yytext), p$1.push(M.yylloc), s.push($[1]), P = null, x = M.yyleng, C = M.yytext, R = M.yylineno, b = M.yylloc;
            break;
          case 2:
            if (j = this.productions_[$[1]][1], Q.$ = u[u.length - j], Q._$ = {
              first_line: p$1[p$1.length - (j || 1)].first_line,
              last_line: p$1[p$1.length - 1].last_line,
              first_column: p$1[p$1.length - (j || 1)].first_column,
              last_column: p$1[p$1.length - 1].last_column
            }, Y && (Q._$.range = [
              p$1[p$1.length - (j || 1)].range[0],
              p$1[p$1.length - 1].range[1]
              ...
              return K;
            j && (s = s.slice(0, -1 * j * 2), u = u.slice(0, -1 * j), p$1 = p$1.slice(0, -1 * j)), s.push(this.productions_[$[1]][0]), u.push(Q.$), p$1.push(Q._$), gt = A[s[s.length - 2]][s[s.length - 1]], s.push(gt);
            break;
          case 3:
            return true;
        }
    ...
    var O = {
      EOF: 1,
      parseError: /* @__PURE__ */ p(function(N, s) {
        if (this.yy.parser)
      ...
      setInput: /* @__PURE__ */ p(function(d, N) {
...
` + N + "^";
      ...
      test_match: /* @__PURE__ */ p(function(d, N) {
        var s, h, u;
      ...
      next: /* @__PURE__ */ p(function() {
        ...
        for (var u = this._currentRules(), p2 = 0; p2 < u.length; p2++)
          if (s = this._input.match(this.rules[u[p2]]), s && (!N || s[0].length > N[0].length)) {
            if (N = s, h = p2, this.options.backtrack_lexer) {
              if (d = this.test_match(s, u[p2]), d !== false)
                return d;
              if (this._backtrack) {
                N = false;
                continue;
...
` + this.showPosition(), {
      ...
      performAction: /* @__PURE__ */ p(function(N, s, h, u) {
        switch (h) {
          case 0:
  ...
  return p(L, "Parser"), L.prototype = T, T.Parser = L, new L();
}();
at.parser = at;
var Pt = at, Z = [], vt = 0, ht = {}, Yt = /* @__PURE__ */ p(() => {
  Z = [], vt = 0, ht = {};
}, "clear"), Xt = /* @__PURE__ */ p(function(I) {
  for (let w = Z.length - 1; w >= 0; w--)
    if (Z[w].level < I)
      return Z[w];
  return null;
}, "getParent"), kt = /* @__PURE__ */ p(() => Z.length > 0 ? Z[0] : null, "getMindmap"), Ht = /* @__PURE__ */ p((I, w, f, m) => {
  var i, o;
  D.info("addNode", I, w, f, m);
  const y = dt();
  let r = ((i = y.mindmap) == null ? void 0 : i.padding) ?? Nc.mindmap.padding;
  switch (m) {
    case W.ROUNDED_RECT:
    case W.RECT:
    case W.HEXAGON:
  ...
  const t = {
    ...
    type: m,
    children: [],
    width: ((o = y.mindmap) == null ? void 0 : o.maxNodeWidth) ?? Nc.mindmap.maxNodeWidth,
    padding: r
  }, e = Xt(I);
  if (e)
  ...
  switch (D.debug("In get type", I, w), I) {
    case "[":
      return W.RECT;
    case "(":
...
}, "getType"), Wt = /* @__PURE__ */ p((I, w) => {
  ht[I] = w;
}, "setElementForId"), Bt = /* @__PURE__ */ p((I) => {
  if (!I)
    return;
  const w = dt(), f = Z[Z.length - 1];
  I.icon && (f.icon = rr(I.icon, w)), I.class && (f.class = rr(I.class, w));
}, "decorateNode"), Vt = /* @__PURE__ */ p((I) => {
  switch (I) {
    case W.DEFAULT:
      return "no-border";
    case W.RECT:
...
}, "type2Str"), Zt = /* @__PURE__ */ p(() => D, "getLogger"), Qt = /* @__PURE__ */ p((I) => ht[I], "getElementById"), jt = {
  clear: Yt,
  addNode: Ht,
  getMindmap: kt,
  nodeType: W,
  ...
  getLogger: Zt,
  getElementById: Qt
}, zt = jt, Kt = 12, qt = /* @__PURE__ */ p(function(I, w, f, m) {
...
}, "cloudBkg"), ee = /* @__PURE__ */ p(function(I, w, f) {
...
}, "bangBkg"), re = /* @__PURE__ */ p(function(I, w, f) {
...
p(yt, "insertPolygonShape");
var ie = /* @__PURE__ */ p(function(I, w, f) {
  ...
  yt(w, t, m, e, f);
}, "hexagonBkg"), ne = /* @__PURE__ */ p(function(I, w, f) {
...
}, "roundedRectBkg"), se = /* @__PURE__ */ p(async function(I, w, f, m, y) {
...
`);
  ...
  const v = g.node().getBBox(), [n] = sn(y.fontSize);
...
}, "drawNode"), ae = /* @__PURE__ */ p(function(I, w) {
...
function Et(I, w) {
  w.edges().map((f, m) => {
    ...
    if (f[0]._private.bodyBounds) {
      ...
      D.trace("Edge: ", m, y), I.insert("path").attr(
        "d",
...
function Lt(I, w) {
  return new Promise((f) => {
    const m = Li("body").append("div").attr("id", "cy").attr("style", "display:none"), y = Jt$1({
...
function Tt(I, w) {
  w.nodes().map((f, m) => {
    ...
    D.info("Id:", m, "Position: (", f.position().x, ", ", f.position().y, ")", y), r.attr(
      "transform",
...
p(Tt, "positionNodes");
var oe = /* @__PURE__ */ p(async (I, w, f, m) => {
  var a, v;
  D.debug(`Rendering mindmap diagram
` + I);
  ...
  Et(i, g), Tt(y, g), Xm(
    void 0,
    e,
    ((a = t.mindmap) == null ? void 0 : a.padding) ?? Nc.mindmap.padding,
    ((v = t.mindmap) == null ? void 0 : v.useMaxWidth) ?? Nc.mindmap.useMaxWidth
  );
}, "draw"), he = {
  draw: oe
}, le = /* @__PURE__ */ p((I) => {
  ...
  for (let f = 0; f < I.THEME_COLOR_LIMIT; f++)
    I["lineColor" + f] = I["lineColor" + f] || I["cScaleInv" + f], Fi(I["lineColor" + f]) ? I["lineColor" + f] = G(I["lineColor" + f], 20) : I["lineColor" + f] = it(I["lineColor" + f], 20);
  for (let f = 0; f < I.THEME_COLOR_LIMIT; f++) {
    const m = "" + (17 - 3 * f);
    w += `
