import { _ as p, m as $_, c as dt, b as Jm, s as ey, o as iy, a as ty, g as ry, p as ay, j as Hr, q as g0, J as p0, t as xC, l as D, v as U_, u as ge$1, x as Qm, y as D_, n as J_, r as Q_, z as xi } from "./mermaid-j5R1o_wi-dCQhMK9F.js";
import { b, B } from "./chunk-RZ5BOZE2-mpnkmZCx-SD7v2Mwj.js";
...
var he = "flowchart-", P1, de = (P1 = class {
  // cspell:ignore funs
  constructor() {
    this.vertexCounter = 0, this.config = dt(), this.vertices = /* @__PURE__ */ new Map(), this.edges = [], this.classes = /* @__PURE__ */ new Map(), this.subGraphs = [], this.subGraphLookup = /* @__PURE__ */ new Map(), this.tooltips = /* @__PURE__ */ new Map(), this.subCount = 0, this.firstGraphFlag = true, this.secCount = -1, this.posCrossRef = [], this.funs = [], this.setAccTitle = Jm, this.setAccDescription = ey, this.setDiagramTitle = iy, this.getAccTitle = ty, this.getAccDescription = ry, this.getDiagramTitle = ay, this.funs.push(this.setupToolTips.bind(this)), this.addVertex = this.addVertex.bind(this), this.firstGraph = this.firstGraph.bind(this), this.setDirection = this.setDirection.bind(this), this.addSubGraph = this.addSubGraph.bind(this), this.addLink = this.addLink.bind(this), this.setLink = this.setLink.bind(this), this.updateLink = this.updateLink.bind(this), this.addClass = this.addClass.bind(this), this.setClass = this.setClass.bind(this), this.destructLink = this.destructLink.bind(this), this.setClickEvent = this.setClickEvent.bind(this), this.setTooltip = this.setTooltip.bind(this), this.updateLinkInterpolate = this.updateLinkInterpolate.bind(this), this.setClickFun = this.setClickFun.bind(this), this.bindFunctions = this.bindFunctions.bind(this), this.lex = {
      firstGraph: this.firstGraph.bind(this)
    }, this.clear(), this.setGen("gen-2");
  }
  sanitizeText(i) {
    return Hr.sanitizeText(i, this.config);
  }
  /**
...
` + A + `
    ...
    const b2 = this.edges.find((d) => d.id === i);
    if (b2) {
      const d = r;
      (d == null ? void 0 : d.animate) !== void 0 && (b2.animate = d.animate), (d == null ? void 0 : d.animation) !== void 0 && (b2.animation = d.animation);
      return;
    }
    ...
    if (k === void 0 && (k = {
      ...
      styles: [],
      classes: []
    }, this.vertices.set(i, k)), this.vertexCounter++, a !== void 0 ? (this.config = dt(), F = this.sanitizeText(a.text.trim()), k.labelType = a.type, F.startsWith('"') && F.endsWith('"') && (F = F.substring(1, F.length - 1)), k.text = F) : k.text === void 0 && (k.text = i), n !== void 0 && (k.type = n), u != null && u.forEach((d) => {
      k.styles.push(d);
    }), l2 != null && l2.forEach((d) => {
      k.classes.push(d);
  ...
  addSingleLink(i, a, n, u) {
    ...
    if (A !== void 0 && (c.text = this.sanitizeText(A.text.trim()), c.text.startsWith('"') && c.text.endsWith('"') && (c.text = c.text.substring(1, c.text.length - 1)), c.labelType = A.type), n !== void 0 && (c.type = n.type, c.stroke = n.stroke, c.length = n.length > 10 ? 10 : n.length), u && !this.edges.some((r) => r.id === u))
      ...
      const r = this.edges.filter((b2) => b2.start === c.start && b2.end === c.end);
      r.length === 0 ? c.id = U_(c.start, c.end, { counter: 0, prefix: "L" }) : c.id = U_(c.start, c.end, {
        counter: r.length + 1,
        prefix: "L"
      });
    }
    if (this.edges.length < (this.config.maxEdges ?? 500))
      D.info("Pushing edge..."), this.edges.push(c);
    else
      throw new Error(
...
You have to call mermaid.initialize.`
  ...
  addLink(i, a, n) {
    ...
    D.info("addLink", i, a, u);
    for (const l2 of i)
      for (const f of a) {
        const c = l2 === i[i.length - 1], A = f === a[0];
        c && A ? this.addSingleLink(l2, f, n, u) : this.addSingleLink(l2, f, n, void 0);
      }
  }
  /**
  ...
  updateLink(i, a) {
    i.forEach((n) => {
      ...
      n === "default" ? this.edges.defaultStyle = a : (this.edges[n].style = a, (((l2 = (u = this.edges[n]) == null ? void 0 : u.style) == null ? void 0 : l2.length) ?? 0) > 0 && !((c = (f = this.edges[n]) == null ? void 0 : f.style) != null && c.some((b2) => b2 == null ? void 0 : b2.startsWith("fill"))) && ((r = (A = this.edges[n]) == null ? void 0 : A.style) == null || r.push("fill:none")));
    });
  }
  addClass(i, a) {
    const n = a.join().replace(/\\,/g, "§§§").replace(/,/g, ";").replace(/§§§/g, ",").split(";");
    i.split(",").forEach((u) => {
      let l2 = this.classes.get(u);
      l2 === void 0 && (l2 = { id: u, styles: [], textStyles: [] }, this.classes.set(u, l2)), n != null && n.forEach((f) => {
        if (/color/.exec(f)) {
  ...
  setClass(i, a) {
    for (const n of i.split(",")) {
      ...
      u && u.classes.push(a);
      const l2 = this.edges.find((c) => c.id === n);
      l2 && l2.classes.push(a);
  ...
  setClickFun(i, a, n) {
    ...
    if (dt().securityLevel !== "loose" || a === void 0)
      return;
    let l2 = [];
    if (typeof n == "string") {
      l2 = n.split(/,(?=(?:(?:[^"]*"){2})*[^"]*$)/);
      for (let c = 0; c < l2.length; c++) {
        let A = l2[c].trim();
        A.startsWith('"') && A.endsWith('"') && (A = A.substr(1, A.length - 2)), l2[c] = A;
      }
    }
  ...
  setLink(i, a, n) {
    i.split(",").forEach((u) => {
      const l2 = this.vertices.get(u);
      l2 !== void 0 && (l2.link = ge$1.formatUrl(a, this.config), l2.linkTarget = n);
  ...
  setupToolTips(i) {
    let a = Li(".mermaidTooltip");
    (a._groups || a)[0][0] === null && (a = Li("body").append("div").attr("class", "mermaidTooltip").style("opacity", 0)), Li(i).select("svg").selectAll("g.node").on("mouseover", (l2) => {
      var r;
      const f = Li(l2.currentTarget);
      if (f.attr("title") === null)
        return;
      const A = (r = l2.currentTarget) == null ? void 0 : r.getBoundingClientRect();
      ...
      a.transition().duration(500).style("opacity", 0), Li(l2.currentTarget).classed("hover", false);
    });
  }
  /**
   ...
   */
  clear(i = "gen-2") {
    this.vertices = /* @__PURE__ */ new Map(), this.classes = /* @__PURE__ */ new Map(), this.edges = [], this.funs = [this.setupToolTips.bind(this)], this.subGraphs = [], this.subGraphLookup = /* @__PURE__ */ new Map(), this.subCount = 0, this.tooltips = /* @__PURE__ */ new Map(), this.firstGraphFlag = true, this.version = i, this.config = dt(), Qm();
  }
  setGen(i) {
  ...
  addSubGraph(i, a, n) {
    let u = i.text.trim(), l2 = n.text;
    i === n && /\s/.exec(n.text) && (u = void 0);
    const f = /* @__PURE__ */ p((b2) => {
      const F = { boolean: {}, number: {}, string: {} }, k = [];
      let U;
      return { nodeList: b2.filter(function(d) {
        const K = typeof d;
        return d.stmt && d.stmt === "dir" ? (U = d.value, false) : d.trim() === "" ? false : K in F ? F[K].hasOwnProperty(d) ? false : F[K][d] = true : k.includes(d) ? false : k.push(d);
      }), dir: U };
    }, "uniq"), { nodeList: c, dir: A } = f(a.flat());
    if (this.version === "gen-1")
      for (let b2 = 0; b2 < c.length; b2++)
        c[b2] = this.lookUpDomId(c[b2]);
    u = u ?? "subGraph" + this.subCount, l2 = l2 || "", l2 = this.sanitizeText(l2), this.subCount = this.subCount + 1;
    const r = {
      id: u,
      nodes: c,
      title: l2.trim(),
    ...
    return D.info("Adding", r.id, r.nodes, r.dir), r.nodes = this.makeUniq(r, this.subGraphs).nodes, this.subGraphs.push(r), this.subGraphLookup.set(u, r), u;
  }
  getPosForId(i) {
  ...
  destructEndLink(i) {
    ...
    let l2 = "normal", f = n.length - 1;
    n.startsWith("=") && (l2 = "thick"), n.startsWith("~") && (l2 = "invisible");
    const c = this.countChar(".", n);
    return c && (l2 = "dotted", f = c), { type: u, stroke: l2, length: f };
  }
  destructLink(i, a) {
  ...
  makeUniq(i, a) {
    const n = [];
    return i.nodes.forEach((u, l2) => {
      this.exists(a, u) || n.push(i.nodes[l2]);
    }), { nodes: n };
  }
  getTypeFromVertex(i) {
    if (i.img)
  ...
  addNodeFromVertex(i, a, n, u, l2, f) {
    var b2;
    ...
    if (r)
      ...
      const F = {
        ...
        labelStyle: "",
        parentId: c,
        padding: ((b2 = l2.flowchart) == null ? void 0 : b2.padding) || 8,
        cssStyles: i.styles,
  ...
  getCompiledStyles(i) {
    ...
    for (const n of i) {
      ...
      u != null && u.styles && (a = [...a, ...u.styles ?? []].map((l2) => l2.trim())), u != null && u.textStyles && (a = [...a, ...u.textStyles ?? []].map((l2) => l2.trim()));
    }
    return a;
  }
  getData() {
    const i = dt(), a = [], n = [], u = this.getSubGraphs(), l2 = /* @__PURE__ */ new Map(), f = /* @__PURE__ */ new Map();
    for (let r = u.length - 1; r >= 0; r--) {
      const b2 = u[r];
      b2.nodes.length > 0 && f.set(b2.id, true);
      for (const F of b2.nodes)
        l2.set(F, b2.id);
    }
    for (let r = u.length - 1; r >= 0; r--) {
      const b2 = u[r];
      a.push({
        ...
        label: b2.title,
        labelStyle: "",
        parentId: l2.get(b2.id),
        padding: 8,
        cssCompiledStyles: this.getCompiledStyles(b2.classes),
        cssClasses: b2.classes.join(" "),
        shape: "rect",
        dir: b2.dir,
        isGroup: true,
        look: i.look
...
}, p(P1, "FlowDB"), P1), pe = /* @__PURE__ */ p(function(s, i) {
  return i.db.getClasses();
}, "getClasses"), fe = /* @__PURE__ */ p(async function(s, i, a, n) {
  var U;
  D.info("REF0:"), D.info("Drawing state diagram (v2)", i);
  const { securityLevel: u, flowchart: l2, layout: f } = dt();
  let c;
  u === "sandbox" && (c = Li("#i" + i));
  const A = u === "sandbox" ? c.nodes()[0].contentDocument : document;
  D.debug("Before getData: ");
  const r = n.db.getData();
  D.debug("Data: ", r);
  const b$1 = b(i, u), F = n.db.getDirection();
  r.type = n.type, r.layoutAlgorithm = J_(f), r.layoutAlgorithm === "dagre" && f === "elk" && D.warn(
    "flowchart-elk was moved to an external package in Mermaid v11. Please refer [release notes](https://github.com/mermaid-js/mermaid/releases/tag/v11.0.0) for more details. This diagram will be rendered using `dagre` layout as a fallback."
  ), r.direction = F, r.nodeSpacing = (l2 == null ? void 0 : l2.nodeSpacing) || 50, r.rankSpacing = (l2 == null ? void 0 : l2.rankSpacing) || 50, r.markers = ["point", "circle", "cross"], r.diagramId = i, D.debug("REF1:", r), await Q_(r, b$1);
  ...
  ), B(b$1, k, "flowchart", (l2 == null ? void 0 : l2.useMaxWidth) || false);
  for (const T of r.nodes) {
    const d = Li(`#${i} [id="${T.id}"]`);
    if (!d || !T.link)
      continue;
  ...
  var s = /* @__PURE__ */ p(function(p1, h, p2, g) {
    ...
    performAction: /* @__PURE__ */ p(function(h, p2, g, o, _, t, O1) {
      var e = t.length - 1;
      switch (_) {
        case 2:
          this.$ = [];
    ...
    table: [{ 3: 1, 4: 2, 9: i, 10: a, 12: n }, { 1: [3] }, s(u, l2, { 5: 6 }), { 4: 7, 9: i, 10: a, 12: n }, { 4: 8, 9: i, 10: a, 12: n }, { 13: [1, 9], 14: [1, 10] }, { 1: [2, 1], 6: 11, 7: 12, 8: f, 9: c, 10: A, 11: r, 20: 17, 22: 18, 23: 19, 24: 20, 25: 21, 26: 22, 27: b2, 33: 24, 34: F, 36: k, 38: U, 42: 28, 43: 38, 44: T, 45: 39, 47: 40, 60: d, 84: K, 85: f1, 86: g1, 87: b1, 88: M1, 89: V, 102: L, 105: I, 106: w, 109: R, 111: N, 113: 41, 114: G, 115: P, 116: O, 121: U1, 122: W1, 123: z1, 124: j1 }, s(u, [2, 9]), s(u, [2, 10]), s(u, [2, 11]), { 8: [1, 54], 9: [1, 55], 10: h1, 15: 53, 18: 56 }, s(E, [2, 3]), s(E, [2, 4]), s(E, [2, 5]), s(E, [2, 6]), s(E, [2, 7]), s(E, [2, 8]), { 8: $, 9: t1, 11: e1, 21: 58, 41: 59, 72: 63, 75: [1, 64], 77: [1, 66], 78: [1, 65] }, { 8: $, 9: t1, 11: e1, 21: 67 }, { 8: $, 9: t1, 11: e1, 21: 68 }, { 8: $, 9: t1, 11: e1, 21: 69 }, { 8: $, 9: t1, 11: e1, 21: 70 }, { 8: $, 9: t1, 11: e1, 21: 71 }, { 8: $, 9: t1, 10: [1, 72], 11: e1, 21: 73 }, s(E, [2, 36]), { 35: [1, 74] }, { 37: [1, 75] }, s(E, [2, 39]), s(S1, [2, 50], { 18: 76, 39: 77, 10: h1, 40: at }), { 10: [1, 79] }, { 10: [1, 80] }, { 10: [1, 81] }, { 10: [1, 82] }, { 14: D1, 44: x1, 60: T1, 80: [1, 86], 89: E1, 95: [1, 83], 97: [1, 84], 101: 85, 105: y1, 106: F1, 109: _1, 111: B1, 114: v1, 115: V1, 116: L1, 120: 87 }, s(E, [2, 185]), s(E, [2, 186]), s(E, [2, 187]), s(E, [2, 188]), s(A1, [2, 51]), s(A1, [2, 54], { 46: [1, 99] }), s(W, [2, 72], { 113: 112, 29: [1, 100], 44: T, 48: [1, 101], 50: [1, 102], 52: [1, 103], 54: [1, 104], 56: [1, 105], 58: [1, 106], 60: d, 63: [1, 107], 65: [1, 108], 67: [1, 109], 68: [1, 110], 70: [1, 111], 89: V, 102: L, 105: I, 106: w, 109: R, 111: N, 114: G, 115: P, 116: O }), s(H, [2, 181]), s(H, [2, 142]), s(H, [2, 143]), s(H, [2, 144]), s(H, [2, 145]), s(H, [2, 146]), s(H, [2, 147]), s(H, [2, 148]), s(H, [2, 149]), s(H, [2, 150]), s(H, [2, 151]), s(H, [2, 152]), s(u, [2, 12]), s(u, [2, 18]), s(u, [2, 19]), { 9: [1, 113] }, s(nt, [2, 26], { 18: 114, 10: h1 }), s(E, [2, 27]), { 42: 115, 43: 38, 44: T, 45: 39, 47: 40, 60: d, 89: V, 102: L, 105: I, 106: w, 109: R, 111: N, 113: 41, 114: G, 115: P, 116: O }, s(E, [2, 40]), s(E, [2, 41]), s(E, [2, 42]), s(I1, [2, 76], { 73: 116, 62: [1, 118], 74: [1, 117] }), { 76: 119, 79: 120, 80: ut, 81: lt, 116: K1, 119: Y1 }, { 75: [1, 125], 77: [1, 126] }, s(ot, [2, 83]), s(E, [2, 28]), s(E, [2, 29]), s(E, [2, 30]), s(E, [2, 31]), s(E, [2, 32]), { 10: ct, 12: ht, 14: dt2, 27: pt, 28: 127, 32: ft, 44: gt, 60: bt, 75: At, 80: [1, 129], 81: [1, 130], 83: 140, 84: kt, 85: mt, 86: Ct, 87: St, 88: Dt, 89: xt, 90: Tt, 91: 128, 105: Et, 109: yt, 111: Ft, 114: _t, 115: Bt, 116: vt }, s(Q1, l2, { 5: 153 }), s(E, [2, 37]), s(E, [2, 38]), s(S1, [2, 48], { 44: Vt }), s(S1, [2, 49], { 18: 155, 10: h1, 40: Lt }), s(A1, [2, 44]), { 44: T, 47: 157, 60: d, 89: V, 102: L, 105: I, 106: w, 109: R, 111: N, 113: 41, 114: G, 115: P, 116: O }, { 102: [1, 158], 103: 159, 105: [1, 160] }, { 44: T, 47: 161, 60: d, 89: V, 102: L, 105: I, 106: w, 109: R, 111: N, 113: 41, 114: G, 115: P, 116: O }, { 44: T, 47: 162, 60: d, 89: V, 102: L, 105: I, 106: w, 109: R, 111: N, 113: 41, 114: G, 115: P, 116: O }, s(B2, [2, 107], { 10: [1, 163], 96: [1, 164] }), { 80: [1, 165] }, s(B2, [2, 115], { 120: 167, 10: [1, 166], 14: D1, 44: x1, 60: T1, 89: E1, 105: y1, 106: F1, 109: _1, 111: B1, 114: v1, 115: V1, 116: L1 }), s(B2, [2, 117], { 10: [1, 168] }), s(q, [2, 183]), s(q, [2, 170]), s(q, [2, 171]), s(q, [2, 172]), s(q, [2, 173]), s(q, [2, 174]), s(q, [2, 175]), s(q, [2, 176]), s(q, [2, 177]), s(q, [2, 178]), s(q, [2, 179]), s(q, [2, 180]), { 44: T, 47: 169, 60: d, 89: V, 102: L, 105: I, 106: w, 109: R, 111: N, 113: 41, 114: G, 115: P, 116: O }, { 30: 170, 67: C, 80: z, 81: j, 82: 171, 116: S, 117: D2, 118: x }, { 30: 178, 67: C, 80: z, 81: j, 82: 171, 116: S, 117: D2, 118: x }, { 30: 180, 50: [1, 179], 67: C, 80: z, 81: j, 82: 171, 116: S, 117: D2, 118: x }, { 30: 181, 67: C, 80: z, 81: j, 82: 171, 116: S, 117: D2, 118: x }, { 30: 182, 67: C, 80: z, 81: j, 82: 171, 116: S, 117: D2, 118: x }, { 30: 183, 67: C, 80: z, 81: j, 82: 171, 116: S, 117: D2, 118: x }, { 109: [1, 184] }, { 30: 185, 67: C, 80: z, 81: j, 82: 171, 116: S, 117: D2, 118: x }, { 30: 186, 65: [1, 187], 67: C, 80: z, 81: j, 82: 171, 116: S, 117: D2, 118: x }, { 30: 188, 67: C, 80: z, 81: j, 82: 171, 116: S, 117: D2, 118: x }, { 30: 189, 67: C, 80: z, 81: j, 82: 171, 116: S, 117: D2, 118: x }, { 30: 190, 67: C, 80: z, 81: j, 82: 171, 116: S, 117: D2, 118: x }, s(H, [2, 182]), s(u, [2, 20]), s(nt, [2, 25]), s(S1, [2, 46], { 39: 191, 18: 192, 10: h1, 40: at }), s(I1, [2, 73], { 10: [1, 193] }), { 10: [1, 194] }, { 30: 195, 67: C, 80: z, 81: j, 82: 171, 116: S, 117: D2, 118: x }, { 77: [1, 196], 79: 197, 116: K1, 119: Y1 }, s(w1, [2, 79]), s(w1, [2, 81]), s(w1, [2, 82]), s(w1, [2, 168]), s(w1, [2, 169]), { 76: 198, 79: 120, 80: ut, 81: lt, 116: K1, 119: Y1 }, s(ot, [2, 84]), { 8: $, 9: t1, 10: ct, 11: e1, 12: ht, 14: dt2, 21: 200, 27: pt, 29: [1, 199], 32: ft, 44: gt, 60: bt, 75: At, 83: 140, 84: kt, 85: mt, 86: Ct, 87: St, 88: Dt, 89: xt, 90: Tt, 91: 201, 105: Et, 109: yt, 111: Ft, 114: _t, 115: Bt, 116: vt }, s(y, [2, 101]), s(y, [2, 103]), s(y, [2, 104]), s(y, [2, 157]), s(y, [2, 158]), s(y, [2, 159]), s(y, [2, 160]), s(y, [2, 161]), s(y, [2, 162]), s(y, [2, 163]), s(y, [2, 164]), s(y, [2, 165]), s(y, [2, 166]), s(y, [2, 167]), s(y, [2, 90]), s(y, [2, 91]), s(y, [2, 92]), s(y, [2, 93]), s(y, [2, 94]), s(y, [2, 95]), s(y, [2, 96]), s(y, [2, 97]), s(y, [2, 98]), s(y, [2, 99]), s(y, [2, 100]), { 6: 11, 7: 12, 8: f, 9: c, 10: A, 11: r, 20: 17, 22: 18, 23: 19, 24: 20, 25: 21, 26: 22, 27: b2, 32: [1, 202], 33: 24, 34: F, 36: k, 38: U, 42: 28, 43: 38, 44: T, 45: 39, 47: 40, 60: d, 84: K, 85: f1, 86: g1, 87: b1, 88: M1, 89: V, 102: L, 105: I, 106: w, 109: R, 111: N, 113: 41, 114: G, 115: P, 116: O, 121: U1, 122: W1, 123: z1, 124: j1 }, { 10: h1, 18: 203 }, { 44: [1, 204] }, s(A1, [2, 43]), { 10: [1, 205], 44: T, 60: d, 89: V, 102: L, 105: I, 106: w, 109: R, 111: N, 113: 112, 114: G, 115: P, 116: O }, { 10: [1, 206] }, { 10: [1, 207], 106: [1, 208] }, s(It, [2, 128]), { 10: [1, 209], 44: T, 60: d, 89: V, 102: L, 105: I, 106: w, 109: R, 111: N, 113: 112, 114: G, 115: P, 116: O }, { 10: [1, 210], 44: T, 60: d, 89: V, 102: L, 105: I, 106: w, 109: R, 111: N, 113: 112, 114: G, 115: P, 116: O }, { 80: [1, 211] }, s(B2, [2, 109], { 10: [1, 212] }), s(B2, [2, 111], { 10: [1, 213] }), { 80: [1, 214] }, s(q, [2, 184]), { 80: [1, 215], 98: [1, 216] }, s(A1, [2, 55], { 113: 112, 44: T, 60: d, 89: V, 102: L, 105: I, 106: w, 109: R, 111: N, 114: G, 115: P, 116: O }), { 31: [1, 217], 67: C, 82: 218, 116: S, 117: D2, 118: x }, s(d1, [2, 86]), s(d1, [2, 88]), s(d1, [2, 89]), s(d1, [2, 153]), s(d1, [2, 154]), s(d1, [2, 155]), s(d1, [2, 156]), { 49: [1, 219], 67: C, 82: 218, 116: S, 117: D2, 118: x }, { 30: 220, 67: C, 80: z, 81: j, 82: 171, 116: S, 117: D2, 118: x }, { 51: [1, 221], 67: C, 82: 218, 116: S, 117: D2, 118: x }, { 53: [1, 222], 67: C, 82: 218, 116: S, 117: D2, 118: x }, { 55: [1, 223], 67: C, 82: 218, 116: S, 117: D2, 118: x }, { 57: [1, 224], 67: C, 82: 218, 116: S, 117: D2, 118: x }, { 60: [1, 225] }, { 64: [1, 226], 67: C, 82: 218, 116: S, 117: D2, 118: x }, { 66: [1, 227], 67: C, 82: 218, 116: S, 117: D2, 118: x }, { 30: 228, 67: C, 80: z, 81: j, 82: 171, 116: S, 117: D2, 118: x }, { 31: [1, 229], 67: C, 82: 218, 116: S, 117: D2, 118: x }, { 67: C, 69: [1, 230], 71: [1, 231], 82: 218, 116: S, 117: D2, 118: x }, { 67: C, 69: [1, 233], 71: [1, 232], 82: 218, 116: S, 117: D2, 118: x }, s(S1, [2, 45], { 18: 155, 10: h1, 40: Lt }), s(S1, [2, 47], { 44: Vt }), s(I1, [2, 75]), s(I1, [2, 74]), { 62: [1, 234], 67: C, 82: 218, 116: S, 117: D2, 118: x }, s(I1, [2, 77]), s(w1, [2, 80]), { 77: [1, 235], 79: 197, 116: K1, 119: Y1 }, { 30: 236, 67: C, 80: z, 81: j, 82: 171, 116: S, 117: D2, 118: x }, s(Q1, l2, { 5: 237 }), s(y, [2, 102]), s(E, [2, 35]), { 43: 238, 44: T, 45: 39, 47: 40, 60: d, 89: V, 102: L, 105: I, 106: w, 109: R, 111: N, 113: 41, 114: G, 115: P, 116: O }, { 10: h1, 18: 239 }, { 10: s1, 60: i1, 84: r1, 92: 240, 105: a1, 107: 241, 108: 242, 109: n1, 110: u1, 111: l1, 112: o1 }, { 10: s1, 60: i1, 84: r1, 92: 251, 104: [1, 252], 105: a1, 107: 241, 108: 242, 109: n1, 110: u1, 111: l1, 112: o1 }, { 10: s1, 60: i1, 84: r1, 92: 253, 104: [1, 254], 105: a1, 107: 241, 108: 242, 109: n1, 110: u1, 111: l1, 112: o1 }, { 105: [1, 255] }, { 10: s1, 60: i1, 84: r1, 92: 256, 105: a1, 107: 241, 108: 242, 109: n1, 110: u1, 111: l1, 112: o1 }, { 44: T, 47: 257, 60: d, 89: V, 102: L, 105: I, 106: w, 109: R, 111: N, 113: 41, 114: G, 115: P, 116: O }, s(B2, [2, 108]), { 80: [1, 258] }, { 80: [1, 259], 98: [1, 260] }, s(B2, [2, 116]), s(B2, [2, 118], { 10: [1, 261] }), s(B2, [2, 119]), s(W, [2, 56]), s(d1, [2, 87]), s(W, [2, 57]), { 51: [1, 262], 67: C, 82: 218, 116: S, 117: D2, 118: x }, s(W, [2, 64]), s(W, [2, 59]), s(W, [2, 60]), s(W, [2, 61]), { 109: [1, 263] }, s(W, [2, 63]), s(W, [2, 65]), { 66: [1, 264], 67: C, 82: 218, 116: S, 117: D2, 118: x }, s(W, [2, 67]), s(W, [2, 68]), s(W, [2, 70]), s(W, [2, 69]), s(W, [2, 71]), s([10, 44, 60, 89, 102, 105, 106, 109, 111, 114, 115, 116], [2, 85]), s(I1, [2, 78]), { 31: [1, 265], 67: C, 82: 218, 116: S, 117: D2, 118: x }, { 6: 11, 7: 12, 8: f, 9: c, 10: A, 11: r, 20: 17, 22: 18, 23: 19, 24: 20, 25: 21, 26: 22, 27: b2, 32: [1, 266], 33: 24, 34: F, 36: k, 38: U, 42: 28, 43: 38, 44: T, 45: 39, 47: 40, 60: d, 84: K, 85: f1, 86: g1, 87: b1, 88: M1, 89: V, 102: L, 105: I, 106: w, 109: R, 111: N, 113: 41, 114: G, 115: P, 116: O, 121: U1, 122: W1, 123: z1, 124: j1 }, s(A1, [2, 53]), { 43: 267, 44: T, 45: 39, 47: 40, 60: d, 89: V, 102: L, 105: I, 106: w, 109: R, 111: N, 113: 41, 114: G, 115: P, 116: O }, s(B2, [2, 121], { 106: R1 }), s(wt, [2, 130], { 108: 269, 10: s1, 60: i1, 84: r1, 105: a1, 109: n1, 110: u1, 111: l1, 112: o1 }), s(J, [2, 132]), s(J, [2, 134]), s(J, [2, 135]), s(J, [2, 136]), s(J, [2, 137]), s(J, [2, 138]), s(J, [2, 139]), s(J, [2, 140]), s(J, [2, 141]), s(B2, [2, 122], { 106: R1 }), { 10: [1, 270] }, s(B2, [2, 123], { 106: R1 }), { 10: [1, 271] }, s(It, [2, 129]), s(B2, [2, 105], { 106: R1 }), s(B2, [2, 106], { 113: 112, 44: T, 60: d, 89: V, 102: L, 105: I, 106: w, 109: R, 111: N, 114: G, 115: P, 116: O }), s(B2, [2, 110]), s(B2, [2, 112], { 10: [1, 272] }), s(B2, [2, 113]), { 98: [1, 273] }, { 51: [1, 274] }, { 62: [1, 275] }, { 66: [1, 276] }, { 8: $, 9: t1, 11: e1, 21: 277 }, s(E, [2, 34]), s(A1, [2, 52]), { 10: s1, 60: i1, 84: r1, 105: a1, 107: 278, 108: 242, 109: n1, 110: u1, 111: l1, 112: o1 }, s(J, [2, 133]), { 14: D1, 44: x1, 60: T1, 89: E1, 101: 279, 105: y1, 106: F1, 109: _1, 111: B1, 114: v1, 115: V1, 116: L1, 120: 87 }, { 14: D1, 44: x1, 60: T1, 89: E1, 101: 280, 105: y1, 106: F1, 109: _1, 111: B1, 114: v1, 115: V1, 116: L1, 120: 87 }, { 98: [1, 281] }, s(B2, [2, 120]), s(W, [2, 58]), { 30: 282, 67: C, 80: z, 81: j, 82: 171, 116: S, 117: D2, 118: x }, s(W, [2, 66]), s(Q1, l2, { 5: 283 }), s(wt, [2, 131], { 108: 269, 10: s1, 60: i1, 84: r1, 105: a1, 109: n1, 110: u1, 111: l1, 112: o1 }), s(B2, [2, 126], { 120: 167, 10: [1, 284], 14: D1, 44: x1, 60: T1, 89: E1, 105: y1, 106: F1, 109: _1, 111: B1, 114: v1, 115: V1, 116: L1 }), s(B2, [2, 127], { 120: 167, 10: [1, 285], 14: D1, 44: x1, 60: T1, 89: E1, 105: y1, 106: F1, 109: _1, 111: B1, 114: v1, 115: V1, 116: L1 }), s(B2, [2, 114]), { 31: [1, 286], 67: C, 82: 218, 116: S, 117: D2, 118: x }, { 6: 11, 7: 12, 8: f, 9: c, 10: A, 11: r, 20: 17, 22: 18, 23: 19, 24: 20, 25: 21, 26: 22, 27: b2, 32: [1, 287], 33: 24, 34: F, 36: k, 38: U, 42: 28, 43: 38, 44: T, 45: 39, 47: 40, 60: d, 84: K, 85: f1, 86: g1, 87: b1, 88: M1, 89: V, 102: L, 105: I, 106: w, 109: R, 111: N, 113: 41, 114: G, 115: P, 116: O, 121: U1, 122: W1, 123: z1, 124: j1 }, { 10: s1, 60: i1, 84: r1, 92: 288, 105: a1, 107: 241, 108: 242, 109: n1, 110: u1, 111: l1, 112: o1 }, { 10: s1, 60: i1, 84: r1, 92: 289, 105: a1, 107: 241, 108: 242, 109: n1, 110: u1, 111: l1, 112: o1 }, s(W, [2, 62]), s(E, [2, 33]), s(B2, [2, 124], { 106: R1 }), s(B2, [2, 125], { 106: R1 })],
    defaultActions: {},
    parseError: /* @__PURE__ */ p(function(h, p2) {
      if (p2.recoverable)
        this.trace(h);
      else {
        var g = new Error(h);
    ...
    parse: /* @__PURE__ */ p(function(h) {
      var p$1 = this, g = [0], o = [], _ = [null], t = [], O1 = this.table, e = "", v = 0, Rt = 0, zt = 2, Nt = 1, jt = t.slice.call(arguments, 1), M = Object.create(this.lexer), k1 = { yy: {} };
      ...
      function Gt() {
        var X;
        return X = o.pop() || M.lex() || Nt, typeof X != "number" && (X instanceof Array && (o = X, X = o.pop()), X = p$1.symbols_[X] || X), X;
      }
      p(Gt, "lex");
...
Expecting ` + X1.join(", ") + ", got '" + (this.terminals_[Y] || Y) + "'" : et = "Parse error on line " + (v + 1) + ": Unexpected " + (Y == Nt ? "end of input" : "'" + (this.terminals_[Y] || Y) + "'"), this.parseError(et, {
    ...
    var p1 = {
      EOF: 1,
      parseError: /* @__PURE__ */ p(function(p2, g) {
        if (this.yy.parser)
          this.yy.parser.parseError(p2, g);
        else
          throw new Error(p2);
      }, "parseError"),
      // resets the lexer, sets new input
      setInput: /* @__PURE__ */ p(function(h, p2) {
        return this.yy = p2 || this.yy || {}, this._input = h, this._more = this._backtrack = this.done = false, this.yylineno = this.yyleng = 0, this.yytext = this.matched = this.match = "", this.conditionStack = ["INITIAL"], this.yylloc = {
          first_line: 1,
          first_column: 0,
          last_line: 1,
          last_column: 0
      ...
      input: /* @__PURE__ */ p(function() {
        ...
        var p2 = h.match(/(?:\r\n?|\n).*/g);
        return p2 ? (this.yylineno++, this.yylloc.last_line++) : this.yylloc.last_column++, this.options.ranges && this.yylloc.range[1]++, this._input = this._input.slice(1), h;
      }, "input"),
      // unshifts one char (or a string) into the input
      unput: /* @__PURE__ */ p(function(h) {
        var p2 = h.length, g = h.split(/(?:\r\n?|\n)/g);
        this._input = h + this._input, this.yytext = this.yytext.substr(0, this.yytext.length - p2), this.offset -= p2;
        ...
        return this.yylloc = {
          ...
          last_column: g ? (g.length === o.length ? this.yylloc.first_column : 0) + o[o.length - g.length].length - g[0].length : this.yylloc.first_column - p2
        }, this.options.ranges && (this.yylloc.range = [_[0], _[0] + this.yyleng - p2]), this.yyleng = this.yytext.length, this;
      }, "unput"),
...
` + this.showPosition(), {
      ...
      showPosition: /* @__PURE__ */ p(function() {
        var h = this.pastInput(), p2 = new Array(h.length + 1).join("-");
        return h + this.upcomingInput() + `
` + p2 + "^";
      }, "showPosition"),
      // test the lexed token: return FALSE when not a match, otherwise return token
      test_match: /* @__PURE__ */ p(function(h, p2) {
        var g, o, _;
      ...
      next: /* @__PURE__ */ p(function() {
        ...
        for (var _ = this._currentRules(), t = 0; t < _.length; t++)
          if (g = this._input.match(this.rules[_[t]]), g && (!p2 || g[0].length > p2[0].length)) {
            if (p2 = g, o = t, this.options.backtrack_lexer) {
              if (h = this.test_match(g, _[t]), h !== false)
                return h;
              if (this._backtrack) {
                p2 = false;
                continue;
        ...
        return p2 ? (h = this.test_match(p2, _[o]), h !== false ? h : false) : this._input === "" ? this.EOF : this.parseError("Lexical error on line " + (this.yylineno + 1) + `. Unrecognized text.
` + this.showPosition(), {
          text: "",
          token: null,
          line: this.yylineno
      ...
      begin: /* @__PURE__ */ p(function(p2) {
        this.conditionStack.push(p2);
      }, "begin"),
      // pop the previously active lexer condition state off the condition stack
      popState: /* @__PURE__ */ p(function() {
        var p2 = this.conditionStack.length - 1;
        return p2 > 0 ? this.conditionStack.pop() : this.conditionStack[0];
      }, "popState"),
      ...
      topState: /* @__PURE__ */ p(function(p2) {
        return p2 = this.conditionStack.length - 1 - Math.abs(p2 || 0), p2 >= 0 ? this.conditionStack[p2] : "INITIAL";
      }, "topState"),
      // alias for begin(condition)
      pushState: /* @__PURE__ */ p(function(p2) {
        this.begin(p2);
      }, "pushState"),
      ...
      options: {},
      performAction: /* @__PURE__ */ p(function(p2, g, o, _) {
        switch (o) {
          case 0:
          ...
          case 34:
            return 88;
          case 35:
            return p2.lex.firstGraph() && this.begin("dir"), 12;
          case 36:
            return p2.lex.firstGraph() && this.begin("dir"), 12;
          case 37:
            return p2.lex.firstGraph() && this.begin("dir"), 12;
  ...
  return p(H1, "Parser"), H1.prototype = J1, J1.Parser = H1, new H1();
}();
rt.parser = rt;
...
var be = Ut, Ae = /* @__PURE__ */ p((s, i) => {
  const a = l, n = a(s, "r"), u = a(s, "g"), l$1 = a(s, "b");
  return xi(n, u, l$1, i);
}, "fade"), ke = /* @__PURE__ */ p((s) => `.label {
...
`, "getStyles"), me = ke, Te = {
  ...
  styles: me,
  init: /* @__PURE__ */ p((s) => {
    s.flowchart || (s.flowchart = {}), s.layout && $_({ layout: s.layout }), s.flowchart.arrowMarkerAbsolute = s.arrowMarkerAbsolute, $_({ flowchart: { arrowMarkerAbsolute: s.arrowMarkerAbsolute } });
  }, "init")
};
export {
  Te as diagram
