import{B as f,a8 as h,r as t,o as k,a as x,c as y,b as _,d as v,J as w,A as D}from"./main-CF3M_8Rw.js";import{u as B}from"./navigation-DbPJLO8Q.js";const E=["srcdoc"],R=f({__name:"index",setup(U){const s=B(),g=h(),u=t({}),c=t(),m=t(),o=t(500),a=t("");let i=null;const b=()=>{c.value},d=l=>`
    <!DOCTYPE html>
    <html>
      <head>
        <meta charset="UTF-8">
...
.loaderrorclass{display:inline-block;cursor:default;background: url('http://192.168.1.71:81/console/UEditor/themes/default/images/loaderror.png') no-repeat center center transparent;border:1px solid #cccccc;margin-right:1px;height: 22px;width: 22px;}</style><style id="anchor">.anchorclass{background: url('http://192.168.1.71:81/console/UEditor/themes/default/images/anchor.gif') no-repeat scroll left center transparent;cursor: auto;display: inline-block;height: 16px;width: 15px;}</style>
  ...
  `;return k(async()=>{const l=g.path;s.navigations.length||await s.fetchNavigations(),u.value=s.navigations.find(n=>n.menu_path===l)||{};const e=(u.value.content||{}).html_content||"";a.value=d(e),i&&(clearInterval(i),i=null),i=setInterval(()=>{const n=c.value.contentDocument;if(n){const p=n.documentElement.scrollHeight;o.value=p}},1e3)}),x(()=>{clearInterval(i),i=null}),(l,r)=>(_(),y("div",{class:"iframe-container",ref_key:"containerRef",ref:m},[v("iframe",{ref_key:"iframeRef",ref:c,srcdoc:a.value,class:"w-full border-none",style:w({height:o.value+"px"}),onLoad:b,sandbox:"allow-same-origin"},null,44,E)],512))}}),T=D(R,[["__scopeId","data-v-d25b0f46"]]);export{T as default};
