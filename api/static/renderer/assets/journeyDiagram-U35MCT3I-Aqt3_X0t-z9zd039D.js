import{x as dt,g as ft,y as rt,d as gt}from"./chunk-D6G4REZN-AYZPaegw-9Tt_5SXl.js";import{_ as s,c as A,o as mt,p as xt,b as kt,a as _t,s as bt,g as $t,x as wt,d as vt}from"./mermaid-j5R1o_wi-pyelFJjv.js";import{L as X}from"./helper-7WMIPux3-ZRh5gUou.js";import{v as K}from"./arc-6Ea6x5Wp-7r31Nd3I.js";import"./main-B8r1lKmx.js";import"./copy-BS31ARP0-Fmnkulfq.js";var q=function(){var t=s(function(g,i,a,u){for(a=a||{},u=g.length;u--;a[g[u]]=i);return a},"o"),e=[6,8,10,11,12,14,16,17,18],r=[1,9],l=[1,10],n=[1,11],h=[1,12],c=[1,13],p=[1,14],d={trace:s(function(){},"trace"),yy:{},symbols_:{error:2,start:3,journey:4,document:5,EOF:6,line:7,SPACE:8,statement:9,NEWLINE:10,title:11,acc_title:12,acc_title_value:13,acc_descr:14,acc_descr_value:15,acc_descr_multiline_value:16,section:17,taskName:18,taskData:19,$accept:0,$end:1},terminals_:{2:"error",4:"journey",6:"EOF",8:"SPACE",10:"NEWLINE",11:"title",12:"acc_title",13:"acc_title_value",14:"acc_descr",15:"acc_descr_value",16:"acc_descr_multiline_value",17:"section",18:"taskName",19:"taskData"},productions_:[0,[3,3],[5,0],[5,2],[7,2],[7,1],[7,1],[7,1],[9,1],[9,2],[9,2],[9,1],[9,1],[9,2]],performAction:s(function(g,i,a,u,y,o,m){var k=o.length-1;switch(y){case 1:return o[k-1];case 2:this.$=[];break;case 3:o[k-1].push(o[k]),this.$=o[k-1];break;case 4:case 5:this.$=o[k];break;case 6:case 7:this.$=[];break;case 8:u.setDiagramTitle(o[k].substr(6)),this.$=o[k].substr(6);break;case 9:this.$=o[k].trim(),u.setAccTitle(this.$);break;case 10:case 11:this.$=o[k].trim(),u.setAccDescription(this.$);break;case 12:u.addSection(o[k].substr(8)),this.$=o[k].substr(8);break;case 13:u.addTask(o[k-1],o[k]),this.$="task";break}},"anonymous"),table:[{3:1,4:[1,2]},{1:[3]},t(e,[2,2],{5:3}),{6:[1,4],7:5,8:[1,6],9:7,10:[1,8],11:r,12:l,14:n,16:h,17:c,18:p},t(e,[2,7],{1:[2,1]}),t(e,[2,3]),{9:15,11:r,12:l,14:n,16:h,17:c,18:p},t(e,[2,5]),t(e,[2,6]),t(e,[2,8]),{13:[1,16]},{15:[1,17]},t(e,[2,11]),t(e,[2,12]),{19:[1,18]},t(e,[2,4]),t(e,[2,9]),t(e,[2,10]),t(e,[2,13])],defaultActions:{},parseError:s(function(g,i){if(i.recoverable)this.trace(g);else{var a=new Error(g);throw a.hash=i,a}},"parseError"),parse:s(function(g){var i=this,a=[0],u=[],y=[null],o=[],m=this.table,k="",L=0,G=0,ht=2,H=1,ut=o.slice.call(arguments,1),_=Object.create(this.lexer),S={yy:{}};for(var D in this.yy)Object.prototype.hasOwnProperty.call(this.yy,D)&&(S.yy[D]=this.yy[D]);_.setInput(g,S.yy),S.yy.lexer=_,S.yy.parser=this,typeof _.yylloc>"u"&&(_.yylloc={});var N=_.yylloc;o.push(N);var yt=_.options&&_.options.ranges;typeof S.yy.parseError=="function"?this.parseError=S.yy.parseError:this.parseError=Object.getPrototypeOf(this).parseError;function pt($){a.length=a.length-2*$,y.length=y.length-$,o.length=o.length-$}s(pt,"popStack");function Q(){var $;return $=u.pop()||_.lex()||H,typeof $!="number"&&($ instanceof Array&&(u=$,$=u.pop()),$=i.symbols_[$]||$),$}s(Q,"lex");for(var b,E,w,z,P={},B,T,Z,O;;){if(E=a[a.length-1],this.defaultActions[E]?w=this.defaultActions[E]:((b===null||typeof b>"u")&&(b=Q()),w=m[E]&&m[E][b]),typeof w>"u"||!w.length||!w[0]){var Y="";O=[];for(B in m[E])this.terminals_[B]&&B>ht&&O.push("'"+this.terminals_[B]+"'");_.showPosition?Y="Parse error on line "+(L+1)+`:
`+_.showPosition()+`
...
`,"getStyles"),Ft=Vt,U=s(function(t,e){return dt(t,e)},"drawRect"),Lt=s(function(t,e){const r=t.append("circle").attr("cx",e.cx).attr("cy",e.cy).attr("class","face").attr("r",15).attr("stroke-width",2).attr("overflow","visible"),l=t.append("g");l.append("circle").attr("cx",e.cx-15/3).attr("cy",e.cy-15/3).attr("r",1.5).attr("stroke-width",2).attr("fill","#666").attr("stroke","#666"),l.append("circle").attr("cx",e.cx+15/3).attr("cy",e.cy-15/3).attr("r",1.5).attr("stroke-width",2).attr("fill","#666").attr("stroke","#666");function n(p){const d=K().startAngle(Math.PI/2).endAngle(3*(Math.PI/2)).innerRadius(7.5).outerRadius(6.8181818181818175);p.append("path").attr("class","mouth").attr("d",d).attr("transform","translate("+e.cx+","+(e.cy+2)+")")}s(n,"smile");function h(p){const d=K().startAngle(3*Math.PI/2).endAngle(5*(Math.PI/2)).innerRadius(7.5).outerRadius(6.8181818181818175);p.append("path").attr("class","mouth").attr("d",d).attr("transform","translate("+e.cx+","+(e.cy+7)+")")}s(h,"sad");function c(p){p.append("line").attr("class","mouth").attr("stroke",2).attr("x1",e.cx-5).attr("y1",e.cy+7).attr("x2",e.cx+5).attr("y2",e.cy+7).attr("class","mouth").attr("stroke-width","1px").attr("stroke","#666")}return s(c,"ambivalent"),e.score>3?n(l):e.score<3?h(l):c(l),r},"drawFace"),at=s(function(t,e){const r=t.append("circle");return r.attr("cx",e.cx),r.attr("cy",e.cy),r.attr("class","actor-"+e.pos),r.attr("fill",e.fill),r.attr("stroke",e.stroke),r.attr("r",e.r),r.class!==void 0&&r.attr("class",r.class),e.title!==void 0&&r.append("title").text(e.title),r},"drawCircle"),ot=s(function(t,e){return ft(t,e)},"drawText"),Bt=s(function(t,e){function r(n,h,c,p,d){return n+","+h+" "+(n+c)+","+h+" "+(n+c)+","+(h+p-d)+" "+(n+c-d*1.2)+","+(h+p)+" "+n+","+(h+p)}s(r,"genPoints");const l=t.append("polygon");l.attr("points",r(e.x,e.y,50,20,7)),l.attr("class","labelBox"),e.y=e.y+e.labelMargin,e.x=e.x+.5*e.labelMargin,ot(t,e)},"drawLabel"),Ot=s(function(t,e,r){const l=t.append("g"),n=rt();n.x=e.x,n.y=e.y,n.fill=e.fill,n.width=r.width*e.taskCount+r.diagramMarginX*(e.taskCount-1),n.height=r.height,n.class="journey-section section-type-"+e.num,n.rx=3,n.ry=3,U(l,n),lt(r)(e.text,l,n.x,n.y,n.width,n.height,{class:"journey-section section-type-"+e.num},r,e.colour)},"drawSection"),it=-1,Rt=s(function(t,e,r){const l=e.x+r.width/2,n=t.append("g");it++;const h=300+5*30;n.append("line").attr("id","task"+it).attr("x1",l).attr("y1",e.y).attr("x2",l).attr("y2",h).attr("class","task-line").attr("stroke-width","1px").attr("stroke-dasharray","4 2").attr("stroke","#666"),Lt(n,{cx:l,cy:300+(5-e.score)*30,score:e.score});const c=rt();c.x=e.x,c.y=e.y,c.fill=e.fill,c.width=r.width,c.height=r.height,c.class="task task-type-"+e.num,c.rx=3,c.ry=3,U(n,c);let p=e.x+14;e.people.forEach(d=>{const x=e.actors[d].color,f={cx:p,cy:e.y,r:7,fill:x,stroke:"#000",title:d,pos:e.actors[d].position};at(n,f),p+=10}),lt(r)(e.task,n,c.x,c.y,c.width,c.height,{class:"task"},r,e.colour)},"drawTask"),Dt=s(function(t,e){gt(t,e)},"drawBackgroundRect"),lt=function(){function t(n,h,c,p,d,x,f,g){const i=h.append("text").attr("x",c+d/2).attr("y",p+x/2+5).style("font-color",g).style("text-anchor","middle").text(n);l(i,f)}s(t,"byText");function e(n,h,c,p,d,x,f,g,i){const{taskFontSize:a,taskFontFamily:u}=g,y=n.split(/<br\s*\/?>/gi);for(let o=0;o<y.length;o++){const m=o*a-a*(y.length-1)/2,k=h.append("text").attr("x",c+d/2).attr("y",p).attr("fill",i).style("text-anchor","middle").style("font-size",a).style("font-family",u);k.append("tspan").attr("x",c+d/2).attr("dy",m).text(y[o]),k.attr("y",p+x/2).attr("dominant-baseline","central").attr("alignment-baseline","central"),l(k,f)}}s(e,"byTspan");function r(n,h,c,p,d,x,f,g){const i=h.append("switch"),a=i.append("foreignObject").attr("x",c).attr("y",p).attr("width",d).attr("height",x).attr("position","fixed").append("xhtml:div").style("display","table").style("height","100%").style("width","100%");a.append("div").attr("class","label").style("display","table-cell").style("text-align","center").style("vertical-align","middle").text(n),e(n,i,c,p,d,x,f,g),l(a,f)}s(r,"byFo");function l(n,h){for(const c in h)c in h&&n.attr(c,h[c])}return s(l,"_setTextAttrs"),function(n){return n.textPlacement==="fo"?r:n.textPlacement==="old"?t:e}}(),Nt=s(function(t){t.append("defs").append("marker").attr("id","arrowhead").attr("refX",5).attr("refY",2).attr("markerWidth",6).attr("markerHeight",4).attr("orient","auto").append("path").attr("d","M 0,0 V 4 L6,2 Z")},"initGraphics"),F={drawRect:U,drawCircle:at,drawSection:Ot,drawText:ot,drawLabel:Bt,drawTask:Rt,drawBackgroundRect:Dt,initGraphics:Nt},zt=s(function(t){Object.keys(t).forEach(function(e){R[e]=t[e]})},"setConf"),M={};function ct(t){const e=A().journey;let r=60;Object.keys(M).forEach(l=>{const n=M[l].color,h={cx:20,cy:r,r:7,fill:n,stroke:"#000",pos:M[l].position};F.drawCircle(t,h);const c={x:40,y:r+7,fill:"#666",text:l,textMargin:e.boxTextMargin|5};F.drawText(t,c),r+=20})}s(ct,"drawActorLegend");var R=A().journey,I=R.leftMargin,Yt=s(function(t,e,r,l){const n=A().journey,h=A().securityLevel;let c;h==="sandbox"&&(c=X("#i"+e));const p=h==="sandbox"?X(c.nodes()[0].contentDocument.body):X("body");v.init();const d=p.select("#"+e);F.initGraphics(d);const x=l.db.getTasks(),f=l.db.getDiagramTitle(),g=l.db.getActors();for(const m in M)delete M[m];let i=0;g.forEach(m=>{M[m]={color:n.actorColours[i%n.actorColours.length],position:i},i++}),ct(d),v.insert(0,0,I,Object.keys(M).length*50),Xt(d,x,0);const a=v.getBounds();f&&d.append("text").text(f).attr("x",I).attr("font-size","4ex").attr("font-weight","bold").attr("y",25);const u=a.stopy-a.starty+2*n.diagramMarginY,y=I+a.stopx+2*n.diagramMarginX;vt(d,u,y,n.useMaxWidth),d.append("line").attr("x1",I).attr("y1",n.height*4).attr("x2",y-I-4).attr("y2",n.height*4).attr("stroke-width",4).attr("stroke","black").attr("marker-end","url(#arrowhead)");const o=f?70:0;d.attr("viewBox",`${a.startx} -25 ${y} ${u+o}`),d.attr("preserveAspectRatio","xMinYMin meet"),d.attr("height",u+o+25)},"draw"),v={data:{startx:void 0,stopx:void 0,starty:void 0,stopy:void 0},verticalPos:0,sequenceItems:[],init:s(function(){this.sequenceItems=[],this.data={startx:void 0,stopx:void 0,starty:void 0,stopy:void 0},this.verticalPos=0},"init"),updateVal:s(function(t,e,r,l){t[e]===void 0?t[e]=r:t[e]=l(r,t[e])},"updateVal"),updateBounds:s(function(t,e,r,l){const n=A().journey,h=this;let c=0;function p(d){return s(function(x){c++;const f=h.sequenceItems.length-c+1;h.updateVal(x,"starty",e-f*n.boxMargin,Math.min),h.updateVal(x,"stopy",l+f*n.boxMargin,Math.max),h.updateVal(v.data,"startx",t-f*n.boxMargin,Math.min),h.updateVal(v.data,"stopx",r+f*n.boxMargin,Math.max),d!=="activation"&&(h.updateVal(x,"startx",t-f*n.boxMargin,Math.min),h.updateVal(x,"stopx",r+f*n.boxMargin,Math.max),h.updateVal(v.data,"starty",e-f*n.boxMargin,Math.min),h.updateVal(v.data,"stopy",l+f*n.boxMargin,Math.max))},"updateItemBounds")}s(p,"updateFn"),this.sequenceItems.forEach(p())},"updateBounds"),insert:s(function(t,e,r,l){const n=Math.min(t,r),h=Math.max(t,r),c=Math.min(e,l),p=Math.max(e,l);this.updateVal(v.data,"startx",n,Math.min),this.updateVal(v.data,"starty",c,Math.min),this.updateVal(v.data,"stopx",h,Math.max),this.updateVal(v.data,"stopy",p,Math.max),this.updateBounds(n,c,h,p)},"insert"),bumpVerticalPos:s(function(t){this.verticalPos=this.verticalPos+t,this.data.stopy=this.verticalPos},"bumpVerticalPos"),getVerticalPos:s(function(){return this.verticalPos},"getVerticalPos"),getBounds:s(function(){return this.data},"getBounds")},W=R.sectionFills,nt=R.sectionColours,Xt=s(function(t,e,r){const l=A().journey;let n="";const h=l.height*2+l.diagramMarginY,c=r+h;let p=0,d="#CCC",x="black",f=0;for(const[g,i]of e.entries()){if(n!==i.section){d=W[p%W.length],f=p%W.length,x=nt[p%nt.length];let u=0;const y=i.section;for(let m=g;m<e.length&&e[m].section==y;m++)u=u+1;const o={x:g*l.taskMargin+g*l.width+I,y:50,text:i.section,fill:d,num:f,colour:x,taskCount:u};F.drawSection(t,o,l),n=i.section,p++}const a=i.people.reduce((u,y)=>(M[y]&&(u[y]=M[y]),u),{});i.x=g*l.taskMargin+g*l.width+I,i.y=c,i.width=l.diagramMarginX,i.height=l.diagramMarginY,i.colour=x,i.fill=d,i.num=f,i.actors=a,F.drawTask(t,i,l),v.insert(i.x,i.y,i.x+i.width+l.taskMargin,300+5*30)}},"drawTasks"),st={setConf:zt,draw:Yt},Qt={parser:Tt,db:et,renderer:st,styles:Ft,init:s(t=>{st.setConf(t.journey),et.clear()},"init")};export{Qt as diagram};
